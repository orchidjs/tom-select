...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function w(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function C(e,t,i,s){e.addEventListener(t,i,s)}function I(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function _(e,t){const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)}function S(e,t){var i=Object.assign({},v,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)}function x(e,t){var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function k(e,t){Object.assign(e.style,t)}function F(e,...t){var i=P(t);(e=E(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function L(e,...t){var i=P(t);(e=E(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function P(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function E(e){return Array.isArray(e)||(e=[e]),e}function T(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function q(e,t=0){return t>0?e[e.length-1]:e[0]}function V(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function j(e,t){for(const i in t){let s=t[i]
null==s?e.removeAttribute(i):e.setAttribute(i,s)}}function N(e,t){e.parentNode&&e.parentNode.replaceChild(t,e)}var D=0
class R extends(function(e){return e.plugins={},class extends e{constructor(...e){super(...e),this.plugins={names:[],settings:{},requested:{},loaded:{}}}static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s
const n=this,o=[]
...
if(o=d.settings.mode,r=u.getAttribute("class")||"",F(e=A("<div>"),p.wrapperClass,r,o),F(t=A('<div class="items">'),p.inputClass),e.append(t),F(s=d._render("dropdown"),p.dropdownClass,o),F(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
else{i=A('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&j(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),j(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=_(i,d.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",v=document.querySelector(f)
if(v){j(v,{for:a}),j(n,{"aria-labelledby":_(v,d.inputId+"-ts-label")})}var m,y,O
d.settings.copyClassesToDropdown&&F(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),F([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&j(u,{multiple:"multiple"}),d.settings.placeholder&&j(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,C(s,"click",(e=>{const t=T(e.target,"[data-selectable]")
t&&(d.onOptionSelect(e,t),w(e,!0))})),C(t,"click",(e=>{var s=T(e.target,"."+d.settings.itemClass,t)
s&&d.onItemSelect(e,s)?w(e,!0):""==i.value&&(d.onClick(),w(e,!0))})),C(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),C(i,"keydown",(e=>d.onKeyDown(e))),C(i,"keyup",(e=>d.onKeyUp(e))),C(i,"keypress",(e=>d.onKeyPress(e))),C(i,"resize",(()=>d.positionDropdown()),h),C(i,"blur",(()=>d.onBlur())),C(i,"focus",(e=>d.onFocus(e))),C(i,"paste",(e=>d.onPaste(e)))
const b=t=>{if(!e.contains(t.target)&&!s.contains(t.target))return d.isFocused&&d.blur(),void d.inputState()
w(t,!0)}
var I=()=>{d.isOpen&&d.positionDropdown()}
C(document,"mousedown",b),C(window,"sroll",I,h),C(window,"resize",I,h),d._destroy=()=>{document.removeEventListener("mousedown",b),window.removeEventListener("sroll",I),window.removeEventListener("resize",I)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,j(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),p.items=[],C(u,"invalid",(e=>{w(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.close(!1),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),F(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
e.isFocused&&e.isOpen?e.blur():e.focus()}onMouseDown(){}onChange(){x(this.input,"input"),x(this.input,"change")}onPaste(e){var t=this
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||L(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
...
w(t)}else"click"===i&&I(f,t)||"keydown"===i&&I("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){var t=this.control.querySelector(".last-active")
t&&L(t,"last-active"),F(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),L(e,"active")}clearActiveItems(){L(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,j(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),j(e,{"aria-selected":"true"}),F(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(L(this.activeOption,"active"),j(this.activeOption,{"aria-selected":null})),this.activeOption=null,j(this.control_input,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(F(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,F(e.wrapper,"input-hidden")):(e.isInputHidden=!1,L(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
const u={},h=[]
var f,v=this,m=v.inputValue(),O=v.search(m),b=v.activeOption,w=v.settings.shouldOpen||!1,C=v.dropdown_content
...
for(l||(l=v._render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),j(l,{id:e.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),L(l,"active")),c==n&&d&&d.dataset.group===o&&(b=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(v.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment(),t=v.render("optgroup_header",v.optgroups[o])
t&&e.append(t),e.append(u[o])
let i=v.render("optgroup",{group:v.optgroups[o],options:e})
l.append(i)}else l.append(u[o])
if(C.innerHTML="",C.append(l),v.settings.highlight&&(f=C.querySelectorAll("span.highlight"),Array.prototype.forEach.call(f,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),O.query.length&&O.tokens.length))for(const e of O.tokens)g(C,e.regex)
var I=e=>{let t=v.render(e,{input:m})
return t&&(w=!0,C.insertBefore(t,C.firstChild)),t}
if(v.settings.shouldLoad.call(v,m)?v.loading?I("loading"):0===O.items.length&&I("no_results"):I("not_loading"),(a=v.canCreate(m))&&(p=I("option_create")),v.hasOptions=O.items.length>0||a,w){if(O.items.length>0){if(!C.contains(b)&&"single"===v.settings.mode&&v.items.length&&(b=v.getOption(v.items[0])),!C.contains(b)){let e=0
...
N(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&F(s,"active"),N(a,s)),i.lastQuery=null}}removeOption(e,t){const i=this
...
return null}getItem(e){if("string"==typeof e){var t=m(e)
return t?this.control.querySelector(`[data-value="${i=t,i.replace(/[\\"']/g,"\\$&")}"]`):null}var i
return e}addItems(e,t){var i=this
...
t&&n.setActiveOption(t)}n.isPending||n.refreshOptions(n.isFocused&&"single"!==o),!e.length||n.isFull()?n.close():n.isPending||n.positionDropdown(),n.trigger("item_add",r,i),n.isPending||n.updateOriginalInput({silent:t})}(!n.isPending||!s&&n.isFull())&&n.refreshState()}}))}removeItem(e=null,t){const i=this,s=i.getItem(e)
if(!s)return
var n,o
const r=s.dataset.value
n=V(s),s.remove(),s.classList.contains("active")&&(o=i.activeItems.indexOf(s),i.activeItems.splice(o,1),L(s,"active")),i.items.splice(n,1),i.lastQuery=null,!i.settings.persist&&i.userOptions.hasOwnProperty(r)&&i.removeOption(r,t),n<i.caretPos&&i.setCaret(i.caretPos-1),i.updateOriginalInput({silent:t}),i.refreshState(),i.positionDropdown(),i.trigger("item_remove",r,s)}createItem(e=null,t=!0,i=(()=>{})){var s,n=this,o=n.caretPos
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=A('<option value="'+O(i)+'">'+O(s)+"</option>")),e.selected=!0,j(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{const i=e;-1==t.items.indexOf(i.value)&&(j(i,{selected:null}),i.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,j(e.control_input,{"aria-expanded":"true"}),e.refreshState(),k(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),k(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,j(t.control_input,{"aria-expanded":"false"}),k(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
k(this.dropdown,{width:t.width+"px",top:i+"px",left:s+"px"})}}clear(e){var t=this
...
0===i?s.insertBefore(e,s.firstChild):s.insertBefore(e,s.children[i]),t.setCaret(i+1)}deleteSelection(e){var t,i,s,n,o=this
t=e&&8===e.keyCode?-1:1,i={start:(n=o.control_input).selectionStart||0,length:(n.selectionEnd||0)-(n.selectionStart||0)},console.log("delete selection")
const r=[],l=[]
if(o.activeItems.length){s=V(q(o.activeItems,t)),t>0&&s++
for(const e of o.activeItems)r.push(e.dataset.value),l.push(e)}else if((o.isFocused||"single"===o.settings.mode)&&o.items.length){const e=o.controlChildren()
t<0&&0===i.start&&0===i.length?(r.push(o.items[o.caretPos-1]),e.push(e[o.caretPos-1])):t>0&&i.start===o.inputValue().length&&(r.push(o.items[o.caretPos]),e.push(e[o.caretPos]))}if(!r.length||"function"==typeof o.settings.onDelete&&!1===o.settings.onDelete.call(o,r,e))return!1
for(console.log("values",r),console.log("items",l),w(e,!0),void 0!==s&&o.setCaret(s);r.length;)o.removeItem(r.pop())
return o.showInput(),o.positionDropdown(),o.refreshOptions(!1),!0}advanceSelection(e,t){var i,s,n,o=this
o.rtl&&(e*=-1),o.inputValue().length||(I(f,t)||I("shiftKey",t)?(n=(s=o.getLastActive(e))?s.classList.contains("active")?o.getAdjacent(s,e,"item"):s:e>0?o.control_input.nextElementSibling:o.control_input.previousElementSibling)&&(n.classList.contains("active")&&o.removeActiveItem(s),o.setActiveItemClass(n)):o.isFocused&&!o.activeItems.length?o.setCaret(o.caretPos+e):(s=o.getLastActive(e))&&(i=V(s),o.setCaret(e>0?i+1:i),o.setActiveItem()))}getLastActive(e){let t=this.control.querySelector(".last-active")
if(t)return t
var i=this.control.querySelectorAll(".active")
return i?q(i,e):void 0}setCaret(e){var t=this
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,L(e.input,"tomselected"),j(e.input,{hidden:null}),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){return"function"!=typeof this.settings.render[e]?null:this._render(e,t)}_render(e,t){var i,s
const n=this
return("option"===e||"item"===e)&&(i=y(t[n.settings.valueField]),s=n.rendered(e,i))?s:(s=n.settings.render[e].call(this,t,O))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?j(s,{"aria-disabled":"true"}):j(s,{"data-selectable":""}):"optgroup"===e&&(j(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&j(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(j(s,{"data-value":i}),"item"===e?F(s,n.settings.itemClass):(F(s,n.settings.optionClass),j(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){return this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return R.define("change_listener",(function(){var e=this,t=!1
C(e.input,"change",(()=>{if(t)t=!1
else{t=!0
var i=S(e.input,{})
e.setupOptions(i.options,i.optgroups),e.setValue(i.items)}}))})),R.define("checkbox_options",(function(){var e=this,t=e.onOptionSelect
e.settings.hideSelected=!1
var i=function(e){setTimeout((()=>{var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}),1)}
e.hook("after","setupTemplates",(()=>{var t=e.settings.render.option
e.settings.render.option=function(i){var s=A(t.apply(e,arguments)),n=document.createElement("input")
n.addEventListener("click",(function(e){w(e)})),n.type="checkbox"
const o=m(i[e.settings.valueField])
return o&&e.items.indexOf(o)>-1&&(n.checked=!0),s.prepend(n),s}})),e.on("item_remove",(t=>{var s=e.getOption(t)
s&&(s.classList.remove("selected"),i(s))})),e.hook("instead","onOptionSelect",(function(s,n){if(n.classList.contains("selected"))return n.classList.remove("selected"),e.removeItem(n.dataset.value),e.refreshOptions(),void w(s,!0)
t.apply(e,arguments),i(n)}))})),R.define("clear_button",(function(e){var t=this
...
i.addEventListener("click",(e=>{t.clear(),e.preventDefault(),e.stopPropagation()})),t.control.appendChild(i)}))})),R.define("drag_drop",(function(){var e=this
...
var i=[]
t.children("[data-value]").each((function(){this.dataset.value&&i.push(this.dataset.value)})),e.setValue(i)}})}))}})),R.define("dropdown_header",(function(e){var t=this
...
s&&s.addEventListener("click",(e=>{w(e,!0),t.close()})),t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),R.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=A(t),e.settings.placeholder&&j(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{j(e.wrapper,{tabindex:e.input.disabled?"-1":""+e.tabIndex}),C(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
let i=A('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),R.define("input_autogrow",(function(){var e=this
...
s(),e.on("update item_add item_remove",s),C(i,"input",s),C(i,"keyup",s),C(i,"blur",s),C(i,"update",s)}))})),R.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),R.define("no_active_items",(function(){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),R.define("optgroup_columns",(function(){var e=this,t=e.onKeyDown
e.hook("instead","onKeyDown",(function(i){var s,n,o,r
if(!e.isOpen||37!==i.keyCode&&39!==i.keyCode)return t.apply(e,arguments)
r=T(e.activeOption,"[data-group]"),s=V(e.activeOption,"[data-selectable]"),(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),R.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
return s.appendChild(n),C(n,"mousedown",(e=>{w(e,!0)})),C(n,"click",(e=>{if(w(e,!0),!t.isLocked){var i=s.dataset.value
t.removeItem(i),t.refreshOptions(!1)}})),s}}))}})),R.define("restore_on_backspace",(function(e){var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),R.define("virtual_scroll",(function(){const e=this,t=e.canLoad,i=e.clearActiveOption,s=e.loadCallback
var n,o={},r=!1
...
var i
l(t)?(i=e.render("loading_more",{query:t}))&&i.setAttribute("data-selectable",""):t in o&&!n.querySelector(".no-results")&&(i=e.render("no_more_results",{query:t})),i&&(F(i,e.settings.optionClass),n.append(i))})),e.hook("after","setup",(()=>{n=e.dropdown_content,e.settings.render=Object.assign({},{loading_more:function(){return'<div class="loading-more-results">Loading more results ... </div>'},no_more_results:function(){return'<div class="no-more-results">No more results</div>'}},e.settings.render),n.addEventListener("scroll",(function(){n.clientHeight/(n.scrollHeight-n.scrollTop)<.95||l(e.lastValue)&&(r||(r=!0,e.load.call(e,e.lastValue)))}))}))})),R}))
