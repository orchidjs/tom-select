...
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){i.settings.cacheSearch&&(i.loadedSearches[e]=!0),m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,C(s,"click",(e=>{const t=T(e.target,"[data-selectable]")
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.settings.cacheSearch||s.clearOptions(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||L(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
...
if(!o)return
const r=n.getItem(o)
r&&-1!==(i=n.items.indexOf(o))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),L(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(o)&&n.removeOption(o,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",o,r))}createItem(e=null,t=!0,i=(()=>{})){var s,n=this,o=n.caretPos
...
if(t=e&&8===e.keyCode?-1:1,i={start:(o=r.control_input).selectionStart||0,length:(o.selectionEnd||0)-(o.selectionStart||0)},s=[],r.activeItems.length){n=V(q(r.activeItems,t)),t>0&&n++
