...
return i||(e.setAttribute("id",t),t)}function S(e){if(e.jquery)return e[0]
...
if(o=d.settings.mode,r=u.getAttribute("class")||"",x(e=S("<div>"),p.wrapperClass,r,o),x(t=S('<div class="items">'),p.inputClass),e.append(t),x(s=d._render("dropdown"),p.dropdownClass,o),x(n=S(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),S(p.dropdownParent||e).appendChild(s),p.controlInput)i=S(p.controlInput)
...
e.isFocused&&e.isOpen?e.blur():e.focus()}onMouseDown(){}onChange(){A(this.input,"input"),A(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,A(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){b(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=S('<option value="'+O(i)+'">'+O(s)+"</option>")),e.selected=!0,V(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{const i=e;-1==t.items.indexOf(i.value)&&(V(i,{selected:null}),i.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
const n=this
return("option"===e||"item"===e)&&(i=y(t[n.settings.valueField]),s=n.rendered(e,i))?s:(s=n.settings.render[e].call(this,t,O))?(s=S(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?V(s,{"aria-disabled":"true"}):V(s,{"data-selectable":""}):"optgroup"===e&&(V(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&V(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(V(s,{"data-value":i}),"item"===e?x(s,n.settings.itemClass):(x(s,n.settings.optionClass),V(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){return this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
t=S(t),e.settings.placeholder&&V(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{V(e.wrapper,{tabindex:e.input.disabled?"-1":""+e.tabIndex}),I(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
