...
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){i.settings.cacheSearch&&(i.loadedSearches[e]=!0),m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,I(s,"click",(e=>{const t=E(e.target,"[data-selectable]")
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.settings.cacheSearch||s.clearOptions(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||k(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
