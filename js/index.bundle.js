...
E===ue(n)&&"static"!==Ee(E=_e(n)).position&&"absolute"===a&&(O="scrollHeight",_="scrollWidth"),E=E,(o===H||(o===$||o===W)&&i===K)&&(w=R,h-=(f&&x.visualViewport?x.visualViewport.height:E[O])-r.height,h*=c?1:-1),o!==$&&(o!==H&&o!==R||i!==K)||(y=W,p-=(f&&x.visualViewport?x.visualViewport.width:E[_])-r.width,p*=c?1:-1)}var j,A=Object.assign({position:a},l&&Pe),L=!0===u?function(e){var t=e.x,n=e.y,r=window.devicePixelRatio||1
