...
for(const e of Object.getOwnPropertyNames(this))this[e]=null}_queueCallback(e,t,n=!0){m(e,t,n)}_getConfig(e){return e=this._mergeConfigObj(e,this._element),e=this._configAfterMerge(e),this._typeCheckConfig(e),e}static getInstance(e){return t.get(i(e),this.DATA_KEY)}static getOrCreateInstance(e,t={}){return this.getInstance(e)||new this(e,"object"==typeof t?t:null)}static get VERSION(){return"5.3.2"}static get DATA_KEY(){return`bs.${this.NAME}`}static get EVENT_KEY(){return`.${this.DATA_KEY}`}static eventName(e){return`${e}${this.EVENT_KEY}`}}const q=e=>{let t=e.getAttribute("data-bs-target")
if(!t||"#"===t){let n=e.getAttribute("href")
if(!n||!n.includes("#")&&!n.startsWith("."))return null
n.includes("#")&&!n.startsWith("#")&&(n=`#${n.split("#")[1]}`),t=n&&"#"!==n?r(n.trim()):null}return t},B={find:(e,t=document.documentElement)=>[].concat(...Element.prototype.querySelectorAll.call(t,e)),findOne:(e,t=document.documentElement)=>Element.prototype.querySelector.call(t,e),children:(e,t)=>[].concat(...e.children).filter((e=>e.matches(t))),parents(e,t){const n=[]
...
n=h(t,e.target,r,!0)}n&&(n.focus({preventScroll:!0}),ce.getOrCreateInstance(n).show())}_getChildren(){return B.find(se,this._parent)}_getActiveElem(){return this._getChildren().find((e=>this._elemIsActive(e)))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist")
...
r(re,ee),r(".dropdown-menu",ne),n.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,n){e.hasAttribute(t)||e.setAttribute(t,n)}_elemIsActive(e){return e.classList.contains(ee)}_getInnerElement(e){return e.matches(se)?e:B.findOne(se,e)}_getOuterElement(e){return e.closest(".nav-item, .list-group-item")||e}static jQueryInterface(e){return this.each((function(){const t=ce.getOrCreateInstance(this)
if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`)
t[e]()}}))}}k.on(document,K,ie,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),a(this)||ce.getOrCreateInstance(this).show()})),k.on(window,U,(()=>{for(const e of B.find(ae))ce.getOrCreateInstance(e)})),d(ce)
...
function Be(e){return e.split("-")[0]}var We=Math.max,Re=Math.min,He=Math.round
...
return a.width=a.right-a.left,a.height=a.bottom-a.top,a.x=a.left,a.y=a.top,a}function Ot(e){var t,n=e.reference,r=e.element,o=e.placement,i=o?Be(o):null,s=o?it(o):null,a=n.x+n.width/2-r.width/2,c=n.y+n.height/2-r.height/2
...
0===d.length&&(d=f)
var p=d.reduce((function(t,n){return t[n]=Et(e,{placement:n,boundary:o,rootBoundary:i,padding:s})[Be(n)],t}),{})
...
if(!t.modifiersData[r]._skip){for(var o=n.mainAxis,i=void 0===o||o,s=n.altAxis,a=void 0===s||s,c=n.fallbackPlacements,l=n.padding,u=n.boundary,f=n.rootBoundary,d=n.altBoundary,p=n.flipVariations,m=void 0===p||p,h=n.allowedAutoPlacements,g=t.options.placement,b=Be(g),v=c||(b!==g&&m?function(e){if(Be(e)===pe)return[]
var t=dt(e)
return[mt(e),t,mt(t)]}(g):[dt(g)]),y=[g].concat(v).reduce((function(e,n){return e.concat(Be(n)===pe?At(t,{placement:n,boundary:u,rootBoundary:f,padding:l,flipVariations:m,allowedAutoPlacements:h}):n)}),[]),w=t.rects.reference,_=t.rects.popper,x=new Map,O=!0,E=y[0],A=0;A<y.length;A++){var j=y[A],C=Be(j),S=it(j)===he,D=[le,ue].indexOf(C)>=0,L=D?"width":"height",k=Et(t,{placement:j,boundary:u,rootBoundary:f,altBoundary:d,padding:l}),T=D?S?fe:de:S?ue:le
w[L]>_[L]&&(T=dt(T))
var N=dt(T),I=[]
...
t.modifiersData[n]=Ot({reference:t.rects.reference,element:t.rects.popper,strategy:"absolute",placement:t.placement})},data:{}},Tt={name:"preventOverflow",enabled:!0,phase:"main",fn:function(e){var t=e.state,n=e.options,r=e.name,o=n.mainAxis,i=void 0===o||o,s=n.altAxis,a=void 0!==s&&s,c=n.boundary,l=n.rootBoundary,u=n.altBoundary,f=n.padding,d=n.tether,p=void 0===d||d,m=n.tetherOffset,h=void 0===m?0:m,g=Et(t,{boundary:c,rootBoundary:l,padding:f,altBoundary:u}),b=Be(t.placement),v=it(t.placement),y=!v,w=et(b),_="x"===w?"y":"x",x=t.modifiersData.popperOffsets,O=t.rects.reference,E=t.rects.popper,A="function"==typeof h?h(Object.assign({},t.rects,{placement:t.placement})):h,j="number"==typeof A?{mainAxis:A,altAxis:A}:Object.assign({mainAxis:0,altAxis:0},A),C=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,S={x:0,y:0}
if(x){if(i){var D,L="y"===w?le:de,k="y"===w?ue:fe,T="y"===w?"height":"width",N=x[w],I=N+g[L],$=N-g[k],P=p?-E[T]/2:0,M=v===he?O[T]:E[T],q=v===he?-E[T]:-O[T],B=t.elements.arrow,W=p&&B?Ye(B):{width:0,height:0},R=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},H=R[L],V=R[k],F=tt(0,O[T],W[T]),K=y?O[T]/2-P-F-H-j.mainAxis:M-F-H-j.mainAxis,Y=y?-O[T]/2+P+F+V+j.mainAxis:q+F+V+j.mainAxis,U=t.elements.arrow&&Ze(t.elements.arrow),z=U?"y"===w?U.clientTop||0:U.clientLeft||0:0,Q=null!=(D=null==C?void 0:C[w])?D:0,J=N+Y-Q,X=tt(p?Re(I,N+K-Q-z):I,N,p?We($,J):$)
...
if(!Pt(e,t))return u
function f(){c.forEach((function(e){return e()})),c=[]}return u.setOptions(n).then((function(e){!l&&n.onFirstUpdate&&n.onFirstUpdate(e)})),u}}var qt=Mt(),Bt=Mt({defaultModifiers:[ut,kt,ct,qe]}),Wt=Mt({defaultModifiers:[ut,kt,ct,qe,Lt,jt,Tt,ot,Dt]}),Rt=Object.freeze({__proto__:null,afterMain:Se,afterRead:Ae,afterWrite:ke,applyStyles:qe,arrow:ot,auto:pe,basePlacements:me,beforeMain:je,beforeRead:Oe,beforeWrite:De,bottom:ue,clippingParents:be,computeStyles:ct,createPopper:Wt,createPopperBase:qt,createPopperLite:Bt,detectOverflow:Et,end:ge,eventListeners:ut,flip:jt,hide:Dt,left:de,main:Ce,modifierPhases:Te,offset:Lt,placements:xe,popper:ye,popperGenerator:Mt,popperOffsets:kt,preventOverflow:Tt,read:Ee,reference:we,right:fe,start:he,top:le,variationPlacements:_e,viewport:ve,write:Le})
...
return(this._inNavbar||"static"===this._config.display)&&($.setDataAttribute(this._menu,"popper","static"),e.modifiers=[{name:"applyStyles",enabled:!1}]),{...e,...p(this._config.popperConfig,[e])}}_selectMenuItem({key:e,target:t}){const n=B.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",this._menu).filter((e=>s(e)))
...
if(t&&!n)return
e.preventDefault()
const o=this.matches(tn)?this:B.prev(this,tn)[0]||B.next(this,tn)[0]||B.findOne(tn,e.delegateTarget.parentNode),i=pn.getOrCreateInstance(o)
...
return t&&t.textContent||""}var o=`<div class="p-4">${r.querySelector("textarea").value||""}</div>`,i=l("style"),s=l("script"),a=[`https://cdn.jsdelivr.net/npm/tom-select@2.2.3/dist/css/tom-select.${localStorage.getItem("theme")||"bootstrap4"}.min.css`,"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"]
...
var c=["https://cdn.jsdelivr.net/npm/tom-select@2.2.3/dist/js/tom-select.complete.min.js"]
