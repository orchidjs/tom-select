...
L.trigger(e,"show.bs.tab",{relatedTarget:t}).defaultPrevented||n&&n.defaultPrevented||(this._deactivate(t,e),this._activate(e,t))}_activate(e,n){e&&(e.classList.add(H),this._activate(t(e)),this._queueCallback((()=>{"tab"===e.getAttribute("role")?(e.removeAttribute("tabindex"),e.setAttribute("aria-selected",!0),this._toggleDropDown(e,!0),L.trigger(e,"shown.bs.tab",{relatedTarget:n})):e.classList.add(K)}),e,e.classList.contains(V)))}_deactivate(e,n){e&&(e.classList.remove(H),e.blur(),this._deactivate(t(e)),this._queueCallback((()=>{"tab"===e.getAttribute("role")?(e.setAttribute("aria-selected",!1),e.setAttribute("tabindex","-1"),this._toggleDropDown(e,!1),L.trigger(e,"hidden.bs.tab",{relatedTarget:n})):e.classList.remove(K)}),e,e.classList.contains(V)))}_keydown(e){if(![B,W,$,R].includes(e.key))return
e.stopPropagation(),e.preventDefault()
const t=[W,R].includes(e.key),n=p(this._getChildren().filter((e=>!i(e))),e.target,t,!0)
n&&(n.focus({preventScroll:!0}),z.getOrCreateInstance(n).show())}_getChildren(){return k.find(U,this._parent)}_getActiveElem(){return this._getChildren().find((e=>this._elemIsActive(e)))||null}_setInitialAttributes(e,t){this._setAttributeIfNotExists(e,"role","tablist")
...
r(".dropdown-toggle",H),r(".dropdown-menu",K),n.setAttribute("aria-expanded",t)}_setAttributeIfNotExists(e,t,n){e.hasAttribute(t)||e.setAttribute(t,n)}_elemIsActive(e){return e.classList.contains(H)}_getInnerElement(e){return e.matches(U)?e:k.findOne(U,e)}_getOuterElement(e){return e.closest(".nav-item, .list-group-item")||e}static jQueryInterface(e){return this.each((function(){const t=z.getOrCreateInstance(this)
if("string"==typeof e){if(void 0===t[e]||e.startsWith("_")||"constructor"===e)throw new TypeError(`No method named "${e}"`)
t[e]()}}))}}L.on(document,"click.bs.tab",Y,(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),i(this)||z.getOrCreateInstance(this).show()})),L.on(window,"load.bs.tab",(()=>{for(const e of k.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))z.getOrCreateInstance(e)})),u(z)
...
return null!=e&&e.brands?e.brands.map((function(e){return e.brand+"/"+e.version})).join(" "):navigator.userAgent}function Le(){return!/^((?!chrome|android).)*safari/i.test(De())}function Se(e,t,n){void 0===t&&(t=!1),void 0===n&&(n=!1)
...
return{width:u,height:f,top:l,right:c+u,bottom:l+f,left:c,x:c,y:l}}function ke(e){var t=Se(e),n=e.offsetWidth,r=e.offsetHeight
...
if(i&&s){var u=function(e,t){return Re("number"!=typeof(e="function"==typeof e?e(Object.assign({},t.rects,{placement:t.placement})):e)?e:He(e,Z))}(o.padding,n),f=ke(i),d="y"===c?F:X,p="y"===c?Q:J,h=n.rects.reference[l]+n.rects.reference[c]-s[c]-n.rects.popper[l],m=s[c]-n.rects.reference[c],g=Be(i),b=g?"y"===c?g.clientHeight||0:g.clientWidth||0:0,v=h/2-m/2,y=u[d],w=b-f[l]-u[p],_=b/2-f[l]/2+v,x=$e(y,_,w),O=c
...
return{scrollLeft:t.pageXOffset,scrollTop:t.pageYOffset}}function tt(e){return Se(Pe(e)).left+et(e).scrollLeft}function nt(e){var t=Ne(e),n=t.overflow,r=t.overflowX,o=t.overflowY
...
var l=Le();(l||!l&&"fixed"===t)&&(a=o.offsetLeft,c=o.offsetTop)}return{width:i,height:s,x:a+tt(e),y:c}}(e,n)):we(t)?function(e,t){var n=Se(e,!1,"fixed"===t)
...
if(x){if(i){var L,S="y"===w?F:X,k="y"===w?Q:J,T="y"===w?"height":"width",N=x[w],I=N+g[S],P=N-g[k],M=p?-E[T]/2:0,q=v===ee?O[T]:E[T],B=v===ee?-E[T]:-O[T],W=t.elements.arrow,$=p&&W?ke(W):{width:0,height:0},R=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},H=R[S],V=R[k],K=$e(0,O[T],$[T]),Y=y?O[T]/2-M-K-H-j.mainAxis:q-K-H-j.mainAxis,U=y?-O[T]/2+M+K+V+j.mainAxis:B+K+V+j.mainAxis,z=t.elements.arrow&&Be(t.elements.arrow),G=z?"y"===w?z.clientTop||0:z.clientLeft||0:0,Z=null!=(L=null==C?void 0:C[w])?L:0,te=N+U-Z,ne=$e(p?je(I,N+Y-Z-G):I,N,p?Ae(P,te):P)
...
return 1!==n||1!==r}(t),a=Pe(t),c=Se(e,s,n),l={scrollLeft:0,scrollTop:0},u={x:0,y:0}
return(i||!i&&!n)&&(("body"!==ve(t)||nt(a))&&(l=(r=t)!==ye(r)&&_e(r)?{scrollLeft:(o=r).scrollLeft,scrollTop:o.scrollTop}:et(r)),_e(t)?((u=Se(t,!0)).x+=t.clientLeft,u.y+=t.clientTop):a&&(u.x=tt(a))),{x:c.left+l.scrollLeft-u.x,y:c.top+l.scrollTop-u.y,width:c.width,height:c.height}}function yt(e){var t=new Map,n=new Set,r=[]
...
if(_t(t,n)){a.rects={reference:vt(t,Be(n),"fixed"===a.options.strategy),popper:ke(n)},a.reset=!1,a.placement=a.options.placement,a.orderedModifiers.forEach((function(e){return a.modifiersData[e.name]=Object.assign({},e.data)}))
...
const Ct="dropdown",Dt="ArrowUp",Lt="ArrowDown",St="click.bs.dropdown.data-api",kt="keydown.bs.dropdown.data-api",Tt="show",Nt='[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled)',It=`${Nt}.show`,Pt=".dropdown-menu",Mt=l()?"top-end":"top-start",qt=l()?"top-start":"top-end",Bt=l()?"bottom-end":"bottom-start",Wt=l()?"bottom-start":"bottom-end",$t=l()?"left-start":"right-start",Rt=l()?"right-start":"left-start",Ht={autoClose:!0,boundary:"clippingParents",display:"dynamic",offset:[0,2],popperConfig:null,reference:"toggle"},Vt={autoClose:"(boolean|string)",boundary:"(string|element)",display:"string",offset:"(array|string|function)",popperConfig:"(null|object|function)",reference:"(string|element|object)"}
class Kt extends q{constructor(e,t){super(e,t),this._popper=null,this._parent=this._element.parentNode,this._menu=k.next(this._element,Pt)[0]||k.prev(this._element,Pt)[0]||k.findOne(Pt,this._parent),this._inNavbar=this._detectNavbar()}static get Default(){return Ht}static get DefaultType(){return Vt}static get NAME(){return Ct}toggle(){return this._isShown()?this.hide():this.show()}show(){if(i(this._element)||this._isShown())return
...
if(t&&!n)return
e.preventDefault()
const o=this.matches(Nt)?this:k.prev(this,Nt)[0]||k.next(this,Nt)[0]||k.findOne(Nt,e.delegateTarget.parentNode),i=Kt.getOrCreateInstance(o)
if(r)return e.stopPropagation(),i.show(),void i._selectMenuItem(e)
i._isShown()&&(e.stopPropagation(),i.hide(),o.focus())}}L.on(document,kt,Nt,Kt.dataApiKeydownHandler),L.on(document,kt,Pt,Kt.dataApiKeydownHandler),L.on(document,St,Kt.clearMenus),L.on(document,"keyup.bs.dropdown.data-api",Kt.clearMenus),L.on(document,St,Nt,(function(e){e.preventDefault(),Kt.getOrCreateInstance(this).toggle()})),u(Kt),document.addEventListener("DOMContentLoaded",(function(){if(document.getElementById("prism-css").media="all",document.getElementById("toggle-offcanvas").addEventListener("click",(function(){document.body.classList.toggle("offcanvas-open")})),0!=document.querySelectorAll(".demo").length&&!document.getElementById("select-theme")){var e=window.themes||["bootstrap5","bootstrap4","default"],t={bootstrap5:"Bootstrap 5",bootstrap4:"Bootstrap 4",default:"Default"},n=localStorage.getItem("theme");-1==e.indexOf(n)&&(n="bootstrap5")
