...
if(!Pt(e,t))return u
function f(){c.forEach((function(e){return e()})),c=[]}return u.setOptions(n).then((function(e){!l&&n.onFirstUpdate&&n.onFirstUpdate(e)})),u}}var qt=Mt(),Bt=Mt({defaultModifiers:[ut,kt,ct,qe]}),Wt=Mt({defaultModifiers:[ut,kt,ct,qe,Lt,jt,Tt,ot,Dt]}),Rt=Object.freeze({__proto__:null,popperGenerator:Mt,detectOverflow:Et,createPopperBase:qt,createPopper:Wt,createPopperLite:Bt,top:le,bottom:ue,right:fe,left:de,auto:pe,basePlacements:me,start:he,end:ge,clippingParents:be,viewport:ve,popper:ye,reference:we,variationPlacements:_e,placements:xe,beforeRead:Oe,read:Ee,afterRead:Ae,beforeMain:je,main:Ce,afterMain:Se,beforeWrite:De,write:Le,afterWrite:ke,modifierPhases:Te,applyStyles:qe,arrow:ot,computeStyles:ct,eventListeners:ut,flip:jt,hide:Dt,offset:Lt,popperOffsets:kt,preventOverflow:Tt})
