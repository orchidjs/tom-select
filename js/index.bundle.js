...
return t&&t.textContent||""}var i=`<div class="p-4">${r.querySelector("textarea").value||""}</div>`,s=o("style"),a=o("script"),c=[`https://cdn.jsdelivr.net/gh/orchidjs/tom-select@1.7.0/dist/css/tom-select.${localStorage.getItem("theme")||"bootstrap4"}.min.css`,"https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/css/bootstrap.min.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"],l=["https://cdn.jsdelivr.net/gh/orchidjs/tom-select@1.7.0/dist/js/tom-select.complete.min.js"]
