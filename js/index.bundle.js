...
return t&&t.textContent||""}var r=`<div class="p-4">${o.querySelector("textarea").value||""}</div>`,i=e("style"),s=e("script"),a=[`https://cdn.jsdelivr.net/gh/orchidjs/tom-select@1.7.5/dist/css/tom-select.${localStorage.getItem("theme")||"bootstrap4"}.min.css`,"https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/css/bootstrap.min.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"],c=["https://cdn.jsdelivr.net/gh/orchidjs/tom-select@1.7.5/dist/js/tom-select.complete.min.js"]
