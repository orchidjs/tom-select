...
t[e]()}}))}}D.on(document,"click.bs.tab.data-api",'[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',(function(e){["A","AREA"].includes(this.tagName)&&e.preventDefault(),i(this)||I.getOrCreateInstance(this).show()})),u(I)
...
for(var n=je(e);de(n)&&["html","body"].indexOf(le(n))<0;){var r=Ee(n)
...
function Me(e){var t,n=e.popper,r=e.popperRect,o=e.placement,i=e.variation,s=e.offsets,a=e.position,c=e.gpuAcceleration,l=e.adaptive,u=e.roundOffsets,f=e.isFixed,d=!0===u?function(e){var t=e.x,n=e.y,r=window.devicePixelRatio||1
return{x:be(t*r)/r||0,y:be(n*r)/r||0}}(s):"function"==typeof u?u(s):s,p=d.x,m=void 0===p?0:p,h=d.y,g=void 0===h?0:h,v=s.hasOwnProperty("x"),b=s.hasOwnProperty("y"),y=$,w=H,x=window
if(l){var E=Le(n),O="clientHeight",_="clientWidth"
E===ue(n)&&"static"!==Ee(E=_e(n)).position&&"absolute"===a&&(O="scrollHeight",_="scrollWidth"),E=E,(o===H||(o===$||o===W)&&i===K)&&(w=R,g-=(f&&x.visualViewport?x.visualViewport.height:E[O])-r.height,g*=c?1:-1),o!==$&&(o!==H&&o!==R||i!==K)||(y=W,m-=(f&&x.visualViewport?x.visualViewport.width:E[_])-r.width,m*=c?1:-1)}var j,A=Object.assign({position:a},l&&Pe)
return c?Object.assign({},A,((j={})[w]=b?"0":"",j[y]=v?"0":"",j.transform=(x.devicePixelRatio||1)<=1?"translate("+m+"px, "+g+"px)":"translate3d("+m+"px, "+g+"px, 0)",j)):Object.assign({},A,((t={})[w]=b?g+"px":"",t[y]=v?m+"px":"",t.transform="",t))}var qe={name:"computeStyles",enabled:!0,phase:"beforeWrite",fn:function(e){var t=e.state,n=e.options,r=n.gpuAcceleration,o=void 0===r||r,i=n.adaptive,s=void 0===i||i,a=n.roundOffsets,c=void 0===a||a,l={placement:he(t.placement),variation:Te(t.placement),popper:t.elements.popper,popperRect:t.rects.popper,gpuAcceleration:o,isFixed:"fixed"===t.options.strategy}
...
return"rtl"===Ee(o||n).direction&&(a+=ge(n.clientWidth,o?o.clientWidth:0)-i),{width:i,height:s,x:a,y:c}}(_e(e)))}function Xe(e,t,n){var r="clippingParents"===t?function(e){var t=Ue(je(e)),n=["absolute","fixed"].indexOf(Ee(e).position)>=0,r=n&&de(e)?Le(e):e
return fe(r)?t.filter((function(e){return fe(e)&&xe(e,r)&&"body"!==le(e)&&(!n||"static"!==Ee(e).position)})):[]}(e):[].concat(t),o=[].concat(r,[n]),i=o[0],s=o.reduce((function(t,n){var r=Qe(e,n)
...
if(E){if(i){var N,S="y"===w?H:$,k="y"===w?R:W,C="y"===w?"height":"width",T=E[w],P=T+g[S],M=T-g[k],q=p?-_[C]/2:0,B=b===F?O[C]:_[C],I=b===F?-_[C]:-O[C],V=t.elements.arrow,Y=p&&V?we(V):{width:0,height:0},K=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:{top:0,right:0,bottom:0,left:0},U=K[S],z=K[k],Q=Ne(0,O[C],Y[C]),X=y?O[C]/2-q-Q-U-A.mainAxis:B-Q-U-A.mainAxis,G=y?-O[C]/2+q+Q+z+A.mainAxis:I+Q+z+A.mainAxis,J=t.elements.arrow&&Le(t.elements.arrow),Z=J?"y"===w?J.clientTop||0:J.clientLeft||0:0,ee=null!=(N=null==L?void 0:L[w])?N:0,te=T+G-ee,ne=Ne(p?ve(P,T+X-ee-Z):P,T,p?ge(M,te):M)
...
if(e.key!==wt)return e.key===Et||e.key===Ot?(t||r.show(),void r._selectMenuItem(e)):void(t&&e.key!==xt||It.clearMenus())
r.hide()}}D.on(document,At,Dt,It.dataApiKeydownHandler),D.on(document,At,Nt,It.dataApiKeydownHandler),D.on(document,jt,It.clearMenus),D.on(document,"keyup.bs.dropdown.data-api",It.clearMenus),D.on(document,jt,Dt,(function(e){e.preventDefault(),It.getOrCreateInstance(this).toggle()})),u(It),document.addEventListener("DOMContentLoaded",(function(){if(document.getElementById("prism-css").media="all",document.getElementById("toggle-offcanvas").addEventListener("click",(function(){document.body.classList.toggle("offcanvas-open")})),0!=document.querySelectorAll(".demo").length&&!document.getElementById("select-theme")){var e=window.themes||["bootstrap5","bootstrap4","default"],t={bootstrap5:"Bootstrap 5",bootstrap4:"Bootstrap 4",default:"Default"},n=localStorage.getItem("theme");-1==e.indexOf(n)&&(n="bootstrap5")
...
return t&&t.textContent||""}var o=`<div class="p-4">${r.querySelector("textarea").value||""}</div>`,i=e("style"),s=e("script"),a=[`https://cdn.jsdelivr.net/npm/tom-select@2.0.0-rc.5/dist/css/tom-select.${localStorage.getItem("theme")||"bootstrap4"}.min.css`,"https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/css/bootstrap.min.css","https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css"],c=["https://cdn.jsdelivr.net/npm/tom-select@2.0.0-rc.5/dist/js/tom-select.complete.min.js"]
