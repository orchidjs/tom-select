...
g.items=t}})(),Object.assign({},a,g,t)}function v(e){if(e.jquery)return e[0]
...
l.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(l,null)).getPropertyValue("direction"),this.settings=f(l,t),this.input=l,this.tabIndex=l.tabIndex||0,this.is_select_tag="select"===l.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.isRequired=l.required,this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(s=this.settings.load,n=this.settings.loadThrottle,function(e,t){var i=this
...
t&&t.setAttribute("for",a+"-tomselected")}if(d.settings.copyClassesToDropdown&&O(s,r),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),O([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&c.setAttribute("multiple","multiple"),d.settings.placeholder&&i.setAttribute("placeholder",p.placeholder),!d.settings.splitOn&&d.settings.delimiter){var f=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
return i}refreshOptions(e=!0){var t,i,s,n,o,l,a,p,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),w=v.activeOption&&d(v.activeOption.dataset.value),C=v.settings.shouldOpen||!1
...
for(r||(r=v.render("option",e)),l=e[v.settings.optgroupField]||"",i=0,s=(a=Array.isArray(l)?l:[l])&&a.length;i<s;i++)l=a[i],v.optgroups.hasOwnProperty(l)||(l=""),g.hasOwnProperty(l)||(g[l]=document.createDocumentFragment(),o.push(l)),i>0&&(r=r.cloneNode(!0),b(r,"active")),g[l].appendChild(r)}for(l of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),p=document.createDocumentFragment(),o))if(v.optgroups.hasOwnProperty(l)&&g[l].children.length){let e=document.createDocumentFragment()
...
e=Object.assign({title:"Untitled",headerClass:"dropdown-header",titleRowClass:"dropdown-header-title",labelClass:"dropdown-header-label",closeClass:"dropdown-header-close",html:e=>'<div class="'+e.headerClass+'"><div class="'+e.titleRowClass+'"><span class="'+e.labelClass+'">'+e.title+'</span><a class="'+e.closeClass+'">&times;</a></div></div>'},e),t.hook("after","setup",(()=>{var i=v(e.html(e)),s=i.querySelector("."+e.closeClass)
s&&s.addEventListener("click",(e=>{u(e,!0),t.close()})),t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),S.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
...
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),S.define("input_autogrow",(function(){var e=this
e.hook("after","setup",(()=>{var t=document.createElement("span"),i=this.control_input
t.style.cssText="position:absolute; top:-99999px; left:-99999px; width:auto; padding:0; white-space:pre; ",e.wrapper.appendChild(t)
for(const e of["letterSpacing","fontSize","fontFamily","fontWeight","textTransform"])t.style[e]=i.style[e]
var s=()=>{this.items.length>0?(t.textContent=i.value,i.style.width=t.clientWidth+"px"):i.style.width=""}
s(),this.on("update item_add item_remove",s),h(i,"input",s),h(i,"keyup",s),h(i,"blur",s),h(i,"update",s)}))})),S.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),S.define("no_active_items",(function(e){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),S.define("optgroup_columns",(function(){var e=this,t=e.onKeyDown
e.hook("instead","onKeyDown",(function(i){var s,n,o,r
if(!e.isOpen||37!==i.keyCode&&39!==i.keyCode)return t.apply(e,arguments)
r=I(e.activeOption,"[data-group]"),s=_(e.activeOption,"[data-selectable]"),(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),S.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
