...
function r(i,s,r){return i||(i=w('<option value="'+z(s)+'">'+z(r)+"</option>")),i!=n&&t.input.append(i),e.push(i),(i!=n||o>0)&&(i.selected=!0),i}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?r(n,"",""):t.items.forEach((n=>{if(i=t.options[n],s=i[t.settings.labelField]||"",e.includes(i.$option)){r(t.input.querySelector(`option[value="${G(n)}"]:not(:checked)`),n,s)}else i.$option=r(i.$option,n,s)}))}else t.input.value=t.getValue()
