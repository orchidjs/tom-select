...
return i||(e.setAttribute("id",t),t)},N=e=>e.replace(/[\\"']/g,"\\$&"),z=(e,t)=>{t&&e.append(t)}
...
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&C(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),C(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":b}),y=D(a,n.inputId+"-tomselected")
let I="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",_=document.querySelector(I)
if(_){C(_,{for:y})
let e=D(_,n.inputId+"-ts-label")
...
t=g(t),e.settings.placeholder&&C(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.on("initialize",(()=>{C(e.wrapper,{tabindex:e.input.disabled?"-1":""+e.tabIndex}),V(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
let i=g('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),K.define("input_autogrow",(function(){var e=this
...
r=w(e.activeOption,"[data-group]"),s=_(e.activeOption,"[data-selectable]"),r&&(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),K.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
