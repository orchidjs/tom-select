...
t=v(t),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{e.wrapper.setAttribute("tabindex",e.input.disabled?"-1":e.tabIndex),h(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}})),e.dropdown.insertBefore(t,e.dropdown.firstChild)}))})),S.define("input_autogrow",(function(e){var t=this
