...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.ignoreBlur=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}}
var s,n,r,a=v(e)
...
const g={passive:!0}
if(o=d.settings.mode,r=c.getAttribute("class")||"",O(e=v("<div>"),p.wrapperClass,r,o),O(t=v('<div class="items">'),p.inputClass),e.append(t),O(s=d.render("dropdown"),p.dropdownClass,o),O(n=v('<div style="scroll-behavior: smooth;">'),p.dropdownContentClass),s.append(n),v(p.dropdownParent||e).appendChild(s),p.controlInput)i=v(p.controlInput)
...
t&&t.setAttribute("for",l+"-tomselected")}if(d.settings.copyClassesToDropdown&&O(s,r),e.style.width=c.style.width,d.plugins.names.length&&(a="plugin-"+d.plugins.names.join(" plugin-"),O([e,s],a)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&c.setAttribute("multiple","multiple"),d.settings.placeholder&&i.setAttribute("placeholder",p.placeholder),!d.settings.splitOn&&d.settings.delimiter){var f=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
var s=I(e.target,"."+d.settings.itemClass,t)
...
u(e,!0),t&&d.onOptionSelect(e,t)},y=()=>{d.isOpen&&d.positionDropdown()}
h(document,"mousedown",m),h(window,"sroll",y,g),h(window,"resize",y,g),d._destroy=()=>{document.removeEventListener("mousedown",m),window.removeEventListener("sroll",y),window.removeEventListener("resize",y)}
for(var b=[];c.children.length>0;)b.push(c.children[0]),c.children[0].remove()
this.revertSettings={children:b,tabIndex:c.tabIndex},c.tabIndex=-1,c.setAttribute("hidden","hidden"),c.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,h(c,"invalid",(e=>{u(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,c.disabled&&d.disable(),d.on("change",this.onChange),O(c,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
break
case 27:return t.isOpen&&(u(e,!0),t.close()),void t.clearActiveItems()
case 40:if(!t.isOpen&&t.hasOptions)t.open()
else if(t.activeOption){let e=t.getAdjacent(t.activeOption,1)
e&&t.setActiveOption(e)}return void u(e)
...
this.activeOption=e,O(e,"active"),t=this.dropdown_content.clientHeight
let n=this.dropdown_content.scrollTop||0
i=this.activeOption.offsetHeight,(s=this.activeOption.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+n)+i>t+n?this.dropdown_content.scrollTop=s-t+i:s<n&&(this.dropdown_content.scrollTop=s)}clearActiveOption(){this.activeOption&&b(this.activeOption,"active"),this.activeOption=null}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(O(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
...
return i}refreshOptions(e=!0){var t,i,s,n,o,a,l,p,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),w=v.activeOption&&d(v.activeOption.dataset.value),C=v.settings.shouldOpen||!1
...
for(r||(r=v.render("option",e)),a=e[v.settings.optgroupField]||"",i=0,s=(l=Array.isArray(a)?a:[a])&&l.length;i<s;i++)a=l[i],v.optgroups.hasOwnProperty(a)||(a=""),g.hasOwnProperty(a)||(g[a]=document.createDocumentFragment(),o.push(a)),i>0&&(r=r.cloneNode(!0),b(r,"active")),g[a].appendChild(r)}for(a of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),p=document.createDocumentFragment(),o))if(v.optgroups.hasOwnProperty(a)&&g[a].children.length){let e=document.createDocumentFragment()
...
t&&O(t,"selected")}var I=e=>{let t=v.render(e,{input:m})
return t&&(C=!0,v.dropdown_content.insertBefore(t,v.dropdown_content.firstChild)),t}
if(v.settings.shouldLoad.call(v,m)?v.loading?I("loading"):0===y.items.length&&I("no_results"):I("not_loading"),(c=v.canCreate(m))&&(h=I("option_create")),v.hasOptions=y.items.length>0||c,C){if(y.items.length>0){if(!(u=w&&v.getOption(w))||!v.dropdown_content.contains(u)){let e=0
...
return"function"!=typeof r?null:(n=r.call(this,t,p))?(n=v(n),"option"===e||"option_create"===e?t[o.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[o.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[o.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),O(n,"item"===e?o.settings.itemClass:o.settings.optionClass),o.renderCache[e][i]=n),n):n}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
...
var e=f(t.input,{})
t.setupOptions(e.options,e.optgroups),t.setValue(e.items)}}))})),S.define("checkbox_options",(function(e){var t=this,i=t.onOptionSelect
t.settings.hideSelected=!1
var s=function(e){var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}
t.hook("after","setupTemplates",(()=>{var e=t.settings.render.option
t.settings.render.option=function(i){var s=v(e.apply(t,arguments)),n=document.createElement("input")
n.addEventListener("click",(function(e){u(e)})),n.type="checkbox"
var o=d(i[t.settings.valueField])
return t.items.indexOf(o)>-1&&(n.checked=!0),s.prepend(n),s}})),t.on("item_remove",(e=>{var i=t.getOption(e)
i&&(i.classList.remove("selected"),s(i))})),t.hook("instead","onOptionSelect",(function(e,s){return s.classList.contains("selected")?(s.classList.remove("selected"),t.removeItem(s.dataset.value),t.refreshOptions(),void u(e,!0)):i.apply(t,arguments)})),t.hook("after","onOptionSelect",((e,t)=>{s(t)}))})),S.define("clear_button",(function(e){var t=this
e=Object.assign({className:"clear-button",title:"Clear All",html:e=>`<div class="${e.className}" title="${e.title}">&times;</div>`},e),t.hook("after","setup",(()=>{var i=v(e.html(e))
i.addEventListener("click",(e=>{for(;t.items.length>0;)t.removeItem(t.items[0])
e.preventDefault(),e.stopPropagation()})),t.control.appendChild(i)}))})),S.define("drag_drop",(function(e){var t=this
...
t=v(t),e.settings.placeholder&&t.setAttribute("placeholder",e.settings.placeholder),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{e.wrapper.setAttribute("tabindex",e.input.disabled?"-1":e.tabIndex),h(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=v('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),S.define("input_autogrow",(function(e){var t=this
...
s(),this.on("update item_add item_remove",s),h(i,"input",s),h(i,"keyup",s),h(i,"blur",s),h(i,"update",s)}))})),S.define("no_backspace_delete",(function(e){var t=this,i=t.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!t.activeItems.length&&i.apply(t,arguments)}))})),S.define("no_active_items",(function(e){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),S.define("optgroup_columns",(function(e){var t=this,i=t.onKeyDown
t.hook("instead","onKeyDown",(function(e){var s,n,o,r
if(!t.isOpen||37!==e.keyCode&&39!==e.keyCode)return i.apply(t,arguments)
r=I(t.activeOption,"[data-group]"),s=_(t.activeOption,"[data-selectable]"),(r=37===e.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&t.setActiveOption(n)}))})),S.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),S}))
