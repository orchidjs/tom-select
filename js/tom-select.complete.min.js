...
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&V(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),V(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=I(i,c.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(c.inputId)+"']",v=document.querySelector(f)
if(v){V(v,{for:a}),V(n,{"aria-labelledby":I(v,c.inputId+"-ts-label")})}var m,y,O
...
t&&(c.onOptionSelect(e,t),b(e,!0))})),w(t,"click",(e=>{var s=E(e.target,"."+c.settings.itemClass,t)
