...
s&&e.onItemSelect(t,s)?M(t,!0):""==i.value&&(e.onClick(),M(t,!0))})),B(a,"keydown",(t=>e.onKeyDown(t))),B(i,"keypress",(t=>e.onKeyPress(t))),B(i,"input",(t=>e.onInput(t))),B(a,"resize",(()=>e.positionDropdown()),c),B(a,"blur",(t=>e.onBlur(t))),B(a,"focus",(t=>e.onFocus(t))),B(i,"paste",(t=>e.onPaste(t)))
...
y(i,(e=>{e=D(e),this.options[e]?t.addItem(e):t.createItem(e)}))}}),0)}onKeyPress(e){var t=this
...
t&&(e.classList.contains("selected")?t.checked=!0:t.checked=!1)}),1)}
...
const t=e.onBlur
e.hook("instead","onBlur",(i=>{if(!i||i.relatedTarget!=e.control_input)return t.call(e)})),B(e.control_input,"blur",(()=>e.onBlur())),e.hook("before","close",(()=>{e.isOpen&&e.focus_node.focus({preventScroll:!0})}))}))})),X.define("input_autogrow",(function(){var e=this
...
return o.appendChild(r),B(r,"mousedown",(e=>{M(e,!0)})),B(r,"click",(e=>{M(e,!0),i.isLocked||i.shouldDelete([o],e)&&(i.removeItem(o),i.refreshOptions(!1),i.inputState())})),o}}))}})),X.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
