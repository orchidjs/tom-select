...
t&&(u=t.textContent)}var p,h,g,f,v,m,b={placeholder:u,options:[],optgroups:[],items:[],maxItems:null}
return"select"===d?(h=b.options,g={},f=1,v=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
...
c[n]=c[n]||e.textContent,c[o]=c[o]||s,c[r]=c[r]||e.disabled,c[l]=c[l]||t,c.$option=e,g[s]=c,h.push(c)}e.selected&&b.items.push(s)}},b.maxItems=e.hasAttribute("multiple")?null:1,P(e.children,(e=>{var t,i,s
"optgroup"===(p=e.tagName.toLowerCase())?((s=v(t=e))[a]=s[a]||t.getAttribute("label")||"",s[c]=s[c]||f++,s[r]=s[r]||t.disabled,b.optgroups.push(s),i=s[c],P(t.children,(e=>{m(e,i)}))):"option"===p&&m(e)}))):(()=>{const t=e.getAttribute(s)
if(t)b.options=JSON.parse(t),P(b.options,(e=>{b.items.push(e[o])}))
else{var r=e.value.trim()||""
if(!i.allowEmptyOption&&!r.length)return
const t=r.split(i.delimiter)
P(t,(e=>{const t={}
t[n]=e,t[o]=e,b.options.push(t)})),b.items=t}})(),Object.assign({},J,b,t)}var ae=0
...
return!(t&&-1!==s.items.indexOf(t))}))),t}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,c,d,u
const p={},h=[]
var g,f=this,v=f.inputValue(),m=f.search(v),b=null,y=f.settings.shouldOpen||!1,O=f.dropdown_content
for(f.activeOption&&(c=f.activeOption.dataset.value,d=f.activeOption.closest("[data-group]")),n=m.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(y=!0),t=0;t<n;t++){let e=m.items[t]
if(!e)continue
let n=e.id,l=f.options[n]
if(void 0===l)continue
let a=X(n),u=f.getOption(a,!0)
for(f.settings.hideSelected||u.classList.toggle("selected",f.items.includes(a)),o=l[f.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++){o=r[i],f.optgroups.hasOwnProperty(o)||(o="")
let e=p[o]
void 0===e&&(e=document.createDocumentFragment(),h.push(o)),i>0&&(u=u.cloneNode(!0),K(u,{id:l.$id+"-clone-"+i,"aria-selected":null}),u.classList.add("ts-cloned"),N(u,"active")),b||c!=n||(d?d.dataset.group===o.toString()&&(b=u):b=u),e.appendChild(u),p[o]=e}}f.settings.lockOptgroupOrder&&h.sort(((e,t)=>{const i=f.optgroups[e],s=f.optgroups[t]
return(i&&i.$order||0)-(s&&s.$order||0)})),l=document.createDocumentFragment(),F(h,(e=>{let t=p[e]
if(!t||!t.children.length)return
let i=f.optgroups[e]
if(void 0!==i){let e=document.createDocumentFragment(),s=f.render("optgroup_header",i)
re(e,s),re(e,t)
let n=f.render("optgroup",{group:i,options:e})
re(l,n)}else re(l,t)})),O.innerHTML="",re(O,l),f.settings.highlight&&(g=O.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
...
if(f.loading?w("loading"):f.settings.shouldLoad.call(f,v)?0===m.items.length&&w("no_results"):w("not_loading"),(a=f.canCreate(v))&&(u=w("option_create")),f.hasOptions=m.items.length>0||a,y){if(m.items.length>0){if(b||"single"!==f.settings.mode||null==f.items[0]||(b=f.getOption(f.items[0])),!O.contains(b)){let e=0
u&&!f.settings.addPrecedence&&(e=1),b=f.selectable()[e]}}else u&&(b=u)
e&&!f.isOpen&&(f.open(),f.scrollToOption(b,"auto")),f.setActiveOption(b)}else f.clearActiveOption(),e&&f.isOpen&&f.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e,t=!1){const i=this
...
function l(e,i,s){return e||(e=T('<option value="'+Y(i)+'">'+Y(s)+"</option>")),e!=n&&t.input.append(e),o.push(e),(e!=n||r>0)&&(e.selected=!0),e}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?l(n,"",""):t.items.forEach((e=>{if(i=t.options[e],s=i[t.settings.labelField]||"",o.includes(i.$option)){l(t.input.querySelector(`option[value="${oe(e)}"]:not(:checked)`),e,s)}else i.$option=l(i.$option,e,s)}))}else t.input.value=t.getValue()
...
t.call(e,s,n),i(n)}))})),ce.define("clear_button",(function(e){const t=this,i=Object.assign({className:"clear-button",title:"Clear All",html:e=>`<div class="${e.className}" title="${e.title}">&times;</div>`},e)
