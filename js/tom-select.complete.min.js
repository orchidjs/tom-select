...
return function(n,r){i&&(this.loading=Math.max(this.loading-1,0)),clearTimeout(i),i=setTimeout((function(){i=null,s.loadedSearches[n]=!0,e.call(s,n,r)}),t)}}function u(e,t,i){var s,n=e.trigger,r={}
...
t&&t.setAttribute("for",a+"-tomselected")}if(d.settings.copyClassesToDropdown&&w(s,o),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),w([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&c.setAttribute("multiple","multiple"),d.settings.placeholder&&i.setAttribute("placeholder",p.placeholder),!d.settings.splitOn&&d.settings.delimiter){var f=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
d.settings.splitOn=new RegExp("\\s*"+f+"+\\s*")}d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=c.type,g(s,"mouseenter",(e=>{var t=A(e.target,"[data-selectable]",s)
...
var y=e=>{var t=A(e.target,"[data-selectable]",d.dropdown)
t||d.wrapper.contains(e.target)?(h(e,!0),t&&d.onOptionSelect(e,t)):d.isFocused&&d.blur(e.target)},O=()=>{d.isOpen&&d.positionDropdown()},b=()=>{d.ignoreHover=!1}
g(document,"mousedown",y),g(window,"sroll",O,u),g(window,"resize",O,u),g(window,"mousemove",b,u),d._destroy=()=>{document.removeEventListener("mousedown",y),window.removeEventListener("mousemove",b),window.removeEventListener("sroll",O),window.removeEventListener("resize",O)}
...
e&&w(e,"selected")}var I=e=>{let t=f.render(e,{input:m})
...
return"option"!==e&&"item"!==e||(i=d(t[r.settings.valueField]),!r.renderCache[e].hasOwnProperty(i))?(n=r.settings.render[e].call(this,t,p))?(n=m(n),"option"===e||"option_create"===e?t[r.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[r.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[r.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),w(n,"item"===e?r.settings.itemClass:r.settings.optionClass),r.renderCache[e][i]=n),n):n:r.renderCache[e][i]}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
