...
const u={passive:!0}
if(r=p.settings.mode,o=c.getAttribute("class")||"",w(e=m("<div>"),d.wrapperClass,o,r),w(t=m('<div class="items">'),d.inputClass),e.append(t),w(s=p.render("dropdown"),d.dropdownClass,r),w(n=m('<div style="scroll-behavior: smooth;">'),d.dropdownContentClass),s.append(n),m(d.dropdownParent||e).appendChild(s),d.controlInput)i=m(d.controlInput)
...
t&&t.setAttribute("for",a+"-tomselected")}if(p.settings.copyClassesToDropdown&&w(s,o),e.style.width=c.style.width,p.plugins.names.length&&(l="plugin-"+p.plugins.names.join(" plugin-"),w([e,s],l)),(null===d.maxItems||d.maxItems>1)&&p.is_select_tag&&c.setAttribute("multiple","multiple"),p.settings.placeholder&&i.setAttribute("placeholder",d.placeholder),!p.settings.splitOn&&p.settings.delimiter){var f=p.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
p.settings.splitOn=new RegExp("\\s*"+f+"+\\s*")}p.control=t,p.control_input=i,p.wrapper=e,p.dropdown=s,p.dropdown_content=n,p.control_input.type=c.type,g(s,"mouseenter",(e=>{var t=A(e.target,"[data-selectable]",s)
if(t)return p.onOptionHover(e,t)}),{capture:!0}),g(t,"mousedown",(e=>{var i=A(e.target,"."+p.settings.itemClass,t)
...
var y=e=>{var t=A(e.target,"[data-selectable]",p.dropdown)
t||p.wrapper.contains(e.target)?(h(e,!0),t&&p.onOptionSelect(e,t)):p.isFocused&&p.blur(e.target)},O=()=>{p.isOpen&&p.positionDropdown()},b=()=>{p.ignoreHover=!1}
g(document,"mousedown",y),g(window,"sroll",O,u),g(window,"resize",O,u),g(window,"mousemove",b,u),p._destroy=()=>{document.removeEventListener("mousedown",y),window.removeEventListener("mousemove",b),window.removeEventListener("sroll",O),window.removeEventListener("resize",O)}
for(var C=[];c.children.length>0;)C.push(c.children[0]),c.children[0].remove()
this.revertSettings={children:C,tabindex:c.getAttribute("tabindex")},c.tabIndex=-1,c.setAttribute("hidden","hidden"),c.insertAdjacentElement("afterend",p.wrapper),p.setValue(d.items),delete d.items,g(c,"invalid",(e=>{h(e),p.isInvalid||(p.isInvalid=!0,p.refreshState())})),p.updateOriginalInput(),p.refreshItems(),p.refreshState(),p.isSetup=!0,c.disabled&&p.disable(),p.on("change",this.onChange),w(c,"tomselected"),p.trigger("initialize"),!0===d.preload&&p.load("")}setupOptions(e,t){var i,s
...
if(t.isFocused){if(e.target!==t.control_input)return"single"===t.settings.mode?t.isOpen?t.close():t.open():t.setActiveItem(),!1}else setTimeout((()=>t.focus()),0)}onChange(){y(this.input,"input"),y(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,y(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){u(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,r,o,a,p=this
if("single"!==p.settings.mode){if(!e)return b(p.activeItems,"active"),p.activeItems=[],void(p.isFocused&&p.showInput())
...
h(t)}else"mousedown"===i&&v(l,t)||"keydown"===i&&v("shiftKey",t)?e.classList.contains("active")?p.removeActiveItem(e):p.setActiveItemClass(e):(b(p.activeItems,"active"),p.activeItems=[],p.setActiveItemClass(e))
...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,d,c,u,h,g,v,f=this,m=f.inputValue(),y=f.search(m),O=f.activeOption&&p(f.activeOption.dataset.value),C=!1
...
r&&(e=p(r.dataset.value),-1!==(i=n.items.indexOf(e))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),b(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.refreshState(),n.updateOriginalInput({silent:t}),n.positionDropdown(),n.trigger("item_remove",e,r)))}createItem(e,t=!0,i){var s,n=this,r=n.caretPos
...
return"option"!==e&&"item"!==e||(i=p(t[r.settings.valueField]),!r.renderCache[e].hasOwnProperty(i))?(n=m(r.settings.render[e].call(this,t,d)),"option"===e||"option_create"===e?t[r.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[r.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[r.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),w(n,"item"===e?r.settings.itemClass:r.settings.optionClass),r.renderCache[e][i]=n),n):r.renderCache[e][i]}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
...
var t=this
if(e.append){var i='<a href="javascript:void(0)" class="'+e.className+'" tabindex="-1" title="'+d(e.title)+'">'+e.label+"</a>"
...
return 8===s.keyCode&&""===t.control_input.value&&(n=t.caretPos-1,t.activeItems.length>0?r=t.options[t.activeItems[0].dataset.value]:0==t.activeItems.length&&n>=0&&n<t.items.length&&(r=t.options[t.items[n]]),r)?(t.deleteSelection(s)&&(t.setTextboxValue(e.text.call(t,r)),t.refreshOptions(!0)),void h(s)):i.apply(t,arguments)}))})),x}))
