...
return i||(e.setAttribute("id",t),t)}function _(e,t){var i=Object.assign({},v,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
if(o=d.settings.mode,r=u.getAttribute("class")||"",k(e=A("<div>"),p.wrapperClass,r,o),k(t=A('<div class="items">'),p.inputClass),e.append(t),k(s=d.render("dropdown"),p.dropdownClass,o),k(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
else{i=A('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&V(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),V(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=I(i,d.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",v=document.querySelector(f)
if(v){V(v,{for:a}),V(n,{"aria-labelledby":I(v,d.inputId+"-ts-label")})}var m,y,O
d.settings.copyClassesToDropdown&&k(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),k([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&V(u,{multiple:"multiple"}),d.settings.placeholder&&V(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,w(s,"click",(e=>{const t=E(e.target,"[data-selectable]")
t&&d.onOptionSelect(e,t)})),w(t,"click",(e=>{var s=E(e.target,"."+d.settings.itemClass,t)
...
w(document,"mousedown",C),w(window,"sroll",_,h),w(window,"resize",_,h),d._destroy=()=>{document.removeEventListener("mousedown",C),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,V(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),k(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
const u={},h=[]
var f,v=this,y=v.inputValue(),O=v.search(y),b=v.activeOption,w=v.settings.shouldOpen||!1,C=v.dropdown_content
...
if(C.innerHTML="",C.append(l),v.settings.highlight&&(f=document.querySelectorAll("span.highlight"),Array.prototype.forEach.call(f,(function(e,t){var i=e.parentNode
i.replaceChild(e.firstChild,e),i.normalize()})),O.query.length&&O.tokens.length))for(const e of O.tokens)g(C,e.regex)
var I=e=>{let t=v.render(e,{input:y})
return t&&(w=!0,C.insertBefore(t,C.firstChild)),t}
if(v.settings.shouldLoad.call(v,y)?v.loading?I("loading"):0===O.items.length&&I("no_results"):I("not_loading"),(a=v.canCreate(y))&&(p=I("option_create")),v.hasOptions=O.items.length>0||a,w){if(O.items.length>0){if(!C.contains(b)&&"single"===v.settings.mode&&v.items.length&&(b=v.getOption(v.items[0])),!C.contains(b)){let e=0
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=A('<option value="'+y(i)+'">'+y(s)+"</option>")),e.selected=!0,V(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{-1==t.items.indexOf(e.value)&&(e.removeAttribute("selected"),e.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
i.addEventListener("click",(e=>{t.clear(),e.preventDefault(),e.stopPropagation()})),t.control.appendChild(i)}))})),N.define("drag_drop",(function(e){var t=this
