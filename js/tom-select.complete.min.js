...
if(i){const s=E(i)
e.setCaret(t>0?s+1:s),e.setActiveItem(),A(i,"last-active")}else e.setCaret(e.caretPos+t)}))})),X.define("dropdown_input",(function(){let e,t=this
t.settings.shouldOpen=!0,t.hook("before","setup",(()=>{t.focus_node=t.control,S(t.control_input,"dropdown-input"),e=w('<div class="dropdown-input-wrap">'),t.dropdown.insertBefore(e,t.dropdown.firstChild)})),t.on("initialize",(()=>{t.control_input.addEventListener("keydown",(e=>{switch(e.keyCode){case 27:return t.isOpen&&(M(e,!0),t.close()),void t.clearActiveItems()
...
const i=t.onBlur
t.hook("instead","onBlur",(e=>{if(!e||e.relatedTarget!=t.control_input)return i.call(t)})),B(t.control_input,"blur",(()=>t.onBlur())),t.hook("before","close",(()=>{t.isOpen&&t.focus_node.focus()}))}))})),X.define("input_autogrow",(function(){var e=this
