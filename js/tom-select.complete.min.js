...
return s=this.prepareSearch(e,t),t=s.options,e=s.query,o=t.score||r._getScoreFunction(s),e.length?p(r.items,((e,n)=>{i=o(e),(!1===t.filter||i>0)&&s.items.push({score:i,id:n})})):p(r.items,((e,t)=>{s.items.push({score:1,id:t})})),(n=r._getSortFunction(s))&&s.items.sort(n),s.total=s.items.length,"number"==typeof t.limit&&(s.items=s.items.slice(0,t.limit)),s}}function g(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function v(e,t){Object.assign(e.style,t)}function m(e,...t){var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function y(e,...t){var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function O(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function b(e){return Array.isArray(e)||(e=[e]),e}function w(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function C(e,t=0){return t>0?e[e.length-1]:e[0]}function I(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function _(e,t){for(const i in t){let s=t[i]
null==s?e.removeAttribute(i):e.setAttribute(i,s)}}function S(e,t){e.parentNode&&e.parentNode.replaceChild(t,e)}const A=(e,t)=>{if(null===t)return
...
function F(e){return null==e?null:L(e)}function L(e){return"boolean"==typeof e?e?"1":"0":e+""}function P(e){return(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(e,t,i){var s,n=e.trigger,o={}
for(s in e.trigger=function(){var i=arguments[0]
if(-1===t.indexOf(i))return n.apply(e,arguments)
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function T(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function q(e,t,i,s){e.addEventListener(t,i,s)}function V(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function j(e,t){const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)}function D(e,t){var i=Object.assign({},k,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
u.items=t}})(),Object.assign({},k,u,t)}var N=0
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},N++
var s=g(e)
if(s.tomselect)throw new Error("Tom Select already initialized on this element")
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),this.settings=D(s,t),this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=j(s,"tomselect-"+N),this.isRequired=s.required,this.sifter=new h(this.options,{diacritics:this.settings.diacritics}),this.setupOptions(this.settings.options,this.settings.optgroups),delete this.settings.optgroups,delete this.settings.options,this.settings.mode=this.settings.mode||(1===this.settings.maxItems?"single":"multi"),"boolean"!=typeof this.settings.hideSelected&&(this.settings.hideSelected="multi"===this.settings.mode),"boolean"!=typeof this.settings.hidePlaceholder&&(this.settings.hidePlaceholder="multi"!==this.settings.mode)
...
const h={passive:!0},f=d.inputId+"-ts-dropdown"
if(o=d.settings.mode,r=u.getAttribute("class")||"",m(e=g("<div>"),p.wrapperClass,r,o),m(t=g('<div class="items">'),p.inputClass),e.append(t),m(s=d._render("dropdown"),p.dropdownClass,o),m(n=g(`<div role="listbox" id="${f}" tabindex="-1">`),p.dropdownContentClass),s.append(n),g(p.dropdownParent||e).appendChild(s),p.controlInput)i=g(p.controlInput)
else{i=g('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&_(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),_(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":f}),a=j(i,d.inputId+"-tomselected")
let v="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",y=document.querySelector(v)
if(y){_(y,{for:a}),_(n,{"aria-labelledby":j(y,d.inputId+"-ts-label")})}var O,b,C
d.settings.copyClassesToDropdown&&m(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),m([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&_(u,{multiple:"multiple"}),d.settings.placeholder&&_(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(O=this.settings.load,b=this.settings.loadThrottle,function(e,t){var i=this
C&&(i.loading=Math.max(i.loading-1,0),clearTimeout(C)),C=setTimeout((function(){C=null,i.loadedSearches[e]=!0,O.call(i,e,t)}),b)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,q(s,"click",(e=>{const t=w(e.target,"[data-selectable]")
t&&(d.onOptionSelect(e,t),T(e,!0))})),q(t,"click",(e=>{var s=w(e.target,"."+d.settings.itemClass,t)
s&&d.onItemSelect(e,s)?T(e,!0):""==i.value&&(d.onClick(),T(e,!0))})),q(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),q(i,"keydown",(e=>d.onKeyDown(e))),q(i,"keyup",(e=>d.onKeyUp(e))),q(i,"keypress",(e=>d.onKeyPress(e))),q(i,"resize",(()=>d.positionDropdown()),h),q(i,"blur",(()=>d.onBlur())),q(i,"focus",(e=>d.onFocus(e))),q(i,"paste",(e=>d.onPaste(e)))
const I=t=>{if(!e.contains(t.target)&&!s.contains(t.target))return d.isFocused&&d.blur(),void d.inputState()
T(t,!0)}
var S=()=>{d.isOpen&&d.positionDropdown()}
q(document,"mousedown",I),q(window,"sroll",S,h),q(window,"resize",S,h),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",S),window.removeEventListener("resize",S)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,_(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),p.items=[],q(u,"invalid",(e=>{T(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.close(!1),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),m(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFull()||t.isInputHidden||t.isLocked?T(e):t.settings.splitOn&&setTimeout((()=>{var e=t.inputValue()
if(e.match(t.settings.splitOn)){var i=e.trim().split(t.settings.splitOn)
for(const e of i)t.createItem(e)}}),0)}onKeyPress(e){var t=this
if(!t.isLocked){var i=String.fromCharCode(e.keyCode||e.which)
return t.settings.create&&"multi"===t.settings.mode&&i===t.settings.delimiter?(t.createItem(),void T(e)):void 0}T(e)}onKeyDown(e){var t=this
if(t.isLocked)9!==e.keyCode&&T(e)
else{switch(e.keyCode){case 65:if(V(x,e))return void t.selectAll()
break
case 27:return t.isOpen&&(T(e,!0),t.close()),void t.clearActiveItems()
case 40:if(!t.isOpen&&t.hasOptions)t.open()
else if(t.activeOption){let e=t.getAdjacent(t.activeOption,1)
e&&t.setActiveOption(e)}return void T(e)
case 38:if(t.activeOption){let e=t.getAdjacent(t.activeOption,-1)
e&&t.setActiveOption(e)}return void T(e)
case 13:return void(t.isOpen&&t.activeOption?(t.onOptionSelect(e,t.activeOption),T(e)):t.settings.create&&t.createItem()&&T(e))
case 37:return void t.advanceSelection(-1,e)
case 39:return void t.advanceSelection(1,e)
case 9:return void(t.settings.selectOnTab&&(t.isOpen&&t.activeOption&&(t.tab_key=!0,t.onOptionSelect(e,t.activeOption),T(e),t.tab_key=!1),t.settings.create&&t.createItem()&&T(e)))
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!V(x,e)&&T(e)}}onKeyUp(e){var t=this
if(t.isLocked)T(e)
else{var i=t.inputValue()
t.lastValue!==i&&(t.lastValue=i,t.settings.shouldLoad.call(t,i)&&t.load(i),t.refreshOptions(),t.trigger("type",i))}}onFocus(e){var t=this,i=t.isFocused
if(t.isDisabled)return t.blur(),void T(e)
...
return!i.isLocked&&"multi"===i.settings.mode&&(T(e),i.setActiveItem(t,e),!0)}canLoad(e){return!!this.settings.load&&!this.loadedSearches.hasOwnProperty(e)}load(e){const t=this
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||y(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
t.value!==e&&(t.value=e,f(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){E(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
if("single"!==a.settings.mode){if(!e)return a.clearActiveItems(),void(a.isFocused&&a.showInput())
if("click"===(i=t&&t.type.toLowerCase())&&V("shiftKey",t)&&a.activeItems.length){for(l=a.getLastActive(),(n=Array.prototype.indexOf.call(a.control.children,l))>(o=Array.prototype.indexOf.call(a.control.children,e))&&(r=n,n=o,o=r),s=n;s<=o;s++)e=a.control.children[s],-1===a.activeItems.indexOf(e)&&a.setActiveItemClass(e)
T(t)}else"click"===i&&V(x,t)||"keydown"===i&&V("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){var t=this.control.querySelector(".last-active")
t&&y(t,"last-active"),m(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
...
for(O&&(c=O.dataset.value,d=O.closest("[data-group]")),n=m.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=f.options[m.items[t].id],n=L(e[f.settings.valueField]),l=f.getOption(n)
...
var C=e=>{let t=f.render(e,{input:v})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(f.settings.shouldLoad.call(f,v)?f.loading?C("loading"):0===m.items.length&&C("no_results"):C("not_loading"),(a=f.canCreate(v))&&(p=C("option_create")),f.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!w.contains(O)&&"single"===f.settings.mode&&f.items.length&&(O=f.getOption(f.items[0])),!w.contains(O)){let e=0
...
var n=i.control
n.insertBefore(i.buffer,n.firstChild),i.buffer=null}addItem(e,t){E(this,t?[]:["change"],(()=>{var i,s
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=g('<option value="'+P(i)+'">'+P(s)+"</option>")),e.selected=!0,_(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{const i=e;-1==t.items.indexOf(i.value)&&(_(i,{selected:null}),i.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
t=e&&8===e.keyCode?-1:1,i={start:(n=o.control_input).selectionStart||0,length:(n.selectionEnd||0)-(n.selectionStart||0)}
const r=[]
if(o.activeItems.length){s=I(C(o.activeItems,t)),t>0&&s++
for(const e of o.activeItems)r.push(e)}else if((o.isFocused||"single"===o.settings.mode)&&o.items.length){const e=o.controlChildren()
t<0&&0===i.start&&0===i.length?r.push(e[o.caretPos-1]):t>0&&i.start===o.inputValue().length&&r.push(e[o.caretPos])}const l=r.map((e=>e.dataset.value))
if(!l.length||"function"==typeof o.settings.onDelete&&!1===o.settings.onDelete.call(o,l,e))return!1
for(T(e,!0),void 0!==s&&o.setCaret(s);r.length;)o.removeItem(r.pop())
return o.showInput(),o.positionDropdown(),o.refreshOptions(!1),!0}advanceSelection(e,t){var i,s,n,o=this
o.rtl&&(e*=-1),o.inputValue().length||(V(x,t)||V("shiftKey",t)?(n=(s=o.getLastActive(e))?s.classList.contains("active")?o.getAdjacent(s,e,"item"):s:e>0?o.control_input.nextElementSibling:o.control_input.previousElementSibling)&&(n.classList.contains("active")&&o.removeActiveItem(s),o.setActiveItemClass(n)):o.isFocused&&!o.activeItems.length?o.setCaret(o.caretPos+e):(s=o.getLastActive(e))&&(i=I(s),o.setCaret(e>0?i+1:i),o.setActiveItem()))}getLastActive(e){let t=this.control.querySelector(".last-active")
if(t)return t
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,y(e.input,"tomselected"),_(e.input,{hidden:null}),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){return"function"!=typeof this.settings.render[e]?null:this._render(e,t)}_render(e,t){var i,s
const n=this
return("option"===e||"item"===e)&&(i=L(t[n.settings.valueField]),s=n.rendered(e,i))?s:(s=n.settings.render[e].call(this,t,P))?(s=g(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?_(s,{"aria-disabled":"true"}):_(s,{"data-selectable":""}):"optgroup"===e&&(_(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&_(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(_(s,{"data-value":i}),"item"===e?m(s,n.settings.itemClass):(m(s,n.settings.optionClass),_(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return R.define("change_listener",(function(){const e=this,t=t=>t.join(e.settings.delimiter)
q(e.input,"change",(()=>{var i=D(e.input,{delimiter:e.settings.delimiter})
t(e.items)!=t(i.items)&&(e.setupOptions(i.options,i.optgroups),e.setValue(i.items))}))})),R.define("checkbox_options",(function(){var e=this,t=e.onOptionSelect
...
n.addEventListener("click",(function(e){T(e)})),n.type="checkbox"
...
s&&(s.classList.remove("selected"),i(s))})),e.hook("instead","onOptionSelect",(function(s,n){if(n.classList.contains("selected"))return n.classList.remove("selected"),e.removeItem(n.dataset.value),e.refreshOptions(),void T(s,!0)
...
s&&s.addEventListener("click",(e=>{T(e,!0),t.close()})),t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),R.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=g(t),e.settings.placeholder&&_(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{_(e.wrapper,{tabindex:e.input.disabled?"-1":""+e.tabIndex}),q(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
...
s(),e.on("update item_add item_remove",s),q(i,"input",s),q(i,"keyup",s),q(i,"blur",s),q(i,"update",s)}))})),R.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
...
r=w(e.activeOption,"[data-group]"),s=I(e.activeOption,"[data-selectable]"),(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),R.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
return s.appendChild(n),q(n,"mousedown",(e=>{T(e,!0)})),q(n,"click",(e=>{if(T(e,!0),!t.isLocked){var i=s.dataset.value
