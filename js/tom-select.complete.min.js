...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function u(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function h(e,t,i,s){e.addEventListener(t,i,s)}function g(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function f(e,t){var i=Object.assign({},l,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,a=i.optgroupField,p=i.optgroupLabelField,c=i.optgroupValueField,u=e.tagName.toLowerCase(),h=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
c[n]=c[n]||e.textContent,c[o]=c[o]||s,c[r]=c[r]||e.disabled,c[a]=c[a]||t,u[s]=c,l.push(c),e.selected&&g.items.push(s)}},m=e=>{var t,i;(i=f(e))[p]=i[p]||e.getAttribute("label")||"",i[c]=i[c]||h++,i[r]=i[r]||e.disabled,g.optgroups.push(i),t=i[c]
...
g.items=t}})(),Object.assign({},l,g,t)}function v(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function y(e,t){Object.assign(e.style,t)}function w(e,...t){var i=b(t);(e=C(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function O(e,...t){var i=b(t);(e=C(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function b(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function C(e){return Array.isArray(e)||(e=[e]),e}function I(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function _(e,t){return t>0?e[e.length-1]:e[0]}function A(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}class S extends(function(e){return e.plugins={},class extends e{static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s,n=this,o=[]
...
a.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(a,null)).getPropertyValue("direction"),this.settings=f(a,t),this.input=a,this.tabIndex=a.tabIndex||0,this.is_select_tag="select"===a.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.isRequired=a.required,this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(s=this.settings.load,n=this.settings.loadThrottle,function(e,t){var i=this
...
const g={passive:!0}
if(o=d.settings.mode,r=c.getAttribute("class")||"",w(e=v("<div>"),p.wrapperClass,r,o),w(t=v('<div class="items">'),p.inputClass),e.append(t),w(s=d.render("dropdown"),p.dropdownClass,o),w(n=v('<div style="scroll-behavior: smooth;">'),p.dropdownContentClass),s.append(n),v(p.dropdownParent||e).appendChild(s),p.controlInput)i=v(p.controlInput)
else{i=v('<input type="text" autocomplete="off" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])c.getAttribute(e)&&i.setAttribute(e,c.getAttribute(e))}if(p.controlInput||(i.tabIndex=c.disabled?-1:d.tabIndex,t.appendChild(i)),l=c.getAttribute("id")){i.setAttribute("id",l+"-tomselected")
let e="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(l)+"']",t=document.querySelector(e)
t&&t.setAttribute("for",l+"-tomselected")}if(d.settings.copyClassesToDropdown&&w(s,r),e.style.width=c.style.width,d.plugins.names.length&&(a="plugin-"+d.plugins.names.join(" plugin-"),w([e,s],a)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&c.setAttribute("multiple","multiple"),d.settings.placeholder&&i.setAttribute("placeholder",p.placeholder),!d.settings.splitOn&&d.settings.delimiter){var f=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
d.settings.splitOn=new RegExp("\\s*"+f+"+\\s*")}d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=c.type,h(s,"mouseenter",(e=>{var t=I(e.target,"[data-selectable]",s)
if(t)return d.onOptionHover(e,t)}),{capture:!0}),h(t,"mousedown",(e=>{if(e.target!=i){var s=I(e.target,"."+d.settings.itemClass,t)
return s?d.onItemSelect(e,s):d.onMouseDown(e)}e.stopPropagation()})),h(t,"click",(e=>d.onClick(e))),h(i,"keydown",(e=>d.onKeyDown(e))),h(i,"keyup",(e=>d.onKeyUp(e))),h(i,"keypress",(e=>d.onKeyPress(e))),h(i,"resize",(()=>d.positionDropdown()),g),h(i,"blur",(e=>d.onBlur(e))),h(i,"focus",(e=>{d.ignoreBlur=!1,d.onFocus(e)})),h(i,"paste",(e=>d.onPaste(e)))
var m=e=>{var t=I(e.target,"[data-selectable]",d.dropdown)
t||d.wrapper.contains(e.target)?(u(e,!0),t&&d.onOptionSelect(e,t)):d.isFocused&&d.blur()},y=()=>{d.isOpen&&d.positionDropdown()},O=()=>{d.ignoreHover=!1}
h(document,"mousedown",m),h(window,"sroll",y,g),h(window,"resize",y,g),h(window,"mousemove",O,g),d._destroy=()=>{document.removeEventListener("mousedown",m),window.removeEventListener("mousemove",O),window.removeEventListener("sroll",y),window.removeEventListener("resize",y)}
...
if(t.isFocused)return"single"!==t.settings.mode&&t.setActiveItem(),t.isOpen?t.close():t.open(),!1
setTimeout((()=>t.focus()),0)}onChange(){m(this.input,"input"),m(this.input,"change")}onPaste(e){var t=this
...
u(t)}else"mousedown"===i&&g(a,t)||"keydown"===i&&g("shiftKey",t)?e.classList.contains("active")?d.removeActiveItem(e):d.setActiveItemClass(e):(O(d.activeItems,"active"),d.activeItems=[],d.setActiveItemClass(e))
d.hideInput(),d.isFocused||d.focus()}}setActiveItemClass(e){var t=this.control.querySelector(".last-active")
t&&O(t,"last-active"),w(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),O(e,"active")}setActiveOption(e,t){var i,s,n
if(e!==this.activeOption&&(this.activeOption&&O(this.activeOption,"active"),this.activeOption=null,e&&(this.activeOption=e,w(e,"active"),t))){i=this.dropdown_content.clientHeight
let e=this.dropdown_content.scrollTop||0
s=this.activeOption.offsetHeight,(n=this.activeOption.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+e)+s>i+e?this.dropdown_content.scrollTop=n-i+s:n<e&&(this.dropdown_content.scrollTop=n)}}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(w(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}hideInput(){this.settings.controlInput||(this.setTextboxValue(""),y(this.control_input,{opacity:0,position:"absolute",left:(this.rtl?1e4:-1e4)+"px"}),this.isInputHidden=!0)}showInput(){this.settings.controlInput||(y(this.control_input,{opacity:1,position:"relative",left:0}),this.isInputHidden=!1)}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
return i}refreshOptions(e=!0){var t,i,s,n,o,a,l,p,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),b=v.activeOption&&d(v.activeOption.dataset.value),C=v.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(C=!0),g={},o=[],t=0;t<n;t++){let e=v.options[y.items[t].id],n=d(e[v.settings.valueField]),r=v.getOption(n)
for(r||(r=v.render("option",e)),a=e[v.settings.optgroupField]||"",i=0,s=(l=Array.isArray(a)?a:[a])&&l.length;i<s;i++)a=l[i],v.optgroups.hasOwnProperty(a)||(a=""),g.hasOwnProperty(a)||(g[a]=document.createDocumentFragment(),o.push(a)),i>0&&(r=r.cloneNode(!0),O(r,"active")),g[a].appendChild(r)}for(a of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),p=document.createDocumentFragment(),o))if(v.optgroups.hasOwnProperty(a)&&g[a].children.length){let e=document.createDocumentFragment()
...
t&&w(t,"selected")}var I=e=>{let t=v.render(e,{input:m})
return t&&(C=!0,v.dropdown_content.insertBefore(t,v.dropdown_content.firstChild)),t}
if(v.settings.shouldLoad.call(v,m)?v.loading?I("loading"):0===y.items.length&&I("no_results"):I("not_loading"),(c=v.canCreate(m))&&(h=I("option_create")),v.hasOptions=y.items.length>0||c,C){if(y.items.length>0){if(!(u=b&&v.getOption(b))||!v.dropdown_content.contains(u)){let e=0
...
l=p.options[e].$order,n!==e&&(delete p.options[e],-1!==(o=p.items.indexOf(e))&&p.items.splice(o,1,n)),t.$order=t.$order||l,p.options[n]=t,r=p.renderCache.item,a=p.renderCache.option,r&&(delete r[e],delete r[n]),a&&(delete a[e],delete a[n]),-1!==p.items.indexOf(n)&&(i=p.getItem(e),s=p.render("item",t),i.classList.contains("active")&&w(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),p.lastQuery=null,p.isOpen&&p.refreshOptions(!1)}}removeOption(e,t){var i=this
e=d(e)
...
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,e.refreshState(),y(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),y(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(){var e=this,t=e.isOpen
...
if(t=e&&8===e.keyCode?-1:1,i={start:(o=r.control_input).selectionStart,length:o.selectionEnd-o.selectionStart},s=[],r.activeItems.length){n=A(_(r.activeItems,t)),t>0&&n++
...
if(0!==e)if(n.rtl&&(e*=-1),g(a,t)||g("shiftKey",t)){s=n.getLastActive(e)
...
return"function"!=typeof r?null:(n=r.call(this,t,p))?(n=v(n),"option"===e||"option_create"===e?t[o.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[o.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[o.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),w(n,"item"===e?o.settings.itemClass:o.settings.optionClass),o.renderCache[e][i]=n),n):n}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return S.define("change_listener",(function(e){var t=this,i=!1
...
e=Object.assign({title:"Untitled",headerClass:"dropdown-header",titleRowClass:"dropdown-header-title",labelClass:"dropdown-header-label",closeClass:"dropdown-header-close",html:e=>'<div class="'+e.headerClass+'"><div class="'+e.titleRowClass+'"><span class="'+e.labelClass+'">'+e.title+'</span><a href="javascript:void(0)" class="'+e.closeClass+'">&times;</a></div></div>'},e),t.hook("after","setup",(()=>{var i=v(e.html(e))
t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),S.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=v(t),e.settings.placeholder&&t.setAttribute("placeholder",e.settings.placeholder),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{e.wrapper.setAttribute("tabindex",e.input.disabled?"-1":e.tabIndex),h(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}})),e.dropdown.insertBefore(t,e.dropdown.firstChild)}))})),S.define("input_autogrow",(function(e){var t=this
...
for(const t of["letterSpacing","fontSize","fontFamily","fontWeight","textTransform"])e.style[t]=i.style[t]
var s=()=>{this.items.length>0?(e.textContent=i.value,i.style.width=e.clientWidth+"px"):i.style.width=""}
s(),this.on("update item_add item_remove",s),h(i,"input",s),h(i,"keyup",s),h(i,"blur",s),h(i,"update",s)}))})),S.define("no_backspace_delete",(function(e){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{})),this.hook("instead","deleteSelection",(()=>{}))})),S.define("optgroup_columns",(function(e){var t=this,i=t.onKeyDown
t.hook("instead","onKeyDown",(function(e){var s,n,o,r
if(!t.isOpen||37!==e.keyCode&&39!==e.keyCode)return i.apply(t,arguments)
t.ignoreHover=!0,r=I(t.activeOption,"[data-group]"),s=A(t.activeOption,"[data-selectable]"),(r=37===e.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&t.setActiveOption(n)}))})),S.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
t.settings.render.item=function(){var s=v(e.apply(t,arguments)),n=v(i)
...
var i=t.onKeyDown
t.hook("instead","onKeyDown",(function(s){var n,o
return 8===s.keyCode&&""===t.control_input.value&&(n=t.caretPos-1,t.activeItems.length>0?o=t.options[t.activeItems[0].dataset.value]:0==t.activeItems.length&&n>=0&&n<t.items.length&&(o=t.options[t.items[n]]),o)?(t.deleteSelection(s)&&(t.setTextboxValue(e.text.call(t,o)),t.refreshOptions(!0)),void u(s)):i.apply(t,arguments)}))})),S}))
