...
return null!==t&&!this.options.hasOwnProperty(t)&&(e.$order=e.$order||++this.order,e.$id=this.inputId+"-opt-"+this.options_i++,this.options[t]=e,t)}registerOptionGroup(e){var t=d(e[this.settings.optgroupValueField])
...
var n=i.control
n.insertBefore(i.buffer,n.firstChild),i.buffer=null}addItem(e,t){c(this,t?[]:["change"],(()=>{var i,s,n=this,o=n.settings.mode
...
n=m('<option value="'+p(i)+'">'+p(e)+"</option>"),s.options[i].$option=n}x(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
