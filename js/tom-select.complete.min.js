...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},m=e=>(e+"").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu,"\\$1"),O=(e,t)=>{var i=e[t]
...
let o=a[i]
if(null==o&&(o="desc"===l[i].direction?-1:1),s=o*b(c(n,e),c(n,t)))return s}return 0}:null}prepareSearch(e,t){const i={}
...
for(v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(e)),o=n[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),T(l,{id:n.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),x(l,"active")),O||c!=e||(d?d.dataset.group===o.toString()&&(O=l):O=l),u[o].appendChild(l)}this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),y(h,(e=>{if(v.optgroups.hasOwnProperty(e)&&u[e].children.length){let t=document.createDocumentFragment(),i=v.render("optgroup_header",v.optgroups[e])
W(t,i),W(t,u[e])
...
if(null==(s=n.settings.render[e].call(this,t,R)))return s
if(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?T(s,{"aria-disabled":"true"}):T(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[n.settings.optgroupValueField],T(s,{"data-group":i}),t.group[n.settings.disabledField]&&T(s,{"data-disabled":""})),"option"===e||"item"===e){const i=H(t[n.settings.valueField])
T(s,{"data-value":i}),"item"===e?(A(s,n.settings.itemClass),T(s,{"data-ts-item":""})):(A(s,n.settings.optionClass),T(s,{role:"option",id:t.$id}),n.options[i].$div=s)}return s}_render(e,t){const i=this.render(e,t)
if(null==i)throw"HTMLElement expected"
return i}clearCache(){y(this.options,((e,t)=>{e.$div&&(e.$div.remove(),delete e.$div)}))}uncacheValue(e){const t=this.getOption(e)
