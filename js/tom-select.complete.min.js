...
let t="",i=[new I]
for(let s=0;s<e.length;s++){let n=e.substring(s).match(h)
...
for(let e of l)S(e,i)||i.push(e)}else if(s>0&&1==a.size&&!a.has("3")){t+=C(i,!1)
let e=new I
const s=i[0]
s&&e.add(s.last()),i=[e]}}return t+=C(i,!0),t},x=(e,t)=>{if(e)return e[t]},k=(e,t)=>{if(e){for(var i,s=t.split(".");(i=s.shift())&&(e=e[i]););return e}},F=(e,t,i)=>{var s,n
...
return N(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\t\n\f\r\s]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},M=e=>(Array.isArray(e)||(e=[e]),e),z=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
