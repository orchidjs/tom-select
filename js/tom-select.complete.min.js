...
e=e.parentNode}}function q(e,t){return t>0?e[e.length-1]:e[0]}function V(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function j(e,t){for(const i in t)e.setAttribute(i,t[i])}var D=0
...
if(o=c.settings.mode,r=u.getAttribute("class")||"",F(e=S("<div>"),p.wrapperClass,r,o),F(t=S('<div class="items">'),p.inputClass),e.append(t),F(s=c.render("dropdown"),p.dropdownClass,o),F(n=S(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),S(p.dropdownParent||e).appendChild(s),p.controlInput)i=S(p.controlInput)
else{i=S('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&j(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),j(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=C(i,c.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(c.inputId)+"']",v=document.querySelector(f)
if(v){j(v,{for:a}),j(n,{"aria-labelledby":C(v,c.inputId+"-ts-label")})}var m,y,O
c.settings.copyClassesToDropdown&&F(s,r),e.style.width=u.style.width,c.plugins.names.length&&(l="plugin-"+c.plugins.names.join(" plugin-"),F([e,s],l)),(null===p.maxItems||p.maxItems>1)&&c.is_select_tag&&j(u,{multiple:"multiple"}),c.settings.placeholder&&j(i,{placeholder:p.placeholder}),!c.settings.splitOn&&c.settings.delimiter&&(c.settings.splitOn=new RegExp("\\s*"+d(c.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),c.control=t,c.control_input=i,c.wrapper=e,c.dropdown=s,c.dropdown_content=n,c.control_input.type=u.type,w(s,"click",(e=>{const t=T(e.target,"[data-selectable]")
t&&c.onOptionSelect(e,t)})),w(t,"click",(e=>{var s=T(e.target,"."+c.settings.itemClass,t)
...
w(document,"mousedown",I),w(window,"sroll",_,h),w(window,"resize",_,h),c._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,j(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",c.wrapper),c.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),c.isInvalid||(c.isInvalid=!0,c.refreshState())})),c.updateOriginalInput(),c.refreshItems(),c.refreshState(),c.inputState(),c.isSetup=!0,u.disabled&&c.disable(),c.on("change",this.onChange),F(u,"tomselected"),c.trigger("initialize"),!0===p.preload&&c.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFocused&&t.isOpen?t.blur():t.focus()}onMouseDown(e){}onChange(){x(this.input,"input"),x(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,x(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){O(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,d,c,p,u,h,f=this,v=f.inputValue(),y=f.search(v),O=f.activeOption&&m(f.activeOption.dataset.value),b=f.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(b=!0),u={},o=[],t=0;t<n;t++){let e=f.options[y.items[t].id],n=m(e[f.settings.valueField]),a=f.getOption(n)
for(a||(a=f.render("option",e)),f.settings.hideSelected||a.classList.toggle("selected",f.items.includes(n)),r=e[f.settings.optgroupField]||"",i=0,s=(l=Array.isArray(r)?r:[r])&&l.length;i<s;i++)r=l[i],f.optgroups.hasOwnProperty(r)||(r=""),u.hasOwnProperty(r)||(u[r]=document.createDocumentFragment(),o.push(r)),i>0&&(a=a.cloneNode(!0),L(a,"active"),a.removeAttribute("aria-selected")),u[r].appendChild(a)}for(r of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(f.optgroups[e]&&f.optgroups[e].$order||0)-(f.optgroups[t]&&f.optgroups[t].$order||0))),a=document.createDocumentFragment(),o))if(f.optgroups.hasOwnProperty(r)&&u[r].children.length){let e=document.createDocumentFragment()
...
if(f.settings.shouldLoad.call(f,v)?f.loading?w("loading"):0===y.items.length&&w("no_results"):w("not_loading"),(d=f.canCreate(v))&&(p=w("option_create")),f.hasOptions=y.items.length>0||d,b){if(y.items.length>0){if(!(c=O&&f.getOption(O))&&"single"===f.settings.mode&&f.items.length&&(c=f.getOption(f.items[0])),!c||!f.dropdown_content.contains(c)){let e=0
p&&!f.settings.addPrecedence&&(e=1),c=f.selectable()[e]}}else c=p
e&&!f.isOpen&&f.open(),f.setActiveOption(c)}else f.clearActiveOption(),e&&f.isOpen&&f.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
t[this.settings.optgroupValueField]=e,(i=this.registerOptionGroup(t))&&this.trigger("optgroup_add",i,t)}removeOptionGroup(e){this.optgroups.hasOwnProperty(e)&&(delete this.optgroups[e],this.clearCache(),this.trigger("optgroup_remove",e))}clearOptionGroups(){this.optgroups={},this.clearCache(),this.trigger("optgroup_clear")}updateOption(e,t){var i,s,n,o,r,l=this
if(e=m(e),n=m(t[l.settings.valueField]),null!==e&&l.options.hasOwnProperty(e)){if("string"!=typeof n)throw new Error("Value must be set in option data")
r=l.options[e].$order,n!==e&&(delete l.options[e],-1!==(o=l.items.indexOf(e))&&l.items.splice(o,1,n)),t.$order=t.$order||r,l.options[n]=t,l.removeValue(e),l.removeValue(n),-1!==l.items.indexOf(n)&&(i=l.getItem(e),s=l.render("item",t),i.classList.contains("active")&&F(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),l.lastQuery=null,l.isOpen&&l.refreshOptions(!1)}}removeOption(e,t){var i=this
e=m(e),i.removeValue(e),delete i.userOptions[e],delete i.options[e],i.lastQuery=null,i.trigger("option_remove",e),i.removeItem(e,t)}clearOptions(){this.loadedSearches={},this.userOptions={},this.clearCache()
var e={}
for(let t in this.options)this.options.hasOwnProperty(t)&&this.items.indexOf(t)>=0&&(e[t]=this.options[t])
this.options=this.sifter.items=e,this.lastQuery=null,this.trigger("option_clear")}removeValue(e){const t=this,i=t.getOption(e),s=t.renderCache.item,n=t.renderCache.option
i&&i.remove(),s&&delete s[e],n&&delete n[e]}getOption(e){if(e=m(e)){const t=this.dropdown_content.querySelector(`[data-selectable][data-value="${_(e)}"]`)
if(t)return t}if(this.renderCache.option.hasOwnProperty(e))return this.renderCache.option[e]}getAdjacent(e,t,i="option"){var s
if(e){s="item"==i?this.controlChildren():this.dropdown_content.querySelectorAll("[data-selectable]")
for(let i=0;i<s.length;i++)if(s[i]==e)return t>0?s[i+1]:s[i-1]}}getItem(e){if(e=m(e))return e=_(e),this.control.querySelector(`[data-value="${e}"]`)}addItems(e,t){var i=this
...
o&&(e=m(o.dataset.value),-1!==(i=n.items.indexOf(e))&&(o.remove(),o.classList.contains("active")&&(s=n.activeItems.indexOf(o),n.activeItems.splice(s,1),L(o,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,o)))}createItem(e,t=!0,i){var s,n=this,o=n.caretPos
...
n=S('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,j(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
...
if(t=e&&8===e.keyCode?-1:1,i={start:(o=r.control_input).selectionStart,length:o.selectionEnd-o.selectionStart},s=[],r.activeItems.length){n=V(q(r.activeItems,t)),t>0&&n++
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,L(e.input,"tomselected"),e.input.removeAttribute("hidden"),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){var i,s,n=this
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=S(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?j(s,{"aria-disabled":"true"}):j(s,{"data-selectable":""}):"optgroup"===e&&(j(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&j(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(j(s,{"data-value":i}),"item"===e?F(s,n.settings.itemClass):(F(s,n.settings.optionClass),j(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}
for(let e in this.options){const t=this.getOption(e)
t&&t.remove()}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
...
t=S(t),e.settings.placeholder&&j(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{j(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex}),w(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
...
r=T(e.activeOption,"[data-group]"),s=V(e.activeOption,"[data-selectable]"),(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),N.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
