...
return i||(e.setAttribute("id",t),t)}function v(e,t){var i=Object.assign({},l,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,a=i.optgroupField,p=i.optgroupLabelField,c=i.optgroupValueField,u=e.tagName.toLowerCase(),h=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
g.items=t}})(),Object.assign({},l,g,t)}function m(e){if(e.jquery)return e[0]
...
return i}function x(e,t){for(const i in t)e.setAttribute(i,t[i])}var k=0
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.ignoreBlur=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},k++
var s,n,r,a=m(e)
if(a.tomselect)throw new Error("Tom Select already initialized on this element")
a.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(a,null)).getPropertyValue("direction"),this.settings=v(a,t),this.input=a,this.tabIndex=a.tabIndex||0,this.is_select_tag="select"===a.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=f(a,"tomselect-"+k),this.isRequired=a.required,this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(s=this.settings.load,n=this.settings.loadThrottle,function(e,t){var i=this
...
for(const e of["autocorrect","autocapitalize","autocomplete"])c.getAttribute(e)&&x(i,{[e]:c.getAttribute(e)})}p.controlInput||(i.tabIndex=c.disabled?-1:d.tabIndex,t.appendChild(i)),x(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":v}),l=f(i,d.inputId+"-tomselected")
let y="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",O=document.querySelector(y)
if(O){x(O,{for:l}),x(n,{"aria-labelledby":f(O,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&b(s,r),e.style.width=c.style.width,d.plugins.names.length&&(a="plugin-"+d.plugins.names.join(" plugin-"),b([e,s],a)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&x(c,{multiple:"multiple"}),d.settings.placeholder&&x(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var w=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
d.settings.splitOn=new RegExp("\\s*"+w+"+\\s*")}d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=c.type,h(s,"mouseenter",(e=>{var t=_(e.target,"[data-selectable]",s)
...
return i}refreshOptions(e=!0){var t,i,s,n,o,a,l,p,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),O=v.activeOption&&d(v.activeOption.dataset.value),b=v.settings.shouldOpen||!1
...
return null!==t&&!this.options.hasOwnProperty(t)&&(e.$order=e.$order||++this.order,e.$id=this.inputId+"-opt-"+Object.keys(this.options).length,this.options[t]=e,t)}registerOptionGroup(e){var t=d(e[this.settings.optgroupValueField])
...
l=p.options[e].$order,n!==e&&(delete p.options[e],-1!==(o=p.items.indexOf(e))&&p.items.splice(o,1,n)),t.$order=t.$order||l,p.options[n]=t,r=p.renderCache.item,a=p.renderCache.option,r&&(delete r[e],delete r[n]),a&&(delete a[e],delete a[n]),-1!==p.items.indexOf(n)&&(i=p.getItem(e),s=p.render("item",t),i.classList.contains("active")&&b(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),p.lastQuery=null,p.isOpen&&p.refreshOptions(!1)}}removeOption(e,t){var i=this
e=d(e)
...
for(let i=0;i<s.length;i++)if(s[i]==e)return t>0?s[i+1]:s[i-1]}}getElementWithValue(e,t){if(null!==(e=d(e)))for(const i of t){let t=i
...
s.is_select_tag?(t=[],s.input.querySelectorAll("option").forEach((function(e){t.push(e.value),-1==s.items.indexOf(e.value)?e.selected=!1:e.selected=!0})),s.items.forEach((function(e){-1==t.indexOf(e)&&(i=s.options[e][s.settings.labelField]||"",s.input.innerHTML+='<option value="'+p(e)+'" selected="selected">'+p(i)+"</option>")}))):s.input.value=s.getValue(),s.isSetup&&(e.silent||s.trigger("change",s.getValue()))}open(){var e=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return F.define("change_listener",(function(e){var t=this,i=!1
h(t.input,"change",(()=>{if(i)i=!1
else{i=!0
var e=v(t.input,{})
t.setupOptions(e.options,e.optgroups),t.setValue(e.items)}}))})),F.define("checkbox_options",(function(e){var t=this,i=t.onOptionSelect
t.settings.hideSelected=!1
var s=function(e){var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}
t.hook("after","setupTemplates",(()=>{var e=t.settings.render.option
t.settings.render.option=function(i){var s=m(e.apply(t,arguments)),n=document.createElement("input")
...
i&&(i.classList.remove("selected"),s(i))})),t.hook("instead","onOptionSelect",(function(e,s){return s.classList.contains("selected")?(s.classList.remove("selected"),t.removeItem(s.dataset.value),t.refreshOptions(),void u(e,!0)):i.apply(t,arguments)})),t.hook("after","onOptionSelect",((e,t)=>{s(t)}))})),F.define("clear_button",(function(e){var t=this
e=Object.assign({className:"clear-button",title:"Clear All",html:e=>`<div class="${e.className}" title="${e.title}">&times;</div>`},e),t.hook("after","setup",(()=>{var i=m(e.html(e))
i.addEventListener("click",(e=>{for(;t.items.length>0;)t.removeItem(t.items[0])
e.preventDefault(),e.stopPropagation()})),t.control.appendChild(i)}))})),F.define("drag_drop",(function(e){var t=this
...
var i=[]
e.children("[data-value]").each((function(){i.push($(this).attr("data-value"))})),t.setValue(i)}})}))}})),F.define("dropdown_header",(function(e){var t=this
e=Object.assign({title:"Untitled",headerClass:"dropdown-header",titleRowClass:"dropdown-header-title",labelClass:"dropdown-header-label",closeClass:"dropdown-header-close",html:e=>'<div class="'+e.headerClass+'"><div class="'+e.titleRowClass+'"><span class="'+e.labelClass+'">'+e.title+'</span><a class="'+e.closeClass+'">&times;</a></div></div>'},e),t.hook("after","setup",(()=>{var i=m(e.html(e)),s=i.querySelector("."+e.closeClass)
s&&s.addEventListener("click",(e=>{u(e,!0),t.close()})),t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),F.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=m(t),e.settings.placeholder&&x(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{x(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex}),h(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=m('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),F.define("input_autogrow",(function(){var e=this
...
s(),this.on("update item_add item_remove",s),h(i,"input",s),h(i,"keyup",s),h(i,"blur",s),h(i,"update",s)}))})),F.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),F.define("no_active_items",(function(e){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),F.define("optgroup_columns",(function(){var e=this,t=e.onKeyDown
...
t.removeItem(i),t.refreshOptions(!1)}})),s}}))}})),F.define("restore_on_backspace",(function(e){var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),F}))
