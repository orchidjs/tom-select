...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},m=e=>(e+"").replace(/([\$\(-\+\.\?\[-\^\{-\}])/g,"\\$1"),y=(e,t)=>{var i=e[t]
...
!e.regex&&s?i+=1/o:i+=f(s,e,1)}else O(n,((s,n)=>{i+=f(r(t,n),e,s)}))
return i/o}
...
return O(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\11\12\14\15\40]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},F=e=>(Array.isArray(e)||(e=[e]),e),L=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
t&&(p=t.textContent)}var u,h,g,v,f,m,y={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===d?(h=y.options,g={},v=1,f=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
...
"optgroup"===(u=e.tagName.toLowerCase())?((s=f(t=e))[a]=s[a]||t.getAttribute("label")||"",s[c]=s[c]||v++,s[r]=s[r]||t.disabled,y.optgroups.push(s),i=s[c],O(t.children,(e=>{m(e,i)}))):"option"===u&&m(e)}))):(()=>{const t=e.getAttribute(s)
if(t)y.options=JSON.parse(t),O(y.options,(e=>{y.items.push(e[o])}))
else{var r=e.value.trim()||""
if(!i.allowEmptyOption&&!r.length)return
const t=r.split(i.delimiter)
O(t,(e=>{const t={}
t[n]=e,t[o]=e,y.options.push(t)})),y.items=t}})(),Object.assign({},D,y,t)}var X=0
...
n==i&&e.isOpen?t.stopPropagation():B(t,!0)},f=()=>{e.isOpen&&e.positionDropdown()},y=()=>{e.ignoreHover=!1}
K(document,"mousedown",v),K(window,"scroll",f,c),K(window,"resize",f,c),K(window,"mousemove",y,c),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("mousemove",y),window.removeEventListener("scroll",f),window.removeEventListener("resize",f),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,K(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),A(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),O(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
O(i,(e=>{e=N(e),this.options[e]?t.addItem(e):t.createItem(e)}))}}),0)}onKeyPress(e){var t=this
...
const u={},h=[]
var g,v=this,f=v.inputValue(),m=v.search(f),y=null,b=v.settings.shouldOpen||!1,w=v.dropdown_content
...
t.replaceChild(e.firstChild,e),t.normalize()})),m.query.length&&m.tokens.length&&O(m.tokens,(e=>{V(w,e.regex)})))
var _=e=>{let t=v.render(e,{input:f})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(v.loading?_("loading"):v.settings.shouldLoad.call(v,f)?0===m.items.length&&_("no_results"):_("not_loading"),(a=v.canCreate(f))&&(p=_("option_create")),v.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!y&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!w.contains(y)){let e=0
...
e=H(e),i.uncacheValue(e),delete i.userOptions[e],delete i.options[e],i.lastQuery=null,i.trigger("option_remove",e),i.removeItem(e,t)}clearOptions(){this.loadedSearches={},this.userOptions={},this.clearCache()
var e={}
O(this.options,((t,i)=>{this.items.indexOf(i)>=0&&(e[i]=this.options[i])})),this.options=this.sifter.items=e,this.lastQuery=null,this.trigger("option_clear")}getOption(e,t=!1){const i=N(e)
...
function l(e,i,s){return e||(e=_('<option value="'+R(i)+'">'+R(s)+"</option>")),e!=n&&t.input.append(e),o.push(e),(e!=n||r>0)&&(e.selected=!0),e}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?l(n,"",""):t.items.forEach((e=>{if(i=t.options[e],s=i[t.settings.labelField]||"",o.includes(i.$option)){l(t.input.querySelector(`option[value="${U(e)}"]:not(:checked)`),e,s)}else i.$option=l(i.$option,e,s)}))}else t.input.value=t.getValue()
...
const l=[]
if(r.activeItems.length)n=E(r.activeItems,t),s=P(n),t>0&&s++,O(r.activeItems,(e=>l.push(e)))
...
var i
a(t)?(i=e.render("loading_more",{query:t}))&&(i.setAttribute("data-selectable",""),o=i):t in r&&!n.querySelector(".no-results")&&(i=e.render("no_more_results",{query:t})),i&&(A(i,e.settings.optionClass),n.append(i))})),e.on("initialize",(()=>{n=e.dropdown_content,e.settings.render=Object.assign({},{loading_more:function(){return'<div class="loading-more-results">Loading more results ... </div>'},no_more_results:function(){return'<div class="no-more-results">No more results</div>'}},e.settings.render),n.addEventListener("scroll",(function(){e.settings.shouldLoadMore.call(e)&&a(e.lastValue)&&(l||(l=!0,e.load.call(e,e.lastValue)))}))}))})),Y}))
