...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function b(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function w(e,t,i,s){e.addEventListener(t,i,s)}function C(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function I(e,t){const i=e.getAttribute("id")
...
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&j(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),j(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=I(i,c.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(c.inputId)+"']",v=document.querySelector(f)
if(v){j(v,{for:a}),j(n,{"aria-labelledby":I(v,c.inputId+"-ts-label")})}var m,y,O
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!C(f,e)&&b(e)}}onKeyUp(e){var t=this
if(t.isLocked)b(e)
...
b(t)}else"click"===i&&C(f,t)||"keydown"===i&&C("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
this.options=this.sifter.items=e,this.lastQuery=null,this.trigger("option_clear")}getOption(e){if(e=m(e)){const t=this.dropdown_content.querySelector(`[data-selectable][data-value="${_(e)}"]`)
