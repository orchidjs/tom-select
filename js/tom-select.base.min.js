...
for(y&&(c=y.dataset.value,d=y.closest("[data-group]")),n=f.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(O=!0),t=0;t<n;t++){let e=f.items[t].id,n=v.options[e],l=v.getOption(e,!0)
