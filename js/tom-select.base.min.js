...
for(var s=t.split(".");s.length&&(e=e[s.shift()]););return e}},n={a:"[aḀḁĂăÂâǍǎȺⱥȦȧẠạÄäÀàÁáĀāÃãÅåąĄÃąĄ]",b:"[b␢βΒB฿𐌁ᛒ]",c:"[cĆćĈĉČčĊċC̄c̄ÇçḈḉȻȼƇƈɕᴄＣｃ]",d:"[dĎďḊḋḐḑḌḍḒḓḎḏĐđD̦d̦ƉɖƊɗƋƌᵭᶁᶑȡᴅＤｄð]",e:"[eÉéÈèÊêḘḙĚěĔĕẼẽḚḛẺẻĖėËëĒēȨȩĘęᶒɆɇȄȅẾếỀềỄễỂểḜḝḖḗḔḕȆȇẸẹỆệⱸᴇＥｅɘǝƏƐε]",f:"[fƑƒḞḟ]",g:"[gɢ₲ǤǥĜĝĞğĢģƓɠĠġ]",h:"[hĤĥĦħḨḩẖẖḤḥḢḣɦʰǶƕ]",i:"[iÍíÌìĬĭÎîǏǐÏïḮḯĨĩĮįĪīỈỉȈȉȊȋỊịḬḭƗɨɨ̆ᵻᶖİiIıɪＩｉ]",j:"[jȷĴĵɈɉʝɟʲ]",k:"[kƘƙꝀꝁḰḱǨǩḲḳḴḵκϰ₭]",l:"[lŁłĽľĻļĹĺḶḷḸḹḼḽḺḻĿŀȽƚⱠⱡⱢɫɬᶅɭȴʟＬｌ]",n:"[nŃńǸǹŇňÑñṄṅŅņṆṇṊṋṈṉN̈n̈ƝɲȠƞᵰᶇɳȵɴＮｎŊŋ]",o:"[oØøÖöÓóÒòÔôǑǒŐőŎŏȮȯỌọƟɵƠơỎỏŌōÕõǪǫȌȍՕօ]",p:"[pṔṕṖṗⱣᵽƤƥᵱ]",q:"[qꝖꝗʠɊɋꝘꝙq̃]",r:"[rŔŕɌɍŘřŖŗṘṙȐȑȒȓṚṛⱤɽ]",s:"[sŚśṠṡṢṣꞨꞩŜŝŠšŞşȘșS̈s̈]",t:"[tŤťṪṫŢţṬṭƮʈȚțṰṱṮṯƬƭ]",u:"[uŬŭɄʉỤụÜüÚúÙùÛûǓǔŰűŬŭƯưỦủŪūŨũŲųȔȕ∪]",v:"[vṼṽṾṿƲʋꝞꝟⱱʋ]",w:"[wẂẃẀẁŴŵẄẅẆẇẈẉ]",x:"[xẌẍẊẋχ]",y:"[yÝýỲỳŶŷŸÿỸỹẎẏỴỵɎɏƳƴ]",z:"[zŹźẐẑŽžŻżẒẓẔẕƵƶ]"},r=function(){var e,t,i,s,r="",o={}
for(i in n)if(n.hasOwnProperty(i))for(r+=s=n[i].substring(2,n[i].length-1),e=0,t=s.length;e<t;e++)o[s.charAt(e)]=i
var a=new RegExp("["+r+"]","g")
return function(e){return e.replace(a,(function(e){return o[e]})).toLowerCase()}}()
...
var i,s,r,o,a=[],l=e.split(/ +/)
for(i=0,s=l.length;i<s;i++){if(r=(l[i]+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),this.settings.diacritics)for(o in n)n.hasOwnProperty(o)&&(r=r.replace(new RegExp(o,"g"),n[o]))
t&&(r="\\b"+r),a.push({string:l[i],regex:new RegExp(r,"i")})}return a}iterator(e,t){(Array.isArray(e)?Array.prototype.forEach||function(e){for(var t=0,i=this.length;t<i;t++)e(this[t],t,this)}:function(e){for(var t in this)this.hasOwnProperty(t)&&e(this[t],t,this)}).apply(e,[t])}getScoreFunction(e,t){var i,n,r,o,a
a=this.prepareSearch(e,t),n=a.tokens,i=a.options.fields,r=n.length,o=a.options.nesting
var l,d=function(e,t){var i,s
return e?-1===(s=(e=String(e||"")).search(t.regex))?0:(i=t.string.length/e.length,0===s&&(i+=.5),i):0},p=(l=i.length)?1===l?function(e,t){return d(s(t,i[0],o),e)}:function(e,t){for(var n=0,r=0;n<l;n++)r+=d(s(t,i[n],o),e)
return r/l}:function(){return 0}
return r?1===r?function(e){return p(n[0],e)}:"and"===a.options.conjunction?function(e){for(var t,i=0,s=0;i<r;i++){if((t=p(n[i],e))<=0)return 0
s+=t}return s/r}:function(e){for(var t=0,i=0;t<r;t++)i+=p(n[t],e)
return i/r}:function(){return 0}}getSortFunction(e,t){var n,r,o,a,l,d,p,c,u,h,g
if(g=!(e=(o=this).prepareSearch(e,t)).query&&t.sort_empty||t.sort,u=function(e,i){return"$score"===e?i.score:s(o.items[i.id],e,t.nesting)},l=[],g)for(n=0,r=g.length;n<r;n++)(e.query||"$score"!==g[n].field)&&l.push(g[n])
if(e.query){for(h=!0,n=0,r=l.length;n<r;n++)if("$score"===l[n].field){h=!1
break}h&&l.unshift({field:"$score",direction:"desc"})}else for(n=0,r=l.length;n<r;n++)if("$score"===l[n].field){l.splice(n,1)
break}for(c=[],n=0,r=l.length;n<r;n++)c.push("desc"===l[n].direction?-1:1)
return(d=l.length)?1===d?(a=l[0].field,p=c[0],function(e,t){return p*i(u(a,e),u(a,t))}):function(e,t){var s,n,r
for(s=0;s<d;s++)if(r=l[s].field,n=c[s]*i(u(r,e),u(r,t)))return n
...
var l=a.cloneNode(!0)
o.appendChild(l),a.parentNode.replaceChild(o,a),s=1}}else if(1===t.nodeType&&t.childNodes&&!/(script|style)/i.test(t.tagName)&&("highlight"!==t.className||"SPAN"!==t.tagName))for(var d=0;d<t.childNodes.length;++d)d+=e(t.childNodes[d])
...
function p(e){return null==e?null:"boolean"==typeof e?e?"1":"0":e+""}function c(e){return(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function u(e,t,i){var s,n=e.trigger,r={}
for(s in e.trigger=function(){var i=arguments[0]
if(-1===t.indexOf(i))return n.apply(e,arguments)
r[i]=arguments},i.apply(e,[]),e.trigger=n,r)n.apply(e,r[s])}function h(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function g(e,t,i,s){e.addEventListener(t,i,s)}function f(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function v(e,t){const i=e.getAttribute("id")
...
class P extends(function(e){return e.plugins={},class extends e{static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s,n=this,r=[]
...
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),this.settings=function(e,t){var i=Object.assign({},d,t),s=i.dataAttr,n=i.labelField,r=i.valueField,o=i.disabledField,a=i.optgroupField,l=i.optgroupLabelField,c=i.optgroupValueField,u=e.tagName.toLowerCase(),h=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
c[n]=c[n]||e.textContent,c[r]=c[r]||s,c[o]=c[o]||e.disabled,c[a]=c[a]||t,c.$option=e,u[s]=c,d.push(c),e.selected&&g.items.push(s)}},m=e=>{var t,i;(i=f(e))[l]=i[l]||e.getAttribute("label")||"",i[c]=i[c]||h++,i[o]=i[o]||e.disabled,g.optgroups.push(i),t=i[c]
for(const i of e.children)v(i,t)}
g.maxItems=e.hasAttribute("multiple")?null:1
for(const i of e.children)"optgroup"===(t=i.tagName.toLowerCase())?m(i):"option"===t&&v(i)})():(()=>{var t,o,a=e.getAttribute(s)
if(a){g.options=JSON.parse(a)
for(const e of g.options)g.items.push(e[r])}else{var l=e.value.trim()||""
if(!i.allowEmptyOption&&!l.length)return
t=l.split(i.delimiter)
for(const e of t)(o={})[n]=e,o[r]=e,g.options.push(o)
g.items=t}})(),Object.assign({},d,g,t)}(s,t),this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=v(s,"tomselect-"+F),this.isRequired=s.required,this.sifter=new o(this.options,{diacritics:this.settings.diacritics}),this.setupOptions(this.settings.options,this.settings.optgroups),delete this.settings.optgroups,delete this.settings.options,this.settings.mode=this.settings.mode||(1===this.settings.maxItems?"single":"multi"),"boolean"!=typeof this.settings.hideSelected&&(this.settings.hideSelected="multi"===this.settings.mode),"boolean"!=typeof this.settings.hidePlaceholder&&(this.settings.hidePlaceholder="multi"!==this.settings.mode)
var n=this.settings.createFilter
"function"!=typeof n&&("string"==typeof n&&(n=new RegExp(n)),n instanceof RegExp?this.settings.createFilter=e=>n.test(e):this.settings.createFilter=()=>!0),this.initializePlugins(this.settings.plugins),this.setupCallbacks(),this.setupTemplates(),this.setup()}setup(){var e,t,i,s,n,r,o,a,l,d=this,p=d.settings,c=d.input
const u={passive:!0},f=d.inputId+"-ts-dropdown"
if(r=d.settings.mode,o=c.getAttribute("class")||"",b(e=m("<div>"),p.wrapperClass,o,r),b(t=m('<div class="items">'),p.inputClass),e.append(t),b(s=d.render("dropdown"),p.dropdownClass,r),b(n=m(`<div role="listbox" id="${f}" tabindex="-1">`),p.dropdownContentClass),s.append(n),m(p.dropdownParent||e).appendChild(s),p.controlInput)i=m(p.controlInput)
...
if(O){x(O,{for:l}),x(n,{"aria-labelledby":v(O,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&b(s,o),e.style.width=c.style.width,d.plugins.names.length&&(a="plugin-"+d.plugins.names.join(" plugin-"),b([e,s],a)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&x(c,{multiple:"multiple"}),d.settings.placeholder&&x(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var w=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
d.settings.splitOn=new RegExp("\\s*"+w+"+\\s*")}var I,C,_
...
_&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(_),_=setTimeout((function(){_=null,i.loadedSearches[e]=!0,I.call(i,e,t)}),C)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=c.type,g(s,"mouseenter",(e=>{var t=A(e.target,"[data-selectable]",s)
...
var S=e=>{var t=A(e.target,"[data-selectable]",d.dropdown)
if(!t&&!d.wrapper.contains(e.target))return d.isFocused&&d.blur(),void d.inputState()
h(e,!0),t&&d.onOptionSelect(e,t)},F=()=>{d.isOpen&&d.positionDropdown()}
g(document,"mousedown",S),g(window,"sroll",F,u),g(window,"resize",F,u),d._destroy=()=>{document.removeEventListener("mousedown",S),window.removeEventListener("sroll",F),window.removeEventListener("resize",F)},this.revertSettings={innerHTML:c.innerHTML,tabIndex:c.tabIndex},c.tabIndex=-1,x(c,{hidden:"hidden"}),c.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,g(c,"invalid",(e=>{h(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,c.disabled&&d.disable(),d.on("change",this.onChange),b(c,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
b(t.wrapper,t.settings.loadingClass),t.loading++
const s=t.loadCallback.bind(t)
i.call(t,e,s)}loadCallback(e,t){const i=this
i.loading=Math.max(i.loading-1,0),i.lastQuery=null,i.clearActiveOption(),i.setupOptions(e,t),i.refreshOptions(i.isFocused&&!i.isInputHidden),i.loading||w(i.wrapper,i.settings.loadingClass),i.trigger("load",e,t)}onSearchChange(e){this.load(e)}setTextboxValue(e=""){var t=this.control_input
t.value!==e&&(t.value=e,y(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){u(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,r,o,a,d=this
if("single"!==d.settings.mode){if(!e)return d.clearActiveItems(),void(d.isFocused&&d.showInput())
if("mousedown"===(i=t&&t.type.toLowerCase())&&f("shiftKey",t)&&d.activeItems.length){for(a=d.getLastActive(),(n=Array.prototype.indexOf.call(d.control.children,a))>(r=Array.prototype.indexOf.call(d.control.children,e))&&(o=n,n=r,r=o),s=n;s<=r;s++)e=d.control.children[s],-1===d.activeItems.indexOf(e)&&d.setActiveItemClass(e)
...
return i}refreshOptions(e=!0){var t,i,s,n,r,o,l,d,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),O=v.activeOption&&p(v.activeOption.dataset.value),b=v.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),g={},r=[],t=0;t<n;t++){let e=v.options[y.items[t].id],n=p(e[v.settings.valueField]),a=v.getOption(n)
for(a||(a=v.render("option",e)),v.settings.hideSelected||a.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(l=Array.isArray(o)?o:[o])&&l.length;i<s;i++)o=l[i],v.optgroups.hasOwnProperty(o)||(o=""),g.hasOwnProperty(o)||(g[o]=document.createDocumentFragment(),r.push(o)),i>0&&(a=a.cloneNode(!0),w(a,"active"),a.removeAttribute("aria-selected")),g[o].appendChild(a)}for(o of(this.settings.lockOptgroupOrder&&r.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),d=document.createDocumentFragment(),r))if(v.optgroups.hasOwnProperty(o)&&g[o].children.length){let e=document.createDocumentFragment()
...
t[this.settings.optgroupValueField]=e,(i=this.registerOptionGroup(t))&&this.trigger("optgroup_add",i,t)}removeOptionGroup(e){this.optgroups.hasOwnProperty(e)&&(delete this.optgroups[e],this.clearCache(),this.trigger("optgroup_remove",e))}clearOptionGroups(){this.optgroups={},this.clearCache(),this.trigger("optgroup_clear")}updateOption(e,t){var i,s,n,r,o,a,l,d=this
...
l=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(r=d.items.indexOf(e))&&d.items.splice(r,1,n)),t.$order=t.$order||l,d.options[n]=t,o=d.renderCache.item,a=d.renderCache.option,o&&(delete o[e],delete o[n]),a&&(delete a[e],delete a[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&b(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=p(e)
...
var n=i.control
n.insertBefore(i.buffer,n.firstChild),i.buffer=null}addItem(e,t){u(this,t?[]:["change"],(()=>{var i,s,n=this,r=n.settings.mode
...
r&&(e=p(r.dataset.value),-1!==(i=n.items.indexOf(e))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),w(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,r)))}createItem(e,t=!0,i){var s,n=this,r=n.caretPos
if(e=e||n.inputValue(),"function"!=typeof i&&(i=()=>{}),!n.canCreate(e))return i(),!1
n.lock()
var o=!1,a=e=>{if(n.unlock(),!e||"object"!=typeof e)return i()
...
return s="function"==typeof n.settings.create?n.settings.create.call(this,e,a):{[n.settings.labelField]:e,[n.settings.valueField]:e},o||a(s),!0}refreshItems(){var e=this
...
n=m('<option value="'+c(i)+'">'+c(e)+"</option>"),s.options[i].$option=n}n.selected=!0,x(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
s.isSetup&&(e.silent||s.trigger("change",s.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,x(e.control_input,{"aria-expanded":"true"}),e.refreshState(),O(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),O(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur()),t.isOpen=!1,x(t.control_input,{"aria-expanded":"false"}),O(t.dropdown,{display:"none"}),t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
if(t=e&&8===e.keyCode?-1:1,i={start:(r=o.control_input).selectionStart,length:r.selectionEnd-r.selectionStart},s=[],o.activeItems.length){n=S(_(o.activeItems,t)),t>0&&n++
...
return"function"!=typeof r?null:(s=r.call(this,t,c))?(s=m(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?x(s,{"aria-disabled":"true"}):x(s,{"data-selectable":""}):"optgroup"===e&&(x(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&x(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(x(s,{"data-value":i}),"item"===e?b(s,n.settings.itemClass):(b(s,n.settings.optionClass),x(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,r
return"after"===e&&(t=n.apply(s,arguments)),r=i.apply(s,arguments),"instead"===e?r:("before"===e&&(t=n.apply(s,arguments)),t)}}}return P}))
