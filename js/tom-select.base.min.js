...
return i||(e.setAttribute("id",t),t)}function A(e){return e.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/'/g,"\\'")}function _(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function S(e,t){Object.assign(e.style,t)}function x(e,...t){var i=P(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function k(e,...t){var i=P(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function P(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function L(e){return Array.isArray(e)||(e=[e]),e}function E(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function T(e,t){return t>0?e[e.length-1]:e[0]}function q(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function D(e,t){for(const i in t)e.setAttribute(i,t[i])}var V=0
...
if(o=c.settings.mode,r=u.getAttribute("class")||"",x(e=_("<div>"),p.wrapperClass,r,o),x(t=_('<div class="items">'),p.inputClass),e.append(t),x(s=c.render("dropdown"),p.dropdownClass,o),x(n=_(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),_(p.dropdownParent||e).appendChild(s),p.controlInput)i=_(p.controlInput)
else{i=_('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&D(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),D(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=C(i,c.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(c.inputId)+"']",v=document.querySelector(f)
if(v){D(v,{for:a}),D(n,{"aria-labelledby":C(v,c.inputId+"-ts-label")})}var m,y,O
c.settings.copyClassesToDropdown&&x(s,r),e.style.width=u.style.width,c.plugins.names.length&&(l="plugin-"+c.plugins.names.join(" plugin-"),x([e,s],l)),(null===p.maxItems||p.maxItems>1)&&c.is_select_tag&&D(u,{multiple:"multiple"}),c.settings.placeholder&&D(i,{placeholder:p.placeholder}),!c.settings.splitOn&&c.settings.delimiter&&(c.settings.splitOn=new RegExp("\\s*"+d(c.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
...
b(t,!0)}
var A=()=>{c.isOpen&&c.positionDropdown()}
w(document,"mousedown",I),w(window,"sroll",A,h),w(window,"resize",A,h),c._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",A),window.removeEventListener("resize",A)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,D(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",c.wrapper),c.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),c.isInvalid||(c.isInvalid=!0,c.refreshState())})),c.updateOriginalInput(),c.refreshItems(),c.refreshState(),c.inputState(),c.isSetup=!0,u.disabled&&c.disable(),c.on("change",this.onChange),x(u,"tomselected"),c.trigger("initialize"),!0===p.preload&&c.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFocused&&t.isOpen?t.blur():t.focus()}onMouseDown(e){}onChange(){F(this.input,"input"),F(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,F(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){O(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
for(a||(a=f.render("option",e)),f.settings.hideSelected||a.classList.toggle("selected",f.items.includes(n)),r=e[f.settings.optgroupField]||"",i=0,s=(l=Array.isArray(r)?r:[r])&&l.length;i<s;i++)r=l[i],f.optgroups.hasOwnProperty(r)||(r=""),u.hasOwnProperty(r)||(u[r]=document.createDocumentFragment(),o.push(r)),i>0&&(a=a.cloneNode(!0),k(a,"active"),a.removeAttribute("aria-selected")),u[r].appendChild(a)}for(r of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(f.optgroups[e]&&f.optgroups[e].$order||0)-(f.optgroups[t]&&f.optgroups[t].$order||0))),a=document.createDocumentFragment(),o))if(f.optgroups.hasOwnProperty(r)&&u[r].children.length){let e=document.createDocumentFragment()
...
a=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(o=d.items.indexOf(e))&&d.items.splice(o,1,n)),t.$order=t.$order||a,d.options[n]=t,r=d.renderCache.item,l=d.renderCache.option,r&&(delete r[e],delete r[n]),l&&(delete l[e],delete l[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&x(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=m(e)
...
this.options=this.sifter.items=e,this.lastQuery=null,this.trigger("option_clear")}getOption(e){if(e=m(e)){const t=this.dropdown_content.querySelector(`[data-selectable][data-value="${A(e)}"]`)
...
for(let i=0;i<s.length;i++)if(s[i]==e)return t>0?s[i+1]:s[i-1]}}getItem(e){if(e=m(e))return e=A(e),this.control.querySelector(`[data-value="${e}"]`)}addItems(e,t){var i=this
...
n=_('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,D(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
s.isSetup&&(e.silent||s.trigger("change",s.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,D(e.control_input,{"aria-expanded":"true"}),e.refreshState(),S(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),S(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,D(t.control_input,{"aria-expanded":"false"}),S(t.dropdown,{display:"none"}),t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?D(s,{"aria-disabled":"true"}):D(s,{"data-selectable":""}):"optgroup"===e&&(D(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&D(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(D(s,{"data-value":i}),"item"===e?x(s,n.settings.itemClass):(x(s,n.settings.optionClass),D(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return j}))
