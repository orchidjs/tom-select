...
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)}function _(e,t){var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function F(e,t){Object.assign(e.style,t)}function S(e,...t){var i=P(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=P(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function P(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function k(e){return Array.isArray(e)||(e=[e]),e}function L(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
if(o=d.settings.mode,r=p.getAttribute("class")||"",S(e=A("<div>"),c.wrapperClass,r,o),S(t=A('<div class="items">'),c.inputClass),e.append(t),S(s=d.render("dropdown"),c.dropdownClass,o),S(n=A(`<div role="listbox" id="${h}" tabindex="-1">`),c.dropdownContentClass),s.append(n),A(c.dropdownParent||e).appendChild(s),c.controlInput)i=A(c.controlInput)
...
setTimeout((()=>t.focus()),0)}onChange(){_(this.input,"input"),_(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,_(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){O(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
n=A('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,q(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?q(s,{"aria-disabled":"true"}):q(s,{"data-selectable":""}):"optgroup"===e&&(q(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&q(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(q(s,{"data-value":i}),"item"===e?S(s,n.settings.itemClass):(S(s,n.settings.optionClass),q(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return D}))
