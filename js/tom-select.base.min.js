...
var i,s,r,o,l=[],a=e.split(/ +/)
for(i=0,s=a.length;i<s;i++){if(r=(a[i]+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),this.settings.diacritics)for(o in n)n.hasOwnProperty(o)&&(r=r.replace(new RegExp(o,"g"),n[o]))
t&&(r="\\b"+r),l.push({string:a[i],regex:new RegExp(r,"i")})}return l}iterator(e,t){(Array.isArray(e)?Array.prototype.forEach||function(e){for(var t=0,i=this.length;t<i;t++)e(this[t],t,this)}:function(e){for(var t in this)this.hasOwnProperty(t)&&e(this[t],t,this)}).apply(e,[t])}getScoreFunction(e,t){var i,n,r,o,l
l=this.prepareSearch(e,t),n=l.tokens,i=l.options.fields,r=n.length,o=l.options.nesting
var a,d=function(e,t){var i,s
return e?-1===(s=(e=String(e||"")).search(t.regex))?0:(i=t.string.length/e.length,0===s&&(i+=.5),i):0},p=(a=i.length)?1===a?function(e,t){return d(s(t,i[0],o),e)}:function(e,t){for(var n=0,r=0;n<a;n++)r+=d(s(t,i[n],o),e)
...
l.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(l,null)).getPropertyValue("direction"),this.settings=function(e,t){var i=Object.assign({},d,t),s=i.dataAttr,n=i.labelField,r=i.valueField,o=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,u=e.tagName.toLowerCase(),h=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
c[n]=c[n]||e.textContent,c[r]=c[r]||s,c[o]=c[o]||e.disabled,c[l]=c[l]||t,c.$option=e,u[s]=c,d.push(c),e.selected&&g.items.push(s)}},m=e=>{var t,i;(i=f(e))[a]=i[a]||e.getAttribute("label")||"",i[c]=i[c]||h++,i[o]=i[o]||e.disabled,g.optgroups.push(i),t=i[c]
...
"function"!=typeof a&&("string"==typeof a&&(a=new RegExp(a)),a instanceof RegExp?this.settings.createFilter=e=>a.test(e):this.settings.createFilter=()=>!0),this.initializePlugins(this.settings.plugins),this.setupCallbacks(),this.setupTemplates(),this.setup()}setup(){var e,t,i,s,n,r,o,l,a,d=this,p=d.settings,c=d.input
const u={passive:!0},f=d.inputId+"-ts-dropdown"
if(r=d.settings.mode,o=c.getAttribute("class")||"",b(e=m("<div>"),p.wrapperClass,o,r),b(t=m('<div class="items">'),p.inputClass),e.append(t),b(s=d.render("dropdown"),p.dropdownClass,r),b(n=m(`<div style="scroll-behavior: smooth;" role="listbox" id="${f}" tabindex="-1">`),p.dropdownContentClass),s.append(n),m(p.dropdownParent||e).appendChild(s),p.controlInput)i=m(p.controlInput)
...
if(O){x(O,{for:a}),x(n,{"aria-labelledby":v(O,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&b(s,o),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),b([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&x(c,{multiple:"multiple"}),d.settings.placeholder&&x(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var w=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
t.value!==e&&(t.value=e,y(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){u(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,r,o,l,d=this
if("single"!==d.settings.mode){if(!e)return d.clearActiveItems(),void(d.isFocused&&d.showInput())
if("mousedown"===(i=t&&t.type.toLowerCase())&&f("shiftKey",t)&&d.activeItems.length){for(l=d.getLastActive(),(n=Array.prototype.indexOf.call(d.control.children,l))>(r=Array.prototype.indexOf.call(d.control.children,e))&&(o=n,n=r,r=o),s=n;s<=r;s++)e=d.control.children[s],-1===d.activeItems.indexOf(e)&&d.setActiveItemClass(e)
...
return i}refreshOptions(e=!0){var t,i,s,n,r,o,a,d,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),O=v.activeOption&&p(v.activeOption.dataset.value),b=v.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),g={},r=[],t=0;t<n;t++){let e=v.options[y.items[t].id],n=p(e[v.settings.valueField]),l=v.getOption(n)
for(l||(l=v.render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(a=Array.isArray(o)?o:[o])&&a.length;i<s;i++)o=a[i],v.optgroups.hasOwnProperty(o)||(o=""),g.hasOwnProperty(o)||(g[o]=document.createDocumentFragment(),r.push(o)),i>0&&(l=l.cloneNode(!0),w(l,"active"),l.removeAttribute("aria-selected")),g[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&r.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),d=document.createDocumentFragment(),r))if(v.optgroups.hasOwnProperty(o)&&g[o].children.length){let e=document.createDocumentFragment()
e.appendChild(v.render("optgroup_header",v.optgroups[o])),e.appendChild(g[o])
let t=v.render("optgroup",{group:v.optgroups[o],options:e})
d.appendChild(t)}else d.appendChild(g[o])
...
a=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(r=d.items.indexOf(e))&&d.items.splice(r,1,n)),t.$order=t.$order||a,d.options[n]=t,o=d.renderCache.item,l=d.renderCache.option,o&&(delete o[e],delete o[n]),l&&(delete l[e],delete l[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&b(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=p(e)
...
r.rtl&&(e*=-1),r.inputValue().length||(f(a,t)||f("shiftKey",t)?(n=(s=r.getLastActive(e))?s.classList.contains("active")?r.getAdjacent(s,e,"item"):s:e>0?r.control_input.nextElementSibling:r.control_input.previousElementSibling)&&(n.classList.contains("active")&&r.removeActiveItem(s),r.setActiveItemClass(n)):r.isFocused&&!r.activeItems.length?r.setCaret(r.caretPos+e):(s=r.getLastActive(e))&&(i=S(s),r.setCaret(e>0?i+1:i),r.setActiveItem()))}getLastActive(e){let t=this.control.querySelector(".last-active")
if(t)return t
var i=this.control.querySelectorAll(".active")
return i?_(i,e):void 0}setCaret(e){var t=this
if("single"===t.settings.mode||t.settings.controlInput)e=t.items.length
else if((e=Math.max(0,Math.min(t.items.length,e)))!=t.caretPos&&!t.isPending){var i,s=t.controlChildren(),n=s.length
for(i=0;i<n;i++)s[i],i<e?t.control_input.insertAdjacentElement("beforebegin",s[i]):t.control.appendChild(s[i])}t.caretPos=e}controlChildren(){return Array.from(this.control.getElementsByClassName(this.settings.itemClass))}lock(){this.close(),this.isLocked=!0,this.refreshState()}unlock(){this.isLocked=!1,this.refreshState()}disable(){var e=this
