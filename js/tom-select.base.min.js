...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},q=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},V=(e,t,i,s)=>{e.addEventListener(t,i,s)},D=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),$=(e,t)=>{const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)},j=e=>e.replace(/[\\"']/g,"\\$&")
var N=0
...
const h={passive:!0},v=d.inputId+"-ts-dropdown"
if(o=d.settings.mode,r=u.getAttribute("class")||"",e=g("<div>"),f(e,p.wrapperClass,r,o),t=g('<div class="items">'),f(t,p.inputClass),e.append(t),s=d._render("dropdown"),f(s,p.dropdownClass,o),n=g(`<div role="listbox" id="${v}" tabindex="-1">`),f(n,p.dropdownContentClass),s.append(n),g(p.dropdownParent||e).appendChild(s),p.controlInput)i=g(p.controlInput)
else{i=g('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&_(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),_(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":v}),a=$(i,d.inputId+"-tomselected")
let m="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(d.inputId)+"']",y=document.querySelector(m)
if(y){_(y,{for:a})
let e=$(y,d.inputId+"-ts-label")
_(n,{"aria-labelledby":e})}d.settings.copyClassesToDropdown&&f(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),f([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&_(u,{multiple:"multiple"}),d.settings.placeholder&&_(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=E(this.settings.load,this.settings.loadThrottle)),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,V(s,"click",(e=>{const t=w(e.target,"[data-selectable]")
t&&(d.onOptionSelect(e,t),q(e,!0))})),V(t,"click",(e=>{var s=w(e.target,"."+d.settings.itemClass,t)
s&&d.onItemSelect(e,s)?q(e,!0):""==i.value&&(d.onClick(),q(e,!0))})),V(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),V(i,"keydown",(e=>d.onKeyDown(e))),V(i,"keyup",(e=>d.onKeyUp(e))),V(i,"keypress",(e=>d.onKeyPress(e))),V(i,"resize",(()=>d.positionDropdown()),h),V(i,"blur",(()=>d.onBlur())),V(i,"focus",(e=>d.onFocus(e))),V(i,"paste",(e=>d.onPaste(e)))
const O=t=>{const i=t.composedPath()[0]
if(!e.contains(i)&&!s.contains(i))return d.isFocused&&d.blur(),void d.inputState()
q(t,!0)}
var b=()=>{d.isOpen&&d.positionDropdown()}
V(document,"mousedown",O),V(window,"sroll",b,h),V(window,"resize",b,h),d._destroy=()=>{document.removeEventListener("mousedown",O),window.removeEventListener("sroll",b),window.removeEventListener("resize",b)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,_(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),p.items=[],V(u,"invalid",(e=>{q(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.close(!1),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),f(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!D(F,e)&&q(e)}}onKeyUp(e){var t=this
if(t.isLocked)q(e)
...
q(t)}else"click"===i&&D(F,t)||"keydown"===i&&D("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return R}))
