...
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},f=(e,t)=>{var s=q(e.value)
...
const u={},h=[]
var g,v=this,m=v.inputValue(),f=v.search(m),O=null,w=v.settings.shouldOpen||!1,b=v.dropdown_content
...
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length&&y(f.tokens,(e=>{V(b,e.regex)})))
var I=e=>{let t=v.render(e,{input:m})
return t&&(w=!0,b.insertBefore(t,b.firstChild)),t}
if(v.loading?I("loading"):v.settings.shouldLoad.call(v,m)?0===f.items.length&&I("no_results"):I("not_loading"),(a=v.canCreate(m))&&(p=I("option_create")),v.hasOptions=f.items.length>0||a,w){if(f.items.length>0){if(!O&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!b.contains(O)){let e=0
