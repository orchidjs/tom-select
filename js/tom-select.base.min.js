...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},C=(e,t)=>{Object.assign(e.style,t)},_=(e,...t)=>{var i=S(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},A=(e,...t)=>{var i=S(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},S=e=>{var t=[]
...
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},v=(e,t)=>{var s=j(e.value)
...
const v={passive:!0},f=n.inputId+"-ts-dropdown"
if(p=n.settings.mode,u=s.getAttribute("class")||"",r=w("<div>"),_(r,t.wrapperClass,u,p),l=w('<div class="items">'),_(l,t.inputClass),Q(r,l),c=n._render("dropdown"),_(c,t.dropdownClass,p),d=w(`<div role="listbox" id="${f}" tabindex="-1">`),_(d,t.dropdownContentClass),Q(c,d),w(t.dropdownParent||r).appendChild(c),t.controlInput)a=w(t.controlInput)
else{a=w('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&L(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),L(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":f}),g=M(a,n.inputId+"-tomselected")
let y="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",O=document.querySelector(y)
if(O){L(O,{for:g})
let e=M(O,n.inputId+"-ts-label")
L(d,{"aria-labelledby":e})}n.settings.copyClassesToDropdown&&_(c,u),r.style.width=s.style.width,n.plugins.names.length&&(h="plugin-"+n.plugins.names.join(" plugin-"),_([r,c],h)),(null===t.maxItems||t.maxItems>1)&&n.is_select_tag&&L(s,{multiple:"multiple"}),n.settings.placeholder&&L(a,{placeholder:t.placeholder}),!n.settings.splitOn&&n.settings.delimiter&&(n.settings.splitOn=new RegExp("\\s*"+m(n.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=N(this.settings.load,this.settings.loadThrottle)),this.control=l,this.control_input=a,this.wrapper=r,this.dropdown=c,this.dropdown_content=d,n.control_input.type=s.type,z(c,"click",(e=>{const t=x(e.target,"[data-selectable]")
t&&(n.onOptionSelect(e,t),H(e,!0))})),z(l,"click",(e=>{var t=x(e.target,"."+n.settings.itemClass,l)
t&&n.onItemSelect(e,t)?H(e,!0):""==a.value&&(n.onClick(),H(e,!0))})),z(a,"mousedown",(e=>{""!==a.value&&e.stopPropagation()})),z(a,"keydown",(e=>n.onKeyDown(e))),z(a,"keyup",(e=>n.onKeyUp(e))),z(a,"keypress",(e=>n.onKeyPress(e))),z(a,"resize",(()=>n.positionDropdown()),v),z(a,"blur",(()=>n.onBlur())),z(a,"focus",(e=>n.onFocus(e))),z(a,"paste",(e=>n.onPaste(e)))
...
const u={},h=[]
var g,v=this,m=v.inputValue(),f=v.search(m),y=v.activeOption,O=v.settings.shouldOpen||!1,b=v.dropdown_content
for(y&&(c=y.dataset.value,d=y.closest("[data-group]")),n=f.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(O=!0),t=0;t<n;t++){let e=v.options[f.items[t].id],n=$(e[v.settings.valueField]),l=v.getOption(n)
...
Q(l,i)}else Q(l,u[o])
if(b.innerHTML="",Q(b,l),v.settings.highlight&&(g=b.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length))for(const e of f.tokens)T(b,e.regex)
var w=e=>{let t=v.render(e,{input:m})
return t&&(O=!0,b.insertBefore(t,b.firstChild)),t}
if(v.settings.shouldLoad.call(v,m)?v.loading?w("loading"):0===f.items.length&&w("no_results"):w("not_loading"),(a=v.canCreate(m))&&(p=w("option_create")),v.hasOptions=f.items.length>0||a,O){if(f.items.length>0){if(!b.contains(y)&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!b.contains(y)){let e=0
...
t&&t.remove()}}getOption(e){var t=j(e)
...
var t=j(e)
return t?this.control.querySelector(`[data-value="${B(t)}"]`):null}addItems(e,t){var i=this,s=Array.isArray(e)?e:[e]
...
const o=this
return("option"===e||"item"===e)&&(n=$(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,D))||(s=w(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?L(s,{"aria-disabled":"true"}):L(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],L(s,{"data-group":i}),t.group[o.settings.disabledField]&&L(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(L(s,{"data-value":n}),"item"===e?_(s,o.settings.itemClass):(_(s,o.settings.optionClass),L(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
