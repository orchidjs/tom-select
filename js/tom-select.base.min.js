...
return T(t,(t=>{"string"==typeof t&&(t=t.trim().split(/[\11\12\14\15\40]/)),Array.isArray(t)&&(e=e.concat(t))})),e.filter(Boolean)},R=t=>(Array.isArray(t)||(t=[t]),t),z=(t,e,i)=>{if(!i||i.contains(t))for(;t&&t.matches;){if(t.matches(e))return t
...
D([o,s],e)}(null===e.maxItems||e.maxItems>1)&&t.is_select_tag&&K(a,{multiple:"multiple"}),e.placeholder&&K(i,{placeholder:e.placeholder}),!e.splitOn&&e.delimiter&&(e.splitOn=new RegExp("\\s*"+r(e.delimiter)+"+\\s*")),e.load&&e.loadThrottle&&(e.load=Z(e.load,e.loadThrottle)),t.control_input.type=a.type,it(s,"mousemove",(()=>{t.ignoreHover=!1})),it(s,"mouseenter",(e=>{var i=z(e.target,"[data-selectable]",s)
i&&t.onOptionHover(e,i)}),{capture:!0}),it(s,"click",(e=>{const i=z(e.target,"[data-selectable]")
i&&(t.onOptionSelect(e,i),et(e,!0))})),it(l,"click",(e=>{var s=z(e.target,"[data-ts-item]",l)
