...
null==s?e.removeAttribute(i):e.setAttribute(i,""+s)}},A=(e,t)=>{e.parentNode&&e.parentNode.replaceChild(t,e)},S=(e,t)=>{if(null===t)return
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},q=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},V=(e,t,i,s)=>{e.addEventListener(t,i,s)},$=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),D=(e,t)=>{const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)},j=e=>e.replace(/[\\"']/g,"\\$&"),N=(e,t)=>{t&&e.append(t)}
var R=0
class z extends(function(e){return e.plugins={},class extends e{constructor(...e){super(...e),this.plugins={names:[],settings:{},requested:{},loaded:{}}}static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i
const s=this,n=[]
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.currentResults=void 0,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},R++
var s=g(e),n=this
...
for(const i of e.children)"optgroup"===(t=i.tagName.toLowerCase())?m(i):"option"===t&&v(i)})():(()=>{const t=e.getAttribute(s)
...
var r,l,a,d,p,u,v,m,y
t=n.settings,s=n.input
const O={passive:!0},b=n.inputId+"-ts-dropdown"
if(u=n.settings.mode,v=s.getAttribute("class")||"",r=g("<div>"),f(r,t.wrapperClass,v,u),l=g('<div class="items">'),f(l,t.inputClass),N(r,l),d=n._render("dropdown"),f(d,t.dropdownClass,u),p=g(`<div role="listbox" id="${b}" tabindex="-1">`),f(p,t.dropdownContentClass),N(d,p),g(t.dropdownParent||r).appendChild(d),t.controlInput)a=g(t.controlInput)
else{a=g('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&_(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),_(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":b}),y=D(a,n.inputId+"-tomselected")
let I="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",C=document.querySelector(I)
if(C){_(C,{for:y})
let e=D(C,n.inputId+"-ts-label")
_(p,{"aria-labelledby":e})}n.settings.copyClassesToDropdown&&f(d,v),r.style.width=s.style.width,n.plugins.names.length&&(m="plugin-"+n.plugins.names.join(" plugin-"),f([r,d],m)),(null===t.maxItems||t.maxItems>1)&&n.is_select_tag&&_(s,{multiple:"multiple"}),n.settings.placeholder&&_(a,{placeholder:t.placeholder}),!n.settings.splitOn&&n.settings.delimiter&&(n.settings.splitOn=new RegExp("\\s*"+c(n.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=E(this.settings.load,this.settings.loadThrottle)),this.control=l,this.control_input=a,this.wrapper=r,this.dropdown=d,this.dropdown_content=p,n.control_input.type=s.type,V(d,"click",(e=>{const t=w(e.target,"[data-selectable]")
...
const A=e=>{const t=e.composedPath()[0]
if(!r.contains(t)&&!d.contains(t))return n.isFocused&&n.blur(),void n.inputState()
q(e,!0)}
var S=()=>{n.isOpen&&n.positionDropdown()}
V(document,"mousedown",A),V(window,"sroll",S,O),V(window,"resize",S,O),this._destroy=()=>{document.removeEventListener("mousedown",A),window.removeEventListener("sroll",S),window.removeEventListener("resize",S)},this.revertSettings={innerHTML:s.innerHTML,tabIndex:s.tabIndex},s.tabIndex=-1,_(s,{hidden:"hidden"}),s.insertAdjacentElement("afterend",n.wrapper),n.setValue(t.items),t.items=[],V(s,"invalid",(e=>{q(e),n.isInvalid||(n.isInvalid=!0,n.refreshState())})),n.updateOriginalInput(),n.refreshItems(),n.close(!1),n.inputState(),n.isSetup=!0,s.disabled&&n.disable(),n.on("change",this.onChange),f(s,"tomselected"),n.trigger("initialize"),!0===t.preload&&n.load(""),n.setup()}setup(){}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
else{switch(e.keyCode){case 65:if($(F,e))return void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!$(F,e)&&q(e)}}onKeyUp(e){var t=this
if(t.isLocked)q(e)
...
if("click"===(i=t&&t.type.toLowerCase())&&$("shiftKey",t)&&a.activeItems.length){for(l=a.getLastActive(),(n=Array.prototype.indexOf.call(a.control.children,l))>(o=Array.prototype.indexOf.call(a.control.children,e))&&(r=n,n=o,o=r),s=n;s<=o;s++)e=a.control.children[s],-1===a.activeItems.indexOf(e)&&a.setActiveItemClass(e)
q(t)}else"click"===i&&$(F,t)||"keydown"===i&&$("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
for(O&&(c=O.dataset.value,d=O.closest("[data-group]")),n=f.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=v.options[f.items[t].id],n=P(e[v.settings.valueField]),l=v.getOption(n)
...
N(l,i)}else N(l,u[o])
if(w.innerHTML="",N(w,l),v.settings.highlight&&(g=w.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length))for(const e of f.tokens)S(w,e.regex)
...
A(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&f(s,"active"),A(a,s)),i.lastQuery=null}}removeOption(e,t){const i=this
...
var t=k(e)
return t?this.control.querySelector(`[data-value="${j(t)}"]`):null}addItems(e,t){var i=this,s=Array.isArray(e)?e:[e]
...
function r(i,s,n){return i||(i=g('<option value="'+L(s)+'">'+L(n)+"</option>")),t.input.prepend(i),e.push(i),_(i,{selected:"true"}),i.selected=!0,i}if(t.input.querySelectorAll("option[selected]").forEach((e=>{_(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=t.items.length-1;i>=0;i--)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.includes(n.$option)){r(t.input.querySelector(`option[value="${j(s)}"]:not([selected])`),s,o)}else n.$option=r(n.$option,s,o)
...
const o=this
return("option"===e||"item"===e)&&(n=P(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,L))||(s=g(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?_(s,{"aria-disabled":"true"}):_(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],_(s,{"data-group":i}),t.group[o.settings.disabledField]&&_(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(_(s,{"data-value":n}),"item"===e?f(s,o.settings.itemClass):(f(s,o.settings.optionClass),_(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return z}))
