...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,p,c,u,h,g,f,v=this,m=v.inputValue(),w=v.search(m),b=v.activeOption&&d(v.activeOption.dataset.value),I=v.settings.shouldOpen||!1
for(n=w.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(I=!0),g={},r=[],t=0;t<n;t++){let e=v.options[w.items[t].id],n=d(e[v.settings.valueField]),o=v.getOption(n)
...
i.replaceChild(e.firstChild,e),i.normalize()})),w.query.length&&w.tokens.length))for(const e of w.tokens)o(v.dropdown_content,e.regex)
