...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},H=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},z=(e,t,i,s)=>{e.addEventListener(t,i,s)},K=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),B=(e,t)=>{const i=e.getAttribute("id")
...
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),t=G(s,t),this.settings=t,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=B(s,"tomselect-"+J),this.isRequired=s.required,this.sifter=new w(this.options,{diacritics:t.diacritics}),t.mode=t.mode||(1===t.maxItems?"single":"multi"),"boolean"!=typeof t.hideSelected&&(t.hideSelected="multi"===t.mode),"boolean"!=typeof t.hidePlaceholder&&(t.hidePlaceholder="multi"!==t.mode)
...
const o=b("<div>"),r=b("<div>"),l=this._render("dropdown"),a=b('<div role="listbox" tabindex="-1">'),c=this.input.getAttribute("class")||"",d=t.mode
var p
if(S(o,t.wrapperClass,c,d),S(r,t.controlClass),Q(o,r),S(l,t.dropdownClass,d),t.copyClassesToDropdown&&S(l,c),S(a,t.dropdownContentClass),Q(l,a),b(t.dropdownParent||o).appendChild(l),t.hasOwnProperty("controlInput"))t.controlInput?(p=b(t.controlInput),this.focus_node=p):(p=b("<input/>"),this.focus_node=r)
else{p=b('<input type="text" autocomplete="off" size="1" />')
...
z(document,"mousedown",v),z(window,"scroll",f,c),z(window,"resize",f,c),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("sroll",f),window.removeEventListener("resize",f),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,z(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),S(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.load("")}setupOptions(e=[],t=[]){this.addOptions(e),y(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(A(this.activeOption,"active"),P(this.activeOption,{"aria-selected":null})),this.activeOption=null,P(this.focus_node,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(S(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.control.contains(e.control_input)&&(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,S(e.wrapper,"input-hidden")):(e.isInputHidden=!1,A(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
const u={},h=[]
var g,v=this,m=v.inputValue(),f=v.search(m),O=v.activeOption,w=v.settings.shouldOpen||!1,b=v.dropdown_content
for(O&&(c=O.dataset.value,d=O.closest("[data-group]")),n=f.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(w=!0),t=0;t<n;t++){let e=f.items[t].id,n=v.options[e],l=v.getOption(e,!0)
...
Q(l,s)}else Q(l,u[e])})),b.innerHTML="",Q(b,l),v.settings.highlight&&(g=b.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
...
if(v.settings.shouldLoad.call(v,m)?v.loading?I("loading"):0===f.items.length&&I("no_results"):I("not_loading"),(a=v.canCreate(m))&&(p=I("option_create")),v.hasOptions=f.items.length>0||a,w){if(f.items.length>0){if(!b.contains(O)&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!b.contains(O)){let e=0
...
function o(i,s,o){return i||(i=b('<option value="'+D(s)+'">'+D(o)+"</option>")),i!=n&&t.input.append(i),e.push(i),i.selected=!0,i}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?o(n,"",""):t.items.forEach((n=>{if(i=t.options[n],s=i[t.settings.labelField]||"",e.includes(i.$option)){o(t.input.querySelector(`option[value="${M(n)}"]:not(:checked)`),n,s)}else i.$option=o(i.$option,n,s)}))}else t.input.value=t.getValue()
