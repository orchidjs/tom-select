...
for(i in s)i<e?t.control_input.insertAdjacentElement("beforebegin",s[i]):t.control.appendChild(s[i])}t.caretPos=e}controlChildren(){return Array.from(this.control.getElementsByClassName(this.settings.itemClass))}lock(){this.close(),this.isLocked=!0,this.refreshState()}unlock(){this.isLocked=!1,this.refreshState()}disable(){var e=this
