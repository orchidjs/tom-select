...
r[i]=arguments},i.apply(e,[]),e.trigger=n,r)r.hasOwnProperty(s)&&n.apply(e,r[s])}function u(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function h(e,t,i,s){e.addEventListener(t,i,s)}function g(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function v(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function m(e,t){Object.keys(t).forEach((function(i){e.style[i]=t[i]}))}function y(e,...t){var i=w(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function O(e,...t){var i=w(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function w(e){var t=[]
for(let i=0;i<e.length;i++){let s=e[i]
"string"==typeof s&&(s=s.trim().split(/[\11\12\14\15\40]/)),Array.isArray(s)&&(t=t.concat(s))}return t.filter(Boolean)}function b(e){return Array.isArray(e)||(e=[e]),e}function C(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
t||p.wrapper.contains(e.target)?(u(e,!0),t&&p.onOptionSelect(e,t)):p.isFocused&&p.blur(e.target)},w=()=>{p.isOpen&&p.positionDropdown()},b=()=>{p.ignoreHover=!1}
h(document,"mousedown",O),h(window,"sroll",w,g),h(window,"resize",w,g),h(window,"mousemove",b,g),p._destroy=()=>{document.removeEventListener("mousedown",O),window.removeEventListener("mousemove",b),window.removeEventListener("sroll",w),window.removeEventListener("resize",w)}
...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,d,c,u,h,g,v,f=this,m=f.inputValue(),w=f.search(m),b=f.activeOption&&p(f.activeOption.dataset.value),C=!1
for(n=w.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(C=!0),r={},l=[],t=0;t<n;t++){let e=f.options[w.items[t].id],n=p(e[f.settings.valueField]),o=f.getOption(n)
...
i.replaceChild(e.firstChild,e),i.normalize()})),w.query.length&&w.tokens.length))for(t=0,n=w.tokens.length;t<n;t++)o(f.dropdown_content,w.tokens[t].regex)
...
if(f.loading?I("loading"):0===w.items.length&&f.settings.render.no_results&&m.length&&I("no_results"),(u=f.canCreate(m))&&(g=I("option_create")),f.hasOptions=w.items.length>0||u,C){if(w.items.length>0){if(!(h=b&&f.getOption(b))||!f.dropdown_content.contains(h)){let e=0
...
r&&(e=p(r.dataset.value),-1!==(i=n.items.indexOf(e))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),O(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.refreshState(),n.updateOriginalInput({silent:t}),n.positionDropdown(),n.trigger("item_remove",e,r)))}createItem(e,t=!0,i){var s,n=this,r=n.caretPos
