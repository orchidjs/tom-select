...
o[i]=arguments},i.apply(e,[]),e.trigger=n,t))s in o&&n.apply(e,o[s])},H=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},z=(e,t,i,s)=>{e.addEventListener(t,i,s)},K=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),M=(e,t)=>{const i=e.getAttribute("id")
...
var u
if(S(r,n.wrapperClass,d,p),S(l,n.controlClass),Q(r,l),S(a,n.dropdownClass,p),n.copyClassesToDropdown&&S(a,d),S(c,n.dropdownContentClass),Q(a,c),b(n.dropdownParent||r).appendChild(a),"string"==typeof n.controlInput&&n.controlInput.indexOf("<")>-1){u=b(n.controlInput)
y(["autocorrect","autocapitalize","autocomplete"],(e=>{s.getAttribute(e)&&P(u,{[e]:s.getAttribute(e)})})),u.tabIndex=-1,l.appendChild(u),this.focus_node=u}else n.controlInput?(u=b(n.controlInput),this.focus_node=u):(u=b("<input/>"),this.focus_node=l)
...
var t=j(e[n.settings.valueField])
