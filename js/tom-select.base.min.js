...
return t.filter(Boolean)}function I(e){return Array.isArray(e)||(e=[e]),e}function C(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.ignoreBlur=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.options_i=0,this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},x++
var s,n,o,l=v(e)
...
if(r=d.settings.mode,o=c.getAttribute("class")||"",O(e=v("<div>"),p.wrapperClass,o,r),O(t=v('<div class="items">'),p.inputClass),e.append(t),O(s=d.render("dropdown"),p.dropdownClass,r),O(n=v(`<div style="scroll-behavior: smooth;" role="listbox" id="${m}" tabindex="-1">`),p.dropdownContentClass),s.append(n),v(p.dropdownParent||e).appendChild(s),p.controlInput)i=v(p.controlInput)
else{i=v('<input type="text" autocomplete="off" size="1" />')
...
if(b){S(b,{for:a}),S(n,{"aria-labelledby":f(b,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&O(s,o),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),O([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&S(c,{multiple:"multiple"}),d.settings.placeholder&&S(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var w=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
var s=C(e.target,"."+d.settings.itemClass,t)
...
var I=e=>{var t=C(e.target,"[data-selectable]",d.dropdown)
if(!t&&!d.wrapper.contains(e.target))return d.isFocused&&d.blur(),void d.inputState()
u(e,!0),t&&d.onOptionSelect(e,t)},A=()=>{d.isOpen&&d.positionDropdown()}
h(document,"mousedown",I),h(window,"sroll",A,g),h(window,"resize",A,g),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",A),window.removeEventListener("resize",A)},this.revertSettings={innerHTML:c.innerHTML,tabIndex:c.tabIndex},c.tabIndex=-1,S(c,{hidden:"hidden"}),c.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,h(c,"invalid",(e=>{u(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,c.disabled&&d.disable(),d.on("change",this.onChange),O(c,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
this.activeOption=e,S(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),S(e,{"aria-selected":"true"}),O(e,"active"),t=this.dropdown_content.clientHeight
...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,p,c,u,h,g,f,v=this,m=v.inputValue(),y=v.search(m),O=v.activeOption&&d(v.activeOption.dataset.value),w=v.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(w=!0),g={},r=[],t=0;t<n;t++){let e=v.options[y.items[t].id],n=d(e[v.settings.valueField]),o=v.getOption(n)
for(o||(o=v.render("option",e)),v.settings.hideSelected||o.classList.toggle("selected",v.items.includes(n)),l=e[v.settings.optgroupField]||"",i=0,s=(a=Array.isArray(l)?l:[l])&&a.length;i<s;i++)l=a[i],v.optgroups.hasOwnProperty(l)||(l=""),g.hasOwnProperty(l)||(g[l]=document.createDocumentFragment(),r.push(l)),i>0&&(o=o.cloneNode(!0),b(o,"active"),o.removeAttribute("aria-selected")),g[l].appendChild(o)}for(l of(this.settings.lockOptgroupOrder&&r.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),p=document.createDocumentFragment(),r))if(v.optgroups.hasOwnProperty(l)&&g[l].children.length){let e=document.createDocumentFragment()
...
var n=i.control
n.insertBefore(i.buffer,n.firstChild),i.buffer=null}addItem(e,t){c(this,t?[]:["change"],(()=>{var i,s,n=this,r=n.settings.mode
...
n=v('<option value="'+p(i)+'">'+p(e)+"</option>"),s.options[i].$option=n}S(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,b(e.input,"tomselected"),e.input.removeAttribute("hidden"),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){var i,s,n=this
...
return"function"!=typeof r?null:(s=r.call(this,t,p))?(s=v(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?S(s,{"aria-disabled":"true"}):S(s,{"data-selectable":""}):"optgroup"===e&&(S(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&S(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(S(s,{"data-value":i}),"item"===e?O(s,n.settings.itemClass):(O(s,n.settings.optionClass),S(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
