...
this.activeOption=e,V(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),V(e,{"aria-selected":"true"}),x(e,"active"),t=this.dropdown_content.clientHeight
...
r=l.options[e].$order,n!==e&&(delete l.options[e],-1!==(o=l.items.indexOf(e))&&l.items.splice(o,1,n)),t.$order=t.$order||r,l.options[n]=t,l.removeValue(e),l.removeValue(n),-1!==l.items.indexOf(n)&&(i=l.getItem(e),s=l.render("item",t),i.classList.contains("active")&&x(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),l.lastQuery=null,l.isOpen&&l.refreshOptions(!1)}}removeOption(e,t){var i=this
...
i&&i.remove(),s&&delete s[e],n&&delete n[e]}getOption(e){if(e=m(e)){const t=this.dropdown_content.querySelector(`[data-selectable][data-value="${A(e)}"]`)
...
n=_('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,V(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
s.isSetup&&(e.silent||s.trigger("change",s.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,V(e.control_input,{"aria-expanded":"true"}),e.refreshState(),S(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),S(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,V(t.control_input,{"aria-expanded":"false"}),S(t.dropdown,{display:"none"}),t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?V(s,{"aria-disabled":"true"}):V(s,{"data-selectable":""}):"optgroup"===e&&(V(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&V(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(V(s,{"data-value":i}),"item"===e?x(s,n.settings.itemClass):(x(s,n.settings.optionClass),V(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}
