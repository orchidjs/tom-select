...
var a,p=function(e,t){var i,s
return e?-1===(s=(e=String(e||"")).search(t.regex))?0:(i=t.string.length/e.length,0===s&&(i+=.5),i):0},d=(a=s.length)?1===a?function(e,t){return p(i(t,s[0],o),e)}:function(e,t){for(var n=0,r=0;n<a;n++)r+=p(i(t,s[n],o),e)
return r/a}:function(){return 0}
return r?1===r?function(e){return d(n[0],e)}:"and"===l.options.conjunction?function(e){for(var t,i=0,s=0;i<r;i++){if((t=d(n[i],e))<=0)return 0
...
t.loadPlugin(e)}return i.loaded[e]}}}(e)){order=0
tab_key=!1
isOpen=!1
isDisabled=!1
isInvalid=!1
...
return"select"===u?(()=>{var t,a=g.options,u={},h=1,v=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},f=(e,t)=>{var s=p(e.value)
if(s||i.allowEmptyOption)if(u.hasOwnProperty(s)){if(t){var d=u[s][l]
d?Array.isArray(d)?d.push(t):u[s][l]=[d,t]:u[s][l]=t}}else{var c=v(e)
c[n]=c[n]||e.textContent,c[r]=c[r]||s,c[o]=c[o]||e.disabled,c[l]=c[l]||t,u[s]=c,a.push(c),e.selected&&g.items.push(s)}},m=e=>{var t,i;(i=v(e))[d]=i[d]||e.getAttribute("label")||"",i[c]=i[c]||h++,i[o]=i[o]||e.disabled,g.optgroups.push(i),t=i[c]
for(const i of e.children)f(i,t)}
g.maxItems=e.hasAttribute("multiple")?null:1
for(const i of e.children)"optgroup"===(t=i.tagName.toLowerCase())?m(i):"option"===t&&f(i)})():(()=>{var t,o,l,a,p=e.getAttribute(s)
...
g.items=l}})(),Object.assign({},a,g,t)}(e,t),this.input=e,this.tabIndex=e.getAttribute("tabindex")||null,this.is_select_tag="select"===e.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.isRequired=e.required,this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(s=this.settings.load,n=this.settings.loadThrottle,function(e,t){var i=this
...
for(n=b.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(C=!0),g={},r=[],t=0;t<n;t++){let e=f.options[b.items[t].id],n=p(e[f.settings.valueField]),o=f.getOption(n)
for(o||(o=f.render("option",e)),l=e[f.settings.optgroupField]||"",i=0,s=(a=Array.isArray(l)?l:[l])&&a.length;i<s;i++)l=a[i],f.optgroups.hasOwnProperty(l)||(l=""),g.hasOwnProperty(l)||(g[l]=document.createDocumentFragment(),r.push(l)),i>0&&(o=o.cloneNode(!0),O(o,"active")),g[l].appendChild(o)}for(this.settings.lockOptgroupOrder&&r.sort(((e,t)=>(f.optgroups[e]&&f.optgroups[e].$order||0)-(f.optgroups[t]&&f.optgroups[t].$order||0))),d=document.createDocumentFragment(),t=0,n=r.length;t<n;t++)if(l=r[t],f.optgroups.hasOwnProperty(l)&&g[l].children.length){let e=document.createDocumentFragment()
e.appendChild(f.render("optgroup_header",f.optgroups[l])),e.appendChild(g[l])
let t=f.render("optgroup",{group:f.optgroups[l],options:e})
d.appendChild(t)}else d.appendChild(g[l])
if(f.dropdown_content.innerHTML="",f.dropdown_content.appendChild(d),f.settings.highlight&&(f.dropdown_content,v=document.querySelectorAll("span.highlight"),Array.prototype.forEach.call(v,(function(e,t){var i=e.parentNode
...
if(f.loading?I("loading"):0===b.items.length&&f.settings.render.no_results&&m.length&&I("no_results"),(c=f.canCreate(m))&&(h=I("option_create")),f.hasOptions=b.items.length>0||c,C){if(b.items.length>0){if(!(u=w&&f.getOption(w))||!f.dropdown_content.contains(u)){let e=0
h&&!f.settings.addPrecedence&&(e=1),u=f.selectable()[e]}}else u=h
f.setActiveOption(u),e&&!f.isOpen&&f.open()}else f.setActiveOption(),e&&f.isOpen&&f.close()}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i,s,n=this
