...
e=e.parentNode}}function I(e,t=0){return t>0?e[e.length-1]:e[0]}function C(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function A(e,t){for(const i in t){let s=t[i]
null==s?e.removeAttribute(i):e.setAttribute(i,s)}}function _(e,t){e.parentNode&&e.parentNode.replaceChild(t,e)}const S=(e,t)=>{if(null===t)return
...
var o=n.cloneNode(!0)
return s.appendChild(o),_(n,s),1}return 0})(e):((e=>{if(1===e.nodeType&&e.childNodes&&!/(script|style)/i.test(e.tagName)&&("highlight"!==e.className||"SPAN"!==e.tagName))for(var t=0;t<e.childNodes.length;++t)t+=i(e.childNodes[t])})(e),0)
...
function k(e){return null==e?null:P(e)}function P(e){return"boolean"==typeof e?e?"1":"0":e+""}function L(e){return(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(e,t,i){var s,n=e.trigger,o={}
for(s in e.trigger=function(){var i=arguments[0]
if(-1===t.indexOf(i))return n.apply(e,arguments)
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function T(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function q(e,t,i,s){e.addEventListener(t,i,s)}function V(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function D(e,t){const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)}var j=0
class $ extends(function(e){return e.plugins={},class extends e{constructor(...e){super(...e),this.plugins={names:[],settings:{},requested:{},loaded:{}}}static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s
const n=this,o=[]
...
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&A(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),A(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":f}),a=D(i,d.inputId+"-tomselected")
let v="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",y=document.querySelector(v)
if(y){A(y,{for:a}),A(n,{"aria-labelledby":D(y,d.inputId+"-ts-label")})}var O,b,I
d.settings.copyClassesToDropdown&&m(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),m([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&A(u,{multiple:"multiple"}),d.settings.placeholder&&A(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(O=this.settings.load,b=this.settings.loadThrottle,function(e,t){var i=this
I&&(i.loading=Math.max(i.loading-1,0),clearTimeout(I)),I=setTimeout((function(){I=null,i.loadedSearches[e]=!0,O.call(i,e,t)}),b)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,q(s,"click",(e=>{const t=w(e.target,"[data-selectable]")
...
const C=t=>{if(!e.contains(t.target)&&!s.contains(t.target))return d.isFocused&&d.blur(),void d.inputState()
T(t,!0)}
var _=()=>{d.isOpen&&d.positionDropdown()}
q(document,"mousedown",C),q(window,"sroll",_,h),q(window,"resize",_,h),d._destroy=()=>{document.removeEventListener("mousedown",C),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,A(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),p.items=[],q(u,"invalid",(e=>{T(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.close(!1),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),m(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
else{switch(e.keyCode){case 65:if(V(F,e))return void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!V(F,e)&&T(e)}}onKeyUp(e){var t=this
if(t.isLocked)T(e)
...
T(t)}else"click"===i&&V(F,t)||"keydown"===i&&V("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
this.activeItems.splice(t,1),y(e,"active")}clearActiveItems(){y(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,A(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),A(e,{"aria-selected":"true"}),m(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(y(this.activeOption,"active"),A(this.activeOption,{"aria-selected":null})),this.activeOption=null,A(this.control_input,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(m(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
...
t.replaceChild(e.firstChild,e),t.normalize()})),m.query.length&&m.tokens.length))for(const e of m.tokens)S(w,e.regex)
...
_(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&m(s,"active"),_(a,s)),i.lastQuery=null}}removeOption(e,t){const i=this
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=g('<option value="'+L(i)+'">'+L(s)+"</option>")),e.selected=!0,A(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{const i=e;-1==t.items.indexOf(i.value)&&(A(i,{selected:null}),i.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,A(e.control_input,{"aria-expanded":"true"}),e.refreshState(),v(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),v(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,A(t.control_input,{"aria-expanded":"false"}),v(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
const r=[]
if(o.activeItems.length){s=C(I(o.activeItems,t)),t>0&&s++
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,y(e.input,"tomselected"),A(e.input,{hidden:null}),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){return"function"!=typeof this.settings.render[e]?null:this._render(e,t)}_render(e,t){var i,s
const n=this
return("option"===e||"item"===e)&&(i=P(t[n.settings.valueField]),s=n.rendered(e,i))?s:(s=n.settings.render[e].call(this,t,L))?(s=g(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?A(s,{"aria-disabled":"true"}):A(s,{"data-selectable":""}):"optgroup"===e&&(A(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&A(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(A(s,{"data-value":i}),"item"===e?m(s,n.settings.itemClass):(m(s,n.settings.optionClass),A(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
