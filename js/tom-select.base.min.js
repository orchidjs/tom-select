...
!e.regex&&s?i+=.1:i+=a(s,e,n[e.field])}else p(n,((s,n)=>{i+=a(r(t,n),e,s)}))
...
return this._getSortFunction(i)}_getSortFunction(e){var t,i,s,n,o,r,l,a,d,c,p,h
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function S(e,t){Object.assign(e.style,t)}function F(e,...t){var i=P(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=P(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function P(e){var t=[]
...
if(o=d.settings.mode,r=p.getAttribute("class")||"",F(e=A("<div>"),c.wrapperClass,r,o),F(t=A('<div class="items">'),c.inputClass),e.append(t),F(s=d.render("dropdown"),c.dropdownClass,o),F(n=A(`<div role="listbox" id="${h}" tabindex="-1">`),c.dropdownContentClass),s.append(n),A(c.dropdownParent||e).appendChild(s),c.controlInput)i=A(c.controlInput)
...
if(f){q(f,{for:a}),q(n,{"aria-labelledby":C(f,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&F(s,r),e.style.width=p.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),F([e,s],l)),(null===c.maxItems||c.maxItems>1)&&d.is_select_tag&&q(p,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:c.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var v=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?q(s,{"aria-disabled":"true"}):q(s,{"data-selectable":""}):"optgroup"===e&&(q(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&q(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(q(s,{"data-value":i}),"item"===e?F(s,n.settings.itemClass):(F(s,n.settings.optionClass),q(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
