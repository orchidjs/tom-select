...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function F(e,t){Object.assign(e.style,t)}function _(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function k(e){var t=[]
...
if(o=d.settings.mode,r=u.getAttribute("class")||"",_(e=A("<div>"),p.wrapperClass,r,o),_(t=A('<div class="items">'),p.inputClass),e.append(t),_(s=d.render("dropdown"),p.dropdownClass,o),_(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
...
d.settings.copyClassesToDropdown&&_(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),_([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&q(u,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,w(s,"click",(e=>{const t=L(e.target,"[data-selectable]")
t&&d.onOptionSelect(e,t)})),w(t,"click",(e=>{var s=L(e.target,"."+d.settings.itemClass,t)
...
w(document,"mousedown",I),w(window,"sroll",S,h),w(window,"resize",S,h),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",S),window.removeEventListener("resize",S)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,q(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),_(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t&&x(t,"last-active"),_(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),x(e,"active")}clearActiveItems(){x(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,q(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),q(e,{"aria-selected":"true"}),_(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(x(this.activeOption,"active"),this.activeOption.removeAttribute("aria-selected")),this.activeOption=null,this.control_input.removeAttribute("aria-activedescendant")}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(_(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,_(e.wrapper,"input-hidden")):(e.isInputHidden=!1,x(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
r.parentNode.replaceChild(e,r),i.activeOption===r&&i.setActiveOption(e)}r.remove()}l&&(-1!==(n=i.items.indexOf(e))&&i.items.splice(n,1,o),s=i.render("item",t),l.classList.contains("active")&&_(s,"active"),l.parentNode.replaceChild(s,l)),i.lastQuery=null}}removeOption(e,t){var i=this
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?q(s,{"aria-disabled":"true"}):q(s,{"data-selectable":""}):"optgroup"===e&&(q(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&q(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(q(s,{"data-value":i}),"item"===e?_(s,n.settings.itemClass):(_(s,n.settings.optionClass),q(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){if(this.renderCache[e].hasOwnProperty(t))return this.renderCache[e][t]}clearCache(e){var t=this
