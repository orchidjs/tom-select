...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},I=(e,t)=>{Object.assign(e.style,t)},C=(e,...t)=>{var i=S(t);(e=x(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},A=(e,...t)=>{var i=S(t);(e=x(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},S=e=>{var t=[]
