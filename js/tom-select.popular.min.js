...
null==s?e.removeAttribute(i):e.setAttribute(i,s)}}function A(e,t){e.parentNode&&e.parentNode.replaceChild(t,e)}const S=(e,t)=>{if(null===t)return
...
var o=n.cloneNode(!0)
return s.appendChild(o),A(n,s),1}return 0})(e):((e=>{if(1===e.nodeType&&e.childNodes&&!/(script|style)/i.test(e.tagName)&&("highlight"!==e.className||"SPAN"!==e.tagName))for(var t=0;t<e.childNodes.length;++t)t+=i(e.childNodes[t])})(e),0)
...
function k(e){return null==e?null:L(e)}function L(e){return"boolean"==typeof e?e?"1":"0":e+""}function P(e){return(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(e,t,i){var s,n=e.trigger,o={}
...
return i||(e.setAttribute("id",t),t)}var D=0
...
if(y){_(y,{for:a}),_(n,{"aria-labelledby":j(y,d.inputId+"-ts-label")})}var O,b,I
...
T(t,!0)}
var A=()=>{d.isOpen&&d.positionDropdown()}
q(document,"mousedown",C),q(window,"sroll",A,h),q(window,"resize",A,h),d._destroy=()=>{document.removeEventListener("mousedown",C),window.removeEventListener("sroll",A),window.removeEventListener("resize",A)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,_(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),p.items=[],q(u,"invalid",(e=>{T(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.close(!1),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),m(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
A(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&m(s,"active"),A(a,s)),i.lastQuery=null}}removeOption(e,t){const i=this
...
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),N.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
