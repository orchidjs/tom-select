...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function S(e,t){Object.assign(e.style,t)}function F(e,...t){var i=k(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=k(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function k(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function L(e){return Array.isArray(e)||(e=[e]),e}function P(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},V++
var s=A(e)
...
if(o=d.settings.mode,r=u.getAttribute("class")||"",F(e=A("<div>"),p.wrapperClass,r,o),F(t=A('<div class="items">'),p.inputClass),e.append(t),F(s=d.render("dropdown"),p.dropdownClass,o),F(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
else{i=A('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&q(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:d.tabIndex,t.appendChild(i)),q(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=C(i,d.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",v=document.querySelector(f)
if(v){q(v,{for:a}),q(n,{"aria-labelledby":C(v,d.inputId+"-ts-label")})}var m,y,O
d.settings.copyClassesToDropdown&&F(s,r),e.style.width=u.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),F([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&q(u,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter&&(d.settings.splitOn=new RegExp("\\s*"+c(d.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=u.type,w(s,"click",(e=>{const t=P(e.target,"[data-selectable]")
t&&d.onOptionSelect(e,t)})),w(t,"click",(e=>{var s=P(e.target,"."+d.settings.itemClass,t)
s&&d.onItemSelect(e,s)||""==i.value&&d.onClick(e)})),w(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),w(i,"keydown",(e=>d.onKeyDown(e))),w(i,"keyup",(e=>d.onKeyUp(e))),w(i,"keypress",(e=>d.onKeyPress(e))),w(i,"resize",(()=>d.positionDropdown()),h),w(i,"blur",(e=>d.onBlur(e))),w(i,"focus",(e=>d.onFocus(e))),w(i,"paste",(e=>d.onPaste(e)))
...
w(document,"mousedown",I),w(window,"sroll",_,h),w(window,"resize",_,h),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,q(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,u.disabled&&d.disable(),d.on("change",this.onChange),F(u,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFocused&&t.isOpen?t.blur():t.focus()}onMouseDown(e){}onChange(){_(this.input,"input"),_(this.input,"change")}onPaste(e){var t=this
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||x(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
...
this.activeItems.splice(t,1),x(e,"active")}clearActiveItems(){x(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,q(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),q(e,{"aria-selected":"true"}),F(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(x(this.activeOption,"active"),this.activeOption.removeAttribute("aria-selected")),this.activeOption=null,this.control_input.removeAttribute("aria-activedescendant")}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(F(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
...
return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,c,d,p
const u={},h=[]
var f,v=this,y=v.inputValue(),O=v.search(y),b=v.activeOption,w=v.settings.shouldOpen||!1,I=v.dropdown_content
for(b&&(c=b.dataset.value,d=b.closest("[data-group]")),n=O.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(w=!0),t=0;t<n;t++){let e=v.options[O.items[t].id],n=m(e[v.settings.valueField]),l=v.getOption(n)
for(l||(l=v.render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),q(l,{id:e.$id+"-clone-"+i}),l.classList.add("ts-cloned"),x(l,"active"),l.removeAttribute("aria-selected")),c==n&&d&&d.dataset.group===o&&(b=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(v.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment()
...
e&&!v.isOpen?(v.open(),v.scrollToOption(b,"auto"),v.setActiveOption(b)):v.setActiveOption(b)}else v.clearActiveOption(),e&&v.isOpen&&v.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
r.parentNode.replaceChild(e,r),i.activeOption===r&&i.setActiveOption(e)}r.remove()}l&&(-1!==(n=i.items.indexOf(e))&&i.items.splice(n,1,o),s=i.render("item",t),l.classList.contains("active")&&F(s,"active"),l.parentNode.replaceChild(s,l)),i.lastQuery=null}}removeOption(e,t){var i=this
...
for(let i=0;i<s.length;i++)if(s[i]==e)return t>0?s[i+1]:s[i-1]}}getItem(e){if(e=m(e))return e=e.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/'/g,"\\'"),this.control.querySelector(`[data-value="${e}"]`)}addItems(e,t){var i=this
...
if(!n.isPending&&n.settings.hideSelected){let t=n.getOption(e),i=n.getAdjacent(t,1)
i&&n.setActiveOption(i)}n.isPending||n.refreshOptions(n.isFocused&&"single"!==o),!s.length||n.isFull()?n.close():n.isPending||n.positionDropdown(),n.trigger("item_add",e,i),n.isPending||n.updateOriginalInput({silent:t})}(!n.isPending||!s&&n.isFull())&&n.refreshState()}}))}removeItem(e,t){var i,s,n=this,o=n.getItem(e)
...
var i,s,n,o
if(t.is_select_tag){function r(e,i,s){return e||(e=A('<option value="'+y(i)+'">'+y(s)+"</option>")),e.selected=!0,q(e,{selected:"true"}),t.input.prepend(e),e}for(t.input.querySelectorAll("option[selected]").forEach((e=>{-1==t.items.indexOf(e.value)&&(e.removeAttribute("selected"),e.selected=!1)})),i=t.items.length-1;i>=0;i--)s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",n.$option=r(n.$option,s,o)
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return j.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=A(t),e.settings.placeholder&&q(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{q(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex}),w(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=A('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),j.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),j.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
