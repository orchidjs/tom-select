...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function F(e,t){Object.assign(e.style,t)}function S(e,...t){var i=k(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=k(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function k(e){var t=[]
...
if(o=c.settings.mode,r=u.getAttribute("class")||"",S(e=A("<div>"),p.wrapperClass,r,o),S(t=A('<div class="items">'),p.inputClass),e.append(t),S(s=c.render("dropdown"),p.dropdownClass,o),S(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
...
r.parentNode.replaceChild(e,r),i.activeOption===r&&i.setActiveOption(e)}r.remove()}l&&(-1!==(n=i.items.indexOf(e))&&i.items.splice(n,1,o),s=i.render("item",t),l.classList.contains("active")&&S(s,"active"),l.parentNode.replaceChild(s,l)),i.lastQuery=null}}removeOption(e,t){var i=this
