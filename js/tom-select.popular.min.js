...
d[n]=d[n]||e.textContent,d[o]=d[o]||s,d[r]=d[r]||e.disabled,d[l]=d[l]||t,d.$option=e,p[s]=d,c.push(d)}e.selected&&u.items.push(s)}},f=e=>{var t,i;(i=g(e))[a]=i[a]||e.getAttribute("label")||"",i[d]=i[d]||h++,i[r]=i[r]||e.disabled,u.optgroups.push(i),t=i[d]
...
if(o=c.settings.mode,r=u.getAttribute("class")||"",e=g("<div>"),m(e,p.wrapperClass,r,o),t=g('<div class="items">'),m(t,p.inputClass),e.append(t),s=c._render("dropdown"),m(s,p.dropdownClass,o),n=g(`<div role="listbox" id="${v}" tabindex="-1">`),m(n,p.dropdownContentClass),s.append(n),g(p.dropdownParent||e).appendChild(s),p.controlInput)i=g(p.controlInput)
...
let f="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(c.inputId)+"']",y=document.querySelector(f)
if(y){_(y,{for:a})
...
for(O&&(d=O.dataset.value,c=O.closest("[data-group]")),n=m.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=v.options[m.items[t].id],n=P(e[v.settings.valueField]),l=v.getOption(n)
