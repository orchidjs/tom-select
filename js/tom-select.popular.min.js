...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},q=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},V=(e,t,i,s)=>{e.addEventListener(t,i,s)},j=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),$=(e,t)=>{const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)},D=e=>e.replace(/[\\"']/g,"\\$&"),N=(e,t)=>{t&&e.append(t)}
var R=0
...
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&_(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),_(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":b}),y=$(a,n.inputId+"-tomselected")
let I="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",C=document.querySelector(I)
if(C){_(C,{for:y})
let e=$(C,n.inputId+"-ts-label")
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return z.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=g(t),e.settings.placeholder&&_(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.on("initialize",(()=>{V(e.wrapper,"focus",(t=>{e.onFocus(t)}))
const i=()=>{_(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex})}
e.on("dropdown_close",i),e.on("dropdown_open",(()=>_(e.wrapper,{tabindex:"-1"}))),i(),V(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
let s=g('<div class="dropdown-input-wrap">')
s.appendChild(t),e.dropdown.insertBefore(s,e.dropdown.firstChild)}))})),z.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(i=>!!e.activeItems.length&&t.call(e,i)))})),z.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
...
i.removeItem(t),i.refreshOptions(!1)}})),o}}))}})),z.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
t.on("item_remove",(function(e){if(""===t.control_input.value.trim()){var s=t.options[e]
s&&t.setTextboxValue(i.text.call(t,s))}}))})),z}))
