...
e&&t.setActiveOption(e)}return void z(e)
case 13:return void(t.canSelect(t.activeOption)?(t.onOptionSelect(e,t.activeOption),z(e)):(t.settings.create&&t.createItem()||document.activeElement==t.control_input&&this.isOpen)&&z(e))
...
case 9:e.focus_node.tabIndex=-1}return e.onKeyDown.call(e,t)})),e.on("blur",(()=>{e.focus_node.tabIndex=e.isDisabled?-1:e.tabIndex})),e.on("dropdown_open",(()=>{console.log("dropdown open"),e.control_input.focus()}))
const t=e.onBlur
