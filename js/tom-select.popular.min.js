...
return i||(e.setAttribute("id",t),t)}function _(e){return e.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/'/g,"\\'")}function A(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function F(e,t){Object.assign(e.style,t)}function x(e,...t){var i=P(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function k(e,...t){var i=P(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function P(e){var t=[]
...
if(o=c.settings.mode,r=u.getAttribute("class")||"",x(e=A("<div>"),p.wrapperClass,r,o),x(t=A('<div class="items">'),p.inputClass),e.append(t),x(s=c.render("dropdown"),p.dropdownClass,o),x(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?V(s,{"aria-disabled":"true"}):V(s,{"data-selectable":""}):"optgroup"===e&&(V(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&V(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(V(s,{"data-value":i}),"item"===e?x(s,n.settings.itemClass):(x(s,n.settings.optionClass),V(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}
