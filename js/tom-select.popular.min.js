...
0!==s?e(t,(e=>{1!==s?e in this._events!=!1&&this._events[e].splice(this._events[e].indexOf(i),1):delete this._events[e]})):this._events={}}trigger(t,...i){var s=this
e(t,(e=>{if(e in s._events!=!1)for(let t of s._events[e])t.apply(s,i)}))}}var i
const s="[̀-ͯ·ʾ]",n=new RegExp(s,"gu")
var o
const r={"æ":"ae","ⱥ":"a","ø":"o"},l=new RegExp(Object.keys(r).join("|"),"gu"),a=[[0,65535]],c=e=>e.normalize("NFKD").replace(n,"").toLowerCase().replace(l,(function(e){return r[e]||e})),d=(e,t="|")=>{if(1===e.length&&null!=e[0])return e[0]
var i=1
...
e.forEach((e=>{for(let i=e[0];i<=e[1];i++){let e=String.fromCharCode(i),s=c(e)
if(s==e.toLowerCase())continue
if(s.length>3)continue
const n=t[s]||[s],o=new RegExp(p(n),"iu")
e.match(o)||(n.push(e),t[s]=n)}})),Object.keys(t).forEach((e=>{(t[e]||[]).length<2&&delete t[e]}))
let s=Object.keys(t).sort(((e,t)=>t.length-e.length))
...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},f=e=>(e+"").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu,"\\$1"),y=(e,t)=>{var i=e[t]
...
break}const d=l.length
return d?function(e,t){var i,s,n
for(i=0;i<d;i++){n=l[i].field
let o=a[i]
if(null==o&&(o="desc"===l[i].direction?-1:1),s=o*w(c(n,e),c(n,t)))return s}return 0}:null}prepareSearch(e,t){const i={}
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,t))s in o&&n.apply(e,o[s])},M=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},z=(e,t,i,s)=>{e.addEventListener(t,i,s)},K=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),Q=(e,t)=>{const i=e.getAttribute("id")
...
C([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&T(l,{multiple:"multiple"}),t.placeholder&&T(i,{placeholder:t.placeholder}),!t.splitOn&&t.delimiter&&(t.splitOn=new RegExp("\\s*"+f(t.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=R(t.load,t.loadThrottle)),e.control_input.type=l.type,z(s,"mouseenter",(t=>{var i=L(t.target,"[data-selectable]",s)
i&&e.onOptionHover(t,i)}),{capture:!0}),z(s,"click",(t=>{const i=L(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),M(t,!0))})),z(r,"click",(t=>{var s=L(t.target,"[data-ts-item]",r)
s&&e.onItemSelect(t,s)?M(t,!0):""==i.value&&(e.onClick(),M(t,!0))})),z(a,"keydown",(t=>e.onKeyDown(t))),z(i,"keypress",(t=>e.onKeyPress(t))),z(i,"input",(t=>e.onInput(t))),z(a,"resize",(()=>e.positionDropdown()),c),z(a,"blur",(t=>e.onBlur(t))),z(a,"focus",(t=>e.onFocus(t))),z(i,"paste",(t=>e.onPaste(t)))
const v=t=>{const n=t.composedPath()[0]
if(!o.contains(n)&&!s.contains(n))return e.isFocused&&e.blur(),void e.inputState()
n==i&&e.isOpen?t.stopPropagation():M(t,!0)},m=()=>{e.isOpen&&e.positionDropdown()},y=()=>{e.ignoreHover=!1}
z(document,"mousedown",v),z(window,"scroll",m,c),z(window,"resize",m,c),z(window,"mousemove",y,c),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("mousemove",y),window.removeEventListener("scroll",m),window.removeEventListener("resize",m),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,z(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),C(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),O(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
if(t.ignoreHover=!0,t.isLocked)9!==e.keyCode&&M(e)
else{switch(e.keyCode){case 65:if(K($,e)&&""==t.control_input.value)return M(e),void t.selectAll()
break
...
e&&t.setActiveOption(e)}return void M(e)
case 13:return void(t.canSelect(t.activeOption)?(t.onOptionSelect(e,t.activeOption),M(e)):(t.settings.create&&t.createItem()||document.activeElement==t.control_input&&t.isOpen)&&M(e))
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!K($,e)&&M(e)}}onInput(e){var t=this
...
M(t)}else"click"===i&&K($,t)||"keydown"===i&&K("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
for(v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(e)),o=n[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),T(l,{id:n.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),x(l,"active")),y||c!=e||(d?d.dataset.group===o.toString()&&(y=l):y=l),u[o].appendChild(l)}this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),O(h,(e=>{if(v.optgroups.hasOwnProperty(e)&&u[e].children.length){let t=document.createDocumentFragment(),i=v.render("optgroup_header",v.optgroups[e])
J(t,i),J(t,u[e])
...
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length&&O(f.tokens,(e=>{V(b,e.regex)})))
var _=e=>{let t=v.render(e,{input:m})
return t&&(w=!0,b.insertBefore(t,b.firstChild)),t}
if(v.loading?_("loading"):v.settings.shouldLoad.call(v,m)?0===f.items.length&&_("no_results"):_("not_loading"),(a=v.canCreate(m))&&(p=_("option_create")),v.hasOptions=f.items.length>0||a,w){if(f.items.length>0){if(!y&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!b.contains(y)){let e=0
...
function l(e,i,s){return e||(e=_('<option value="'+H(i)+'">'+H(s)+"</option>")),e!=n&&t.input.append(e),o.push(e),(e!=n||r>0)&&(e.selected=!0),e}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?l(n,"",""):t.items.forEach((e=>{if(i=t.options[e],s=i[t.settings.labelField]||"",o.includes(i.$option)){l(t.input.querySelector(`option[value="${G(e)}"]:not(:checked)`),e,s)}else i.$option=l(i.$option,e,s)}))}else t.input.value=t.getValue()
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,x(e.input,"tomselected","ts-hidden-accessible"),e._destroy(),delete e.input.tomselect}render(e,t){var i,s
const n=this
if("function"!=typeof this.settings.render[e])return null
if(null==(s=n.settings.render[e].call(this,t,H)))return s
if(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?T(s,{"aria-disabled":"true"}):T(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[n.settings.optgroupValueField],T(s,{"data-group":i}),t.group[n.settings.disabledField]&&T(s,{"data-disabled":""})),"option"===e||"item"===e){const i=N(t[n.settings.valueField])
T(s,{"data-value":i}),"item"===e?(C(s,n.settings.itemClass),T(s,{"data-ts-item":""})):(C(s,n.settings.optionClass),T(s,{role:"option",id:t.$id}),n.options[i].$div=s)}return s}_render(e,t){const i=this.render(e,t)
if(null==i)throw"HTMLElement expected"
return i}clearCache(){O(this.options,((e,t)=>{e.$div&&(e.$div.remove(),delete e.$div)}))}uncacheValue(e){const t=this.getOption(e)
...
const t=e.onBlur
e.hook("instead","onBlur",(i=>{if(!i||i.relatedTarget!=e.control_input)return t.call(e)})),z(e.control_input,"blur",(()=>e.onBlur())),e.hook("before","close",(()=>{e.isOpen&&e.focus_node.focus({preventScroll:!0})}))}))})),X.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(i=>!!e.activeItems.length&&t.call(e,i)))})),X.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
...
return o.appendChild(r),z(r,"mousedown",(e=>{M(e,!0)})),z(r,"click",(e=>{M(e,!0),i.isLocked||i.shouldDelete([o],e)&&(i.removeItem(o),i.refreshOptions(!1),i.inputState())})),o}}))}})),X.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
