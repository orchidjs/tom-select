...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.ignoreBlur=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},V++
var s=_(e)
if(s.tomselect)throw new Error("Tom Select already initialized on this element")
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),this.settings=function(e,t){var i=Object.assign({},v,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,d=i.optgroupValueField,c=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
"function"!=typeof n&&("string"==typeof n&&(n=new RegExp(n)),n instanceof RegExp?this.settings.createFilter=e=>n.test(e):this.settings.createFilter=()=>!0),this.initializePlugins(this.settings.plugins),this.setupCallbacks(),this.setupTemplates(),this.setup()}setup(){var e,t,i,s,n,o,r,l,a,d=this,c=d.settings,p=d.input
const u={passive:!0},h=d.inputId+"-ts-dropdown"
if(o=d.settings.mode,r=p.getAttribute("class")||"",S(e=_("<div>"),c.wrapperClass,r,o),S(t=_('<div class="items">'),c.inputClass),e.append(t),S(s=d.render("dropdown"),c.dropdownClass,o),S(n=_(`<div role="listbox" id="${h}" tabindex="-1">`),c.dropdownContentClass),s.append(n),_(c.dropdownParent||e).appendChild(s),c.controlInput)i=_(c.controlInput)
else{i=_('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])p.getAttribute(e)&&q(i,{[e]:p.getAttribute(e)})}c.controlInput||(i.tabIndex=p.disabled?-1:d.tabIndex,t.appendChild(i)),q(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":h}),a=C(i,d.inputId+"-tomselected")
let g="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",f=document.querySelector(g)
if(f){q(f,{for:a}),q(n,{"aria-labelledby":C(f,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&S(s,r),e.style.width=p.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),S([e,s],l)),(null===c.maxItems||c.maxItems>1)&&d.is_select_tag&&q(p,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:c.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var v=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=p.type,b(s,"mouseenter",(e=>{var t=L(e.target,"[data-selectable]",s)
...
b(document,"mousedown",I),b(window,"sroll",A,u),b(window,"resize",A,u),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",A),window.removeEventListener("resize",A)},this.revertSettings={innerHTML:p.innerHTML,tabIndex:p.tabIndex},p.tabIndex=-1,q(p,{hidden:"hidden"}),p.insertAdjacentElement("afterend",d.wrapper),d.setValue(c.items),delete c.items,b(p,"invalid",(e=>{w(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,p.disabled&&d.disable(),d.on("change",this.onChange),S(p,"tomselected"),d.trigger("initialize"),!0===c.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,d,c,p,u,h,f=this,v=f.inputValue(),y=f.search(v),O=f.activeOption&&m(f.activeOption.dataset.value),w=f.settings.shouldOpen||!1
...
if(f.settings.shouldLoad.call(f,v)?f.loading?b("loading"):0===y.items.length&&b("no_results"):b("not_loading"),(d=f.canCreate(v))&&(p=b("option_create")),f.hasOptions=y.items.length>0||d,w){if(y.items.length>0){if(!(c=O&&f.getOption(O))||!f.dropdown_content.contains(c)){let e=0
