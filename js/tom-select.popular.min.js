...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},C=(e,t)=>{Object.assign(e.style,t)},_=(e,...t)=>{var i=S(t);(e=x(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},A=(e,...t)=>{var i=S(t);(e=x(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},S=e=>{var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)},x=e=>(Array.isArray(e)||(e=[e]),e),F=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
const V=e=>null==e?null:$(e),$=e=>"boolean"==typeof e?e?"1":"0":e+"",N=e=>(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),D=(e,t)=>{var i
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},z=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},H=(e,t,i,s)=>{e.addEventListener(t,i,s)},B=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),K=(e,t)=>{const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)},M=e=>e.replace(/[\\"']/g,"\\$&"),Q=(e,t)=>{t&&e.append(t)}
var G=0
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.currentResults=void 0,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},G++
var s=b(e),n=this
...
if(p=n.settings.mode,u=s.getAttribute("class")||"",r=b("<div>"),_(r,t.wrapperClass,u,p),l=b('<div class="items">'),_(l,t.inputClass),Q(r,l),c=n._render("dropdown"),_(c,t.dropdownClass,p),d=b(`<div role="listbox" id="${m}" tabindex="-1">`),_(d,t.dropdownContentClass),Q(c,d),b(t.dropdownParent||r).appendChild(c),t.controlInput)a=b(t.controlInput)
else{a=b('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&L(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),L(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":m}),g=K(a,n.inputId+"-tomselected")
let y="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",O=document.querySelector(y)
if(O){L(O,{for:g})
let e=K(O,n.inputId+"-ts-label")
L(d,{"aria-labelledby":e})}n.settings.copyClassesToDropdown&&_(c,u),r.style.width=s.style.width,n.plugins.names.length&&(h="plugin-"+n.plugins.names.join(" plugin-"),_([r,c],h)),(null===t.maxItems||t.maxItems>1)&&n.is_select_tag&&L(s,{multiple:"multiple"}),n.settings.placeholder&&L(a,{placeholder:t.placeholder}),!n.settings.splitOn&&n.settings.delimiter&&(n.settings.splitOn=new RegExp("\\s*"+f(n.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=D(this.settings.load,this.settings.loadThrottle)),this.control=l,this.control_input=a,this.wrapper=r,this.dropdown=c,this.dropdown_content=d,n.control_input.type=s.type,H(c,"click",(e=>{const t=F(e.target,"[data-selectable]")
t&&(n.onOptionSelect(e,t),z(e,!0))})),H(l,"click",(e=>{var t=F(e.target,"."+n.settings.itemClass,l)
t&&n.onItemSelect(e,t)?z(e,!0):""==a.value&&(n.onClick(),z(e,!0))})),H(a,"mousedown",(e=>{""!==a.value&&e.stopPropagation()})),H(a,"keydown",(e=>n.onKeyDown(e))),H(a,"keyup",(e=>n.onKeyUp(e))),H(a,"keypress",(e=>n.onKeyPress(e))),H(a,"resize",(()=>n.positionDropdown()),v),H(a,"blur",(()=>n.onBlur())),H(a,"focus",(e=>n.onFocus(e))),H(a,"paste",(e=>n.onPaste(e)))
...
case 9:return void(t.settings.selectOnTab&&(t.isOpen&&t.activeOption&&(t.tab_key=!0,t.onOptionSelect(e,t.activeOption),z(e),t.tab_key=!1),t.settings.create&&t.createItem()&&z(e)))
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!B(q,e)&&z(e)}}onKeyUp(e){var t=this
if(t.isLocked)z(e)
...
i.loading=Math.max(i.loading-1,0),i.lastQuery=null,i.clearActiveOption(),i.setupOptions(e,t),i.refreshOptions(i.isFocused&&!i.isInputHidden),i.loading||A(i.wrapper,i.settings.loadingClass),i.trigger("load",e,t)}setTextboxValue(e=""){var t=this.control_input
...
z(t)}else"click"===i&&B(q,t)||"keydown"===i&&B("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){const t=this,i=t.control.querySelector(".last-active")
i&&A(i,"last-active"),_(e,"active last-active"),t.trigger("item_select",e),-1==t.activeItems.indexOf(e)&&t.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),A(e,"active")}clearActiveItems(){A(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,L(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),L(e,{"aria-selected":"true"}),_(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(A(this.activeOption,"active"),L(this.activeOption,{"aria-selected":null})),this.activeOption=null,L(this.control_input,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(_(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,_(e.wrapper,"input-hidden")):(e.isInputHidden=!1,A(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
const u={},h=[]
var g,v=this,f=v.inputValue(),m=v.search(f),y=v.activeOption,O=v.settings.shouldOpen||!1,w=v.dropdown_content
for(y&&(c=y.dataset.value,d=y.closest("[data-group]")),n=m.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(O=!0),t=0;t<n;t++){let e=v.options[m.items[t].id],n=$(e[v.settings.valueField]),l=v.getOption(n)
for(l||(l=v._render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),L(l,{id:e.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),A(l,"active")),c==n&&d&&d.dataset.group===o&&(y=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(v.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment(),t=v.render("optgroup_header",v.optgroups[o])
Q(e,t),Q(e,u[o])
let i=v.render("optgroup",{group:v.optgroups[o],options:e})
Q(l,i)}else Q(l,u[o])
if(w.innerHTML="",Q(w,l),v.settings.highlight&&(g=w.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),m.query.length&&m.tokens.length))for(const e of m.tokens)T(w,e.regex)
var b=e=>{let t=v.render(e,{input:f})
return t&&(O=!0,w.insertBefore(t,w.firstChild)),t}
if(v.settings.shouldLoad.call(v,f)?v.loading?b("loading"):0===m.items.length&&b("no_results"):b("not_loading"),(a=v.canCreate(f))&&(p=b("option_create")),v.hasOptions=m.items.length>0||a,O){if(m.items.length>0){if(!w.contains(y)&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!w.contains(y)){let e=0
...
t&&t.remove()}}getOption(e){var t=V(e)
...
var t=V(e)
return t?this.control.querySelector(`[data-value="${M(t)}"]`):null}addItems(e,t){var i=this,s=Array.isArray(e)?e:[e]
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,A(e.input,"tomselected"),L(e.input,{hidden:null}),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){return"function"!=typeof this.settings.render[e]?null:this._render(e,t)}_render(e,t){var i,s,n=""
const o=this
return("option"===e||"item"===e)&&(n=$(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,N))||(s=b(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?L(s,{"aria-disabled":"true"}):L(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],L(s,{"data-group":i}),t.group[o.settings.disabledField]&&L(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(L(s,{"data-value":n}),"item"===e?_(s,o.settings.itemClass):(_(s,o.settings.optionClass),L(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return U.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=b(t),e.settings.placeholder&&L(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.on("initialize",(()=>{H(e.wrapper,"focus",(t=>{e.onFocus(t)}))
const i=()=>{L(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex})}
e.on("dropdown_close",i),e.on("dropdown_open",(()=>L(e.wrapper,{tabindex:"-1"}))),i(),H(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick()}}))
let s=b('<div class="dropdown-input-wrap">')
s.appendChild(t),e.dropdown.insertBefore(s,e.dropdown.firstChild)}))})),U.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
...
i.settings.render.item=(t,n)=>{var o=b(e.call(i,t,n)),r=b(s)
return o.appendChild(r),H(r,"mousedown",(e=>{z(e,!0)})),H(r,"click",(e=>{if(z(e,!0),!i.isLocked){var t=o.dataset.value
