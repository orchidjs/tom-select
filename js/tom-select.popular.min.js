...
return i||(e.setAttribute("id",t),t)},$=e=>e.replace(/[\\"']/g,"\\$&"),N=(e,t)=>{t&&e.append(t)}
var R=0
...
function r(t,i,s){return t||(t=g('<option value="'+L(i)+'">'+L(s)+"</option>")),t.selected=!0,_(t,{selected:"true"}),N(e,t),t}if(t.input.querySelectorAll("option[selected]").forEach((e=>{_(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=0;i<t.items.length;i++)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.contains(n.$option)){r(t.input.querySelector(`option[value="${$(s)}"]`),s,o)}else n.$option=r(n.$option,s,o)
