...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},d=e=>(e+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),c=(e,t)=>{var i=e[t]
...
r&&(i=e.match(r))&&(n=i[1],e=i[2]),e.length>0&&(l=d(e),this.settings.diacritics&&(l=o(l)),t&&(l="\\b"+l)),s.push({string:e,regex:l?new RegExp(l,"i"):null,field:n})})),s}getScoreFunction(e,t){var i=this.prepareSearch(e,t)
...
const n=this,o=e.options,r=!e.query&&o.sort_empty?o.sort_empty:o.sort,l=[],a=[],d=function(t,i){return"$score"===t?i.score:e.getAttrFn(n.items[i.id],t)}
if(r)for(t=0,i=r.length;t<i;t++)(e.query||"$score"!==r[t].field)&&l.push(r[t])
if(e.query){for(s=!0,t=0,i=l.length;t<i;t++)if("$score"===l[t].field){s=!1
break}s&&l.unshift({field:"$score",direction:"desc"})}else for(t=0,i=l.length;t<i;t++)if("$score"===l[t].field){l.splice(t,1)
break}for(t=0,i=l.length;t<i;t++)a.push("desc"===l[t].direction?-1:1)
const c=l.length
if(c){if(1===c){const e=l[0].field,t=a[0]
return function(i,s){return t*u(d(e,i),d(e,s))}}return function(e,t){var i,s,n
for(i=0;i<c;i++)if(n=l[i].field,s=a[i]*u(d(n,e),d(n,t)))return s
return 0}}return null}prepareSearch(e,t){const i={}
var n=Object.assign({},t)
if(c(n,"sort"),c(n,"sort_empty"),n.fields){c(n,"fields")
const e=[]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},m=(e,t)=>{Object.assign(e.style,t)},f=(e,...t)=>{var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},y=(e,...t)=>{var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},O=e=>{var t=[]
...
return i||(e.setAttribute("id",t),t)},$=e=>e.replace(/[\\"']/g,"\\$&")
var N=0
...
d[n]=d[n]||e.textContent,d[o]=d[o]||s,d[r]=d[r]||e.disabled,d[l]=d[l]||t,d.$option=e,p[s]=d,c.push(d)}e.selected&&u.items.push(s)}},m=e=>{var t,i;(i=g(e))[a]=i[a]||e.getAttribute("label")||"",i[d]=i[d]||h++,i[r]=i[r]||e.disabled,u.optgroups.push(i),t=i[d]
...
const h={passive:!0},v=c.inputId+"-ts-dropdown"
if(o=c.settings.mode,r=u.getAttribute("class")||"",e=g("<div>"),f(e,p.wrapperClass,r,o),t=g('<div class="items">'),f(t,p.inputClass),e.append(t),s=c._render("dropdown"),f(s,p.dropdownClass,o),n=g(`<div role="listbox" id="${v}" tabindex="-1">`),f(n,p.dropdownContentClass),s.append(n),g(p.dropdownParent||e).appendChild(s),p.controlInput)i=g(p.controlInput)
else{i=g('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&_(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),_(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":v}),a=D(i,c.inputId+"-tomselected")
let m="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(c.inputId)+"']",y=document.querySelector(m)
if(y){_(y,{for:a})
let e=D(y,c.inputId+"-ts-label")
_(n,{"aria-labelledby":e})}c.settings.copyClassesToDropdown&&f(s,r),e.style.width=u.style.width,c.plugins.names.length&&(l="plugin-"+c.plugins.names.join(" plugin-"),f([e,s],l)),(null===p.maxItems||p.maxItems>1)&&c.is_select_tag&&_(u,{multiple:"multiple"}),c.settings.placeholder&&_(i,{placeholder:p.placeholder}),!c.settings.splitOn&&c.settings.delimiter&&(c.settings.splitOn=new RegExp("\\s*"+d(c.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=E(this.settings.load,this.settings.loadThrottle)),c.control=t,c.control_input=i,c.wrapper=e,c.dropdown=s,c.dropdown_content=n,c.control_input.type=u.type,V(s,"click",(e=>{const t=w(e.target,"[data-selectable]")
...
else{switch(e.keyCode){case 65:if(j(F,e))return void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!j(F,e)&&q(e)}}onKeyUp(e){var t=this
if(t.isLocked)q(e)
...
q(t)}else"click"===i&&j(F,t)||"keydown"===i&&j("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){const t=this,i=t.control.querySelector(".last-active")
i&&y(i,"last-active"),f(e,"active last-active"),t.trigger("item_select",e),-1==t.activeItems.indexOf(e)&&t.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),y(e,"active")}clearActiveItems(){y(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,_(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),_(e,{"aria-selected":"true"}),f(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
...
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,f(e.wrapper,"input-hidden")):(e.isInputHidden=!1,y(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
for(O&&(d=O.dataset.value,c=O.closest("[data-group]")),n=f.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=v.options[f.items[t].id],n=P(e[v.settings.valueField]),l=v.getOption(n)
for(l||(l=v._render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),_(l,{id:e.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),y(l,"active")),d==n&&c&&c.dataset.group===o&&(O=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(v.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment(),t=v.render("optgroup_header",v.optgroups[o])
t&&e.append(t),e.append(u[o])
let i=v.render("optgroup",{group:v.optgroups[o],options:e})
l.append(i)}else l.append(u[o])
if(w.innerHTML="",w.append(l),v.settings.highlight&&(g=w.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length))for(const e of f.tokens)A(w,e.regex)
var I=e=>{let t=v.render(e,{input:m})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(v.settings.shouldLoad.call(v,m)?v.loading?I("loading"):0===f.items.length&&I("no_results"):I("not_loading"),(a=v.canCreate(m))&&(p=I("option_create")),v.hasOptions=f.items.length>0||a,b){if(f.items.length>0){if(!w.contains(O)&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!w.contains(O)){let e=0
p&&!v.settings.addPrecedence&&(e=1),O=v.selectable()[e]}}else O=p
...
S(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&f(s,"active"),S(a,s)),i.lastQuery=null}}removeOption(e,t){const i=this
...
var t=k(e)
return t?this.control.querySelector(`[data-value="${$(t)}"]`):null}addItems(e,t){var i=this,s=Array.isArray(e)?e:[e]
...
function r(t,i,s){return t||(t=g('<option value="'+L(i)+'">'+L(s)+"</option>")),t.selected=!0,_(t,{selected:"true"}),e.append(t),t}if(t.input.querySelectorAll("option[selected]").forEach((e=>{_(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=0;i<t.items.length;i++)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.contains(n.$option)){r(t.input.querySelector(`option[value="${$(s)}"]`),s,o)}else n.$option=r(n.$option,s,o)
else r(t.input.querySelector('option[value=""]'),"","")
t.input.prepend(e)}else t.input.value=t.getValue()
t.isSetup&&(e.silent||t.trigger("change",t.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,_(e.control_input,{"aria-expanded":"true"}),e.refreshState(),m(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),m(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,_(t.control_input,{"aria-expanded":"false"}),m(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
const o=this
return("option"===e||"item"===e)&&(i=P(t[o.settings.valueField]),n=o.rendered(e,i))?n:(n=o.settings.render[e].call(this,t,L))?(n=g(n),"option"===e||"option_create"===e?t[o.settings.disabledField]?_(n,{"aria-disabled":"true"}):_(n,{"data-selectable":""}):"optgroup"===e&&(s=t.group[o.settings.optgroupValueField],_(n,{"data-group":s}),t.group[o.settings.disabledField]&&_(n,{"data-disabled":""})),"option"!==e&&"item"!==e||(_(n,{"data-value":i}),"item"===e?f(n,o.settings.itemClass):(f(n,o.settings.optionClass),_(n,{role:"option",id:t.$id})),o.renderCache[e][i]=n),n):n}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return R.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
...
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),R.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),R.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
if(e.append){var i='<a href="javascript:void(0)" class="'+e.className+'" tabindex="-1" title="'+L(e.title)+'">'+e.label+"</a>"
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),R}))
