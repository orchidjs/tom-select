...
r[i]=arguments},i.apply(e,[]),e.trigger=n,r)n.apply(e,r[s])}function u(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function h(e,t,i,s){e.addEventListener(t,i,s)}function g(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function f(e){if(e.jquery)return e[0]
...
return t.filter(Boolean)}function w(e){return Array.isArray(e)||(e=[e]),e}function I(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
c[n]=c[n]||e.textContent,c[r]=c[r]||s,c[o]=c[o]||e.disabled,c[l]=c[l]||t,u[s]=c,a.push(c),e.selected&&g.items.push(s)}},m=e=>{var t,i;(i=f(e))[p]=i[p]||e.getAttribute("label")||"",i[c]=i[c]||h++,i[o]=i[o]||e.disabled,g.optgroups.push(i),t=i[c]
...
const g={passive:!0}
if(r=d.settings.mode,o=c.getAttribute("class")||"",y(e=f("<div>"),p.wrapperClass,o,r),y(t=f('<div class="items">'),p.inputClass),e.append(t),y(s=d.render("dropdown"),p.dropdownClass,r),y(n=f('<div style="scroll-behavior: smooth;">'),p.dropdownContentClass),s.append(n),f(p.dropdownParent||e).appendChild(s),p.controlInput)i=f(p.controlInput)
...
t&&t.setAttribute("for",a+"-tomselected")}if(d.settings.copyClassesToDropdown&&y(s,o),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),y([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&c.setAttribute("multiple","multiple"),d.settings.placeholder&&i.setAttribute("placeholder",p.placeholder),!d.settings.splitOn&&d.settings.delimiter){var v=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
u(e,!0),t&&d.onOptionSelect(e,t)},O=()=>{d.isOpen&&d.positionDropdown()}
h(document,"mousedown",m),h(window,"sroll",O,g),h(window,"resize",O,g),d._destroy=()=>{document.removeEventListener("mousedown",m),window.removeEventListener("sroll",O),window.removeEventListener("resize",O)}
for(var b=[];c.children.length>0;)b.push(c.children[0]),c.children[0].remove()
this.revertSettings={children:b,tabIndex:c.tabIndex},c.tabIndex=-1,c.setAttribute("hidden","hidden"),c.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,h(c,"invalid",(e=>{u(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,c.disabled&&d.disable(),d.on("change",this.onChange),y(c,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
setTimeout((()=>t.focus()),0)}onChange(){v(this.input,"input"),v(this.input,"change")}onPaste(e){var t=this
...
i&&(t.loadedSearches.hasOwnProperty(e)||(y(t.wrapper,t.settings.loadingClass),t.loading++,i.call(t,e,(function(e,i){t.loading=Math.max(t.loading-1,0),t.lastQuery=null,t.clearActiveOption(),t.setupOptions(e,i),t.refreshOptions(t.isFocused&&!t.isInputHidden),t.loading||O(t.wrapper,t.settings.loadingClass),t.trigger("load",e,i)}))))}onSearchChange(e){this.load(e)}setTextboxValue(e){var t=this.control_input
t.value!==e&&(t.value=e,v(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){c(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,r,o,a,d=this
...
this.activeItems.splice(t,1),O(e,"active")}clearActiveItems(){O(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){var t,i,s
if(e===this.activeOption)return
if(this.clearActiveOption(),!e)return
this.activeOption=e,y(e,"active"),t=this.dropdown_content.clientHeight
let n=this.dropdown_content.scrollTop||0
i=this.activeOption.offsetHeight,(s=this.activeOption.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+n)+i>t+n?this.dropdown_content.scrollTop=s-t+i:s<n&&(this.dropdown_content.scrollTop=s)}clearActiveOption(){this.activeOption&&O(this.activeOption,"active"),this.activeOption=null}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(y(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(""),e.isInputHidden=!0,y(e.wrapper,"input-hidden")):(e.isInputHidden=!1,O(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,p,c,u,h,g,f,v=this,m=v.inputValue(),b=v.search(m),w=v.activeOption&&d(v.activeOption.dataset.value),I=v.settings.shouldOpen||!1
for(n=b.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(I=!0),g={},r=[],t=0;t<n;t++){let e=v.options[b.items[t].id],n=d(e[v.settings.valueField]),o=v.getOption(n)
for(o||(o=v.render("option",e)),l=e[v.settings.optgroupField]||"",i=0,s=(a=Array.isArray(l)?l:[l])&&a.length;i<s;i++)l=a[i],v.optgroups.hasOwnProperty(l)||(l=""),g.hasOwnProperty(l)||(g[l]=document.createDocumentFragment(),r.push(l)),i>0&&(o=o.cloneNode(!0),O(o,"active")),g[l].appendChild(o)}for(l of(this.settings.lockOptgroupOrder&&r.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),p=document.createDocumentFragment(),r))if(v.optgroups.hasOwnProperty(l)&&g[l].children.length){let e=document.createDocumentFragment()
...
i.replaceChild(e.firstChild,e),i.normalize()})),b.query.length&&b.tokens.length))for(const e of b.tokens)o(v.dropdown_content,e.regex)
...
if(v.settings.shouldLoad.call(v,m)?v.loading?C("loading"):0===b.items.length&&C("no_results"):C("not_loading"),(c=v.canCreate(m))&&(h=C("option_create")),v.hasOptions=b.items.length>0||c,I){if(b.items.length>0){if(!(u=w&&v.getOption(w))||!v.dropdown_content.contains(u)){let e=0
...
a=p.options[e].$order,n!==e&&(delete p.options[e],-1!==(r=p.items.indexOf(e))&&p.items.splice(r,1,n)),t.$order=t.$order||a,p.options[n]=t,o=p.renderCache.item,l=p.renderCache.option,o&&(delete o[e],delete o[n]),l&&(delete l[e],delete l[n]),-1!==p.items.indexOf(n)&&(i=p.getItem(e),s=p.render("item",t),i.classList.contains("active")&&y(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),p.lastQuery=null,p.isOpen&&p.refreshOptions(!1)}}removeOption(e,t){var i=this
e=d(e)
...
r&&(e=d(r.dataset.value),-1!==(i=n.items.indexOf(e))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),O(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,r)))}createItem(e,t=!0,i){var s,n=this,r=n.caretPos
...
if(t=e&&8===e.keyCode?-1:1,i={start:(r=o.control_input).selectionStart,length:r.selectionEnd-r.selectionStart},s=[],o.activeItems.length){n=A(C(o.activeItems,t)),t>0&&n++
...
if(("option"===e||"item"===e)&&(i=d(t[r.settings.valueField]),r.renderCache[e].hasOwnProperty(i)))return r.renderCache[e][i]
var o=r.settings.render[e]
return"function"!=typeof o?null:(n=o.call(this,t,p))?(n=f(n),"option"===e||"option_create"===e?t[r.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[r.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[r.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),y(n,"item"===e?r.settings.itemClass:r.settings.optionClass),r.renderCache[e][i]=n),n):n}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,r
return"after"===e&&(t=n.apply(s,arguments)),r=i.apply(s,arguments),"instead"===e?r:("before"===e&&(t=n.apply(s,arguments)),t)}}}return _.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=f(t),e.settings.placeholder&&t.setAttribute("placeholder",e.settings.placeholder),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{e.wrapper.setAttribute("tabindex",e.input.disabled?"-1":e.tabIndex),h(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=f('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),_.define("no_backspace_delete",(function(e){var t=this,i=t.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!t.activeItems.length&&i.apply(t,arguments)}))})),_.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
t.removeItem(i),t.refreshOptions(!1)}})),s}}))}})),_.define("restore_on_backspace",(function(e){var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),_}))
