...
let t=p[o]
void 0===t&&(t=document.createDocumentFragment(),h.push(o)),i>0&&(u=u.cloneNode(!0),z(u,{id:l.$id+"-clone-"+i,"aria-selected":null}),u.classList.add("ts-cloned"),D(u,"active")),y||c!=n||(d?d.dataset.group===o.toString()&&(y=u):y=u),t.appendChild(u),p[o]=t}}f.settings.lockOptgroupOrder&&h.sort(((t,e)=>{const i=f.optgroups[t],s=f.optgroups[e]
return(i&&i.$order||0)-(s&&s.$order||0)})),l=document.createDocumentFragment(),k(h,(t=>{let e=p[t]
