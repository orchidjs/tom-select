...
if(o=d.settings.mode,r=c.getAttribute("class")||"",b(e=m("<div>"),p.wrapperClass,r,o),b(t=m('<div class="items">'),p.inputClass),e.append(t),b(s=d.render("dropdown"),p.dropdownClass,o),b(n=m(`<div role="listbox" id="${f}" tabindex="-1">`),p.dropdownContentClass),s.append(n),m(p.dropdownParent||e).appendChild(s),p.controlInput)i=m(p.controlInput)
