...
var p
if(C(o,t.wrapperClass,c,d),C(r,t.controlClass),Q(o,r),C(l,t.dropdownClass,d),t.copyClassesToDropdown&&C(l,c),C(a,t.dropdownContentClass),Q(l,a),b(t.dropdownParent||o).appendChild(l),t.hasOwnProperty("controlInput"))t.controlInput?(p=b(t.controlInput),this.focus_node=p):(p=b("<input/>"),this.focus_node=r)
