...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0}function d(e){return(e+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}function p(e,t){var i=e[t]
...
const s=e.options.fields,n=e.weights,o=s.length,r=e.getAttrFn,l=o?1===o?function(e,t){const i=s[0].field
return a(r(t,i),e,n[i])}:function(e,t){var i=0
if(e.field){const s=r(t,e.field)
!e.regex&&s?i+=1/o:i+=a(s,e,1)}else c(n,((s,n)=>{i+=a(r(t,n),e,s)}))
...
const l=this,a=e.options,d=!e.query&&a.sort_empty||a.sort,p=[],c=[],h=function(t,i){return"$score"===t?i.score:e.getAttrFn(l.items[i.id],t)}
if(d)for(t=0,i=d.length;t<i;t++)(e.query||"$score"!==d[t].field)&&p.push(d[t])
if(e.query){for(r=!0,t=0,i=p.length;t<i;t++)if("$score"===p[t].field){r=!1
break}r&&p.unshift({field:"$score",direction:"desc"})}else for(t=0,i=p.length;t<i;t++)if("$score"===p[t].field){p.splice(t,1)
break}for(t=0,i=p.length;t<i;t++)c.push("desc"===p[t].direction?-1:1)
return(n=p.length)?1===n?(s=p[0].field,o=c[0],function(e,t){return o*u(h(s,e),h(s,t))}):function(e,t){var i,s,o
for(i=0;i<n;i++)if(o=p[i].field,s=c[i]*u(h(o,e),h(o,t)))return s
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function F(e,t){Object.assign(e.style,t)}function S(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function k(e){var t=[]
...
if(o=d.settings.mode,r=c.getAttribute("class")||"",S(e=_("<div>"),p.wrapperClass,r,o),S(t=_('<div class="items">'),p.inputClass),e.append(t),S(s=d.render("dropdown"),p.dropdownClass,o),S(n=_(`<div role="listbox" id="${h}" tabindex="-1">`),p.dropdownContentClass),s.append(n),_(p.dropdownParent||e).appendChild(s),p.controlInput)i=_(p.controlInput)
...
if(f){q(f,{for:a}),q(n,{"aria-labelledby":C(f,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&S(s,r),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),S([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&q(c,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var v=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
t&&x(t,"last-active"),S(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
...
this.activeOption=e,q(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),q(e,{"aria-selected":"true"}),S(e,"active"),t=this.dropdown_content.clientHeight
let n=this.dropdown_content.scrollTop||0
i=this.activeOption.offsetHeight,(s=this.activeOption.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+n)+i>t+n?this.dropdown_content.scrollTop=s-t+i:s<n&&(this.dropdown_content.scrollTop=s)}clearActiveOption(){this.activeOption&&(x(this.activeOption,"active"),this.activeOption.removeAttribute("aria-selected")),this.activeOption=null,this.control_input.removeAttribute("aria-activedescendant")}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(S(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,S(e.wrapper,"input-hidden")):(e.isInputHidden=!1,x(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
a=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(o=d.items.indexOf(e))&&d.items.splice(o,1,n)),t.$order=t.$order||a,d.options[n]=t,r=d.renderCache.item,l=d.renderCache.option,r&&(delete r[e],delete r[n]),l&&(delete l[e],delete l[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&S(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=m(e)
...
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,q(e.control_input,{"aria-expanded":"true"}),e.refreshState(),F(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),F(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,q(t.control_input,{"aria-expanded":"false"}),F(t.dropdown,{display:"none"}),t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?q(s,{"aria-disabled":"true"}):q(s,{"data-selectable":""}):"optgroup"===e&&(q(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&q(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(q(s,{"data-value":i}),"item"===e?S(s,n.settings.itemClass):(S(s,n.settings.optionClass),q(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
