...
for(O&&(d=O.dataset.value,c=O.closest("[data-group]")),n=m.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=v.options[m.items[t].id],n=L(e[v.settings.valueField]),l=v.getOption(n)
