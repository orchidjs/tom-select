...
return e?-1===(n=(e=String(e||"")).search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0}function d(e){return(e+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}function p(e,t){var i=e[t]
i&&!Array.isArray(i)&&(e[t]=[i])}function c(e,t){if(Array.isArray(e))e.forEach(t)
...
var s,n=[],r=e.split(/\s+/)
return i&&(s=new RegExp("^("+Object.keys(i).map(d).join("|")+"):(.*)$")),r.forEach((e=>{let i,r=null,l=null
s&&(i=e.match(s))&&(r=i[1],e=i[2]),e.length>0&&(l=d(e),this.settings.diacritics&&(l=o(l)),t&&(l="\\b"+l),l=new RegExp(l,"i")),n.push({string:e,regex:l,field:r})})),n}getScoreFunction(e,t){var i=this.prepareSearch(e,t)
return this._getScoreFunction(i)}_getScoreFunction(e){const t=e.tokens,i=t.length
if(!i)return function(){return 0}
const s=e.options.fields,n=e.weights,o=s.length,r=e.getAttrFn
var l=o?1===o?function(e,t){const i=s[0].field
return a(r(t,i),e,n[i])}:function(e,t){var i=0
if(e.field){const s=r(t,e.field)
!e.regex&&s?i+=.1:i+=a(s,e,n[e.field])}else c(n,((s,n)=>{i+=a(r(t,n),e,s)}))
return i/o}:function(){return 0}
return 1===i?function(e){return l(t[0],e)}:"and"===e.options.conjunction?function(e){for(var s,n=0,o=0;n<i;n++){if((s=l(t[n],e))<=0)return 0
o+=s}return o/i}:function(e){var s=0
return c(t,(t=>{s+=l(t,e)})),s/i}}getSortFunction(e,t){var i=this.prepareSearch(e,t)
return this._getSortFunction(i)}_getSortFunction(e){var t,i,s,n,o,r,l,a,d,p,c,h
if(s=this,h=e.options,c=!e.query&&h.sort_empty||h.sort,d=function(t,i){return"$score"===t?i.score:e.getAttrFn(s.items[i.id],t)},o=[],c)for(t=0,i=c.length;t<i;t++)(e.query||"$score"!==c[t].field)&&o.push(c[t])
if(e.query){for(p=!0,t=0,i=o.length;t<i;t++)if("$score"===o[t].field){p=!1
break}p&&o.unshift({field:"$score",direction:"desc"})}else for(t=0,i=o.length;t<i;t++)if("$score"===o[t].field){o.splice(t,1)
break}for(a=[],t=0,i=o.length;t<i;t++)a.push("desc"===o[t].direction?-1:1)
return(r=o.length)?1===r?(n=o[0].field,l=a[0],function(e,t){return l*u(d(n,e),d(n,t))}):function(e,t){var i,s,n
for(i=0;i<r;i++)if(n=o[i].field,s=a[i]*u(d(n,e),d(n,t)))return s
return 0}:null}prepareSearch(e,t){const i={}
var n=Object.assign({},t)
if(p(n,"sort"),p(n,"sort_empty"),n.fields){if(p(n,"fields"),Array.isArray(n.fields)&&"object"!=typeof n.fields[0]){var o=[]
n.fields.forEach((e=>{o.push({field:e})})),n.fields=o}n.fields.forEach((e=>{i[e.field]="weight"in e?e.weight:1}))}return{options:n,query:e=s(String(e||"")).toLowerCase().trim(),tokens:this.tokenize(e,n.respect_word_boundaries,i),total:0,items:[],weights:i,getAttrFn:n.nesting?l:r}}search(e,t){var i,s,n,o,r=this
return s=this.prepareSearch(e,t),t=s.options,e=s.query,o=t.score||r._getScoreFunction(s),e.length?c(r.items,((e,n)=>{i=o(e),(!1===t.filter||i>0)&&s.items.push({score:i,id:n})})):c(r.items,((e,t)=>{s.items.push({score:1,id:t})})),(n=r._getSortFunction(s))&&s.items.sort(n),s.total=s.items.length,"number"==typeof t.limit&&(s.items=s.items.slice(0,t.limit)),s}}function g(e,t){if(null!==t){if("string"==typeof t){if(!t.length)return
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])}function w(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function b(e,t,i,s){e.addEventListener(t,i,s)}function I(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function C(e,t){const i=e.getAttribute("id")
return i||(e.setAttribute("id",t),t)}function _(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function S(e,t){Object.assign(e.style,t)}function F(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function x(e,...t){var i=k(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function k(e){var t=[]
for(let i of e)"string"==typeof i&&(i=i.trim().split(/[\11\12\14\15\40]/)),Array.isArray(i)&&(t=t.concat(i))
return t.filter(Boolean)}function P(e){return Array.isArray(e)||(e=[e]),e}function L(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function E(e,t){return t>0?e[e.length-1]:e[0]}function T(e,t){if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i}function q(e,t){for(const i in t)e.setAttribute(i,t[i])}var V=0
class D extends(function(e){return e.plugins={},class extends e{static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s,n=this,o=[]
...
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),this.settings=function(e,t){var i=Object.assign({},v,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,d=i.optgroupValueField,p=e.tagName.toLowerCase(),c=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
if(!c&&!i.allowEmptyOption){let t=e.querySelector('option[value=""]')
t&&(c=t.textContent)}var u={placeholder:c,options:[],optgroups:[],items:[],maxItems:null}
return"select"===p?(()=>{var t,p=u.options,c={},h=1,g=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},f=(e,t)=>{var s=m(e.value)
if(s||i.allowEmptyOption)if(c.hasOwnProperty(s)){if(t){var a=c[s][l]
a?Array.isArray(a)?a.push(t):c[s][l]=[a,t]:c[s][l]=t}}else{var d=g(e)
d[n]=d[n]||e.textContent,d[o]=d[o]||s,d[r]=d[r]||e.disabled,d[l]=d[l]||t,d.$option=e,c[s]=d,p.push(d),e.selected&&u.items.push(s)}},v=e=>{var t,i;(i=g(e))[a]=i[a]||e.getAttribute("label")||"",i[d]=i[d]||h++,i[r]=i[r]||e.disabled,u.optgroups.push(i),t=i[d]
...
u.items=t}})(),Object.assign({},v,u,t)}(s,t),this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=C(s,"tomselect-"+V),this.isRequired=s.required,this.sifter=new h(this.options,{diacritics:this.settings.diacritics}),this.setupOptions(this.settings.options,this.settings.optgroups),delete this.settings.optgroups,delete this.settings.options,this.settings.mode=this.settings.mode||(1===this.settings.maxItems?"single":"multi"),"boolean"!=typeof this.settings.hideSelected&&(this.settings.hideSelected="multi"===this.settings.mode),"boolean"!=typeof this.settings.hidePlaceholder&&(this.settings.hidePlaceholder="multi"!==this.settings.mode)
var n=this.settings.createFilter
"function"!=typeof n&&("string"==typeof n&&(n=new RegExp(n)),n instanceof RegExp?this.settings.createFilter=e=>n.test(e):this.settings.createFilter=()=>!0),this.initializePlugins(this.settings.plugins),this.setupCallbacks(),this.setupTemplates(),this.setup()}setup(){var e,t,i,s,n,o,r,l,a,d=this,p=d.settings,c=d.input
const u={passive:!0},h=d.inputId+"-ts-dropdown"
if(o=d.settings.mode,r=c.getAttribute("class")||"",F(e=_("<div>"),p.wrapperClass,r,o),F(t=_('<div class="items">'),p.inputClass),e.append(t),F(s=d.render("dropdown"),p.dropdownClass,o),F(n=_(`<div role="listbox" id="${h}" tabindex="-1">`),p.dropdownContentClass),s.append(n),_(p.dropdownParent||e).appendChild(s),p.controlInput)i=_(p.controlInput)
else{i=_('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])c.getAttribute(e)&&q(i,{[e]:c.getAttribute(e)})}p.controlInput||(i.tabIndex=c.disabled?-1:d.tabIndex,t.appendChild(i)),q(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":h}),a=C(i,d.inputId+"-tomselected")
let g="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(d.inputId)+"']",f=document.querySelector(g)
if(f){q(f,{for:a}),q(n,{"aria-labelledby":C(f,d.inputId+"-ts-label")})}if(d.settings.copyClassesToDropdown&&F(s,r),e.style.width=c.style.width,d.plugins.names.length&&(l="plugin-"+d.plugins.names.join(" plugin-"),F([e,s],l)),(null===p.maxItems||p.maxItems>1)&&d.is_select_tag&&q(c,{multiple:"multiple"}),d.settings.placeholder&&q(i,{placeholder:p.placeholder}),!d.settings.splitOn&&d.settings.delimiter){var v=d.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
...
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),d.control=t,d.control_input=i,d.wrapper=e,d.dropdown=s,d.dropdown_content=n,d.control_input.type=c.type,b(s,"mouseenter",(e=>{var t=L(e.target,"[data-selectable]",s)
if(t)return d.onOptionHover(e,t)}),{capture:!0}),b(t,"mousedown",(e=>{if(e.target==i)return d.clearActiveItems(),e.stopPropagation(),void d.inputState()
var s=L(e.target,"."+d.settings.itemClass,t)
return s?d.onItemSelect(e,s):d.onMouseDown(e)})),b(t,"click",(e=>d.onClick(e))),b(i,"keydown",(e=>d.onKeyDown(e))),b(i,"keyup",(e=>d.onKeyUp(e))),b(i,"keypress",(e=>d.onKeyPress(e))),b(i,"resize",(()=>d.positionDropdown()),u),b(i,"blur",(e=>d.onBlur(e))),b(i,"focus",(e=>{d.ignoreBlur=!1,d.onFocus(e)})),b(i,"paste",(e=>d.onPaste(e)))
var I=e=>{var t=L(e.target,"[data-selectable]",d.dropdown)
if(!t&&!d.wrapper.contains(e.target))return d.isFocused&&d.blur(),void d.inputState()
w(e,!0),t&&d.onOptionSelect(e,t)},A=()=>{d.isOpen&&d.positionDropdown()}
b(document,"mousedown",I),b(window,"sroll",A,u),b(window,"resize",A,u),d._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",A),window.removeEventListener("resize",A)},this.revertSettings={innerHTML:c.innerHTML,tabIndex:c.tabIndex},c.tabIndex=-1,q(c,{hidden:"hidden"}),c.insertAdjacentElement("afterend",d.wrapper),d.setValue(p.items),delete p.items,b(c,"invalid",(e=>{w(e),d.isInvalid||(d.isInvalid=!0,d.refreshState())})),d.updateOriginalInput(),d.refreshItems(),d.refreshState(),d.inputState(),d.isSetup=!0,c.disabled&&d.disable(),d.on("change",this.onChange),F(c,"tomselected"),d.trigger("initialize"),!0===p.preload&&d.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFocused&&t.isOpen||(t.focus(),w(e))}onMouseDown(e){var t=this
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!I(f,e)&&w(e)}}onKeyUp(e){var t=this
if(t.isLocked)w(e)
...
i.isLocked||"multi"===i.settings.mode&&(w(e),i.setActiveItem(t,e))}load(e){var t=this,i=t.settings.load
if(!i)return
...
i.loading=Math.max(i.loading-1,0),i.lastQuery=null,i.clearActiveOption(),i.setupOptions(e,t),i.refreshOptions(i.isFocused&&!i.isInputHidden),i.loading||x(i.wrapper,i.settings.loadingClass),i.trigger("load",e,t)}onSearchChange(e){this.load(e)}setTextboxValue(e=""){var t=this.control_input
t.value!==e&&(t.value=e,A(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){O(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
if("single"!==a.settings.mode){if(!e)return a.clearActiveItems(),void(a.isFocused&&a.showInput())
if("mousedown"===(i=t&&t.type.toLowerCase())&&I("shiftKey",t)&&a.activeItems.length){for(l=a.getLastActive(),(n=Array.prototype.indexOf.call(a.control.children,l))>(o=Array.prototype.indexOf.call(a.control.children,e))&&(r=n,n=o,o=r),s=n;s<=o;s++)e=a.control.children[s],-1===a.activeItems.indexOf(e)&&a.setActiveItemClass(e)
w(t)}else"mousedown"===i&&I(f,t)||"keydown"===i&&I("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){var t=this.control.querySelector(".last-active")
t&&x(t,"last-active"),F(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),x(e,"active")}clearActiveItems(){x(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){var t,i,s
if(e===this.activeOption)return
if(this.clearActiveOption(),!e)return
this.activeOption=e,q(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),q(e,{"aria-selected":"true"}),F(e,"active"),t=this.dropdown_content.clientHeight
let n=this.dropdown_content.scrollTop||0
i=this.activeOption.offsetHeight,(s=this.activeOption.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+n)+i>t+n?this.dropdown_content.scrollTop=s-t+i:s<n&&(this.dropdown_content.scrollTop=s)}clearActiveOption(){this.activeOption&&(x(this.activeOption,"active"),this.activeOption.removeAttribute("aria-selected")),this.activeOption=null,this.control_input.removeAttribute("aria-activedescendant")}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(F(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,F(e.wrapper,"input-hidden")):(e.isInputHidden=!1,x(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,d,p,c,u,h,f=this,v=f.inputValue(),y=f.search(v),O=f.activeOption&&m(f.activeOption.dataset.value),w=f.settings.shouldOpen||!1
for(n=y.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(w=!0),u={},o=[],t=0;t<n;t++){let e=f.options[y.items[t].id],n=m(e[f.settings.valueField]),a=f.getOption(n)
for(a||(a=f.render("option",e)),f.settings.hideSelected||a.classList.toggle("selected",f.items.includes(n)),r=e[f.settings.optgroupField]||"",i=0,s=(l=Array.isArray(r)?r:[r])&&l.length;i<s;i++)r=l[i],f.optgroups.hasOwnProperty(r)||(r=""),u.hasOwnProperty(r)||(u[r]=document.createDocumentFragment(),o.push(r)),i>0&&(a=a.cloneNode(!0),x(a,"active"),a.removeAttribute("aria-selected")),u[r].appendChild(a)}for(r of(this.settings.lockOptgroupOrder&&o.sort(((e,t)=>(f.optgroups[e]&&f.optgroups[e].$order||0)-(f.optgroups[t]&&f.optgroups[t].$order||0))),a=document.createDocumentFragment(),o))if(f.optgroups.hasOwnProperty(r)&&u[r].children.length){let e=document.createDocumentFragment()
e.append(f.render("optgroup_header",f.optgroups[r])),e.append(u[r])
let t=f.render("optgroup",{group:f.optgroups[r],options:e})
a.append(t)}else a.append(u[r])
if(f.dropdown_content.innerHTML="",f.dropdown_content.append(a),f.settings.highlight&&(f.dropdown_content,h=document.querySelectorAll("span.highlight"),Array.prototype.forEach.call(h,(function(e,t){var i=e.parentNode
...
var b=e=>{let t=f.render(e,{input:v})
return t&&(w=!0,f.dropdown_content.insertBefore(t,f.dropdown_content.firstChild)),t}
if(f.settings.shouldLoad.call(f,v)?f.loading?b("loading"):0===y.items.length&&b("no_results"):b("not_loading"),(d=f.canCreate(v))&&(c=b("option_create")),f.hasOptions=y.items.length>0||d,w){if(y.items.length>0){if(!(p=O&&f.getOption(O))||!f.dropdown_content.contains(p)){let e=0
c&&!f.settings.addPrecedence&&(e=1),p=f.selectable()[e]}}else p=c
f.setActiveOption(p),e&&!f.isOpen&&f.open()}else f.clearActiveOption(),e&&f.isOpen&&f.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
a=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(o=d.items.indexOf(e))&&d.items.splice(o,1,n)),t.$order=t.$order||a,d.options[n]=t,r=d.renderCache.item,l=d.renderCache.option,r&&(delete r[e],delete r[n]),l&&(delete l[e],delete l[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&F(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=m(e)
...
o&&(e=m(o.dataset.value),-1!==(i=n.items.indexOf(e))&&(o.remove(),o.classList.contains("active")&&(s=n.activeItems.indexOf(o),n.activeItems.splice(s,1),x(o,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,o)))}createItem(e,t=!0,i){var s,n=this,o=n.caretPos
...
n=_('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,q(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
s.isSetup&&(e.silent||s.trigger("change",s.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,q(e.control_input,{"aria-expanded":"true"}),e.refreshState(),S(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),S(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur()),t.isOpen=!1,q(t.control_input,{"aria-expanded":"false"}),S(t.dropdown,{display:"none"}),t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
if(t=e&&8===e.keyCode?-1:1,i={start:(o=r.control_input).selectionStart,length:o.selectionEnd-o.selectionStart},s=[],r.activeItems.length){n=T(E(r.activeItems,t)),t>0&&n++
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,x(e.input,"tomselected"),e.input.removeAttribute("hidden"),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){var i,s,n=this
...
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=_(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?q(s,{"aria-disabled":"true"}):q(s,{"data-selectable":""}):"optgroup"===e&&(q(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&q(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(q(s,{"data-value":i}),"item"===e?F(s,n.settings.itemClass):(F(s,n.settings.optionClass),q(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return D.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=_(t),e.settings.placeholder&&q(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{q(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex}),b(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=_('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),D.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),D.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
t.settings.render.item=function(){var s=_(e.apply(t,arguments)),n=_(i)
return s.appendChild(n),b(n,"mousedown",(e=>{w(e,!0)})),b(n,"click",(e=>{if(w(e,!0),!t.isLocked){var i=s.dataset.value
t.removeItem(i),t.refreshOptions(!1)}})),s}}))}})),D.define("restore_on_backspace",(function(e){var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),D}))
